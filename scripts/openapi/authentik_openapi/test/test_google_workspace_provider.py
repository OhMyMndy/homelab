...
class TestGoogleWorkspaceProvider(unittest.TestCase):
    """GoogleWorkspaceProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleWorkspaceProvider:
        """Test GoogleWorkspaceProvider
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleWorkspaceProvider`
        """
    ...
    def testGoogleWorkspaceProvider(self):
        """Test GoogleWorkspaceProvider"""
