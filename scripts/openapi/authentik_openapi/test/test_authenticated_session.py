...
class TestAuthenticatedSession(unittest.TestCase):
    """AuthenticatedSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticatedSession:
        """Test AuthenticatedSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticatedSession`
        """
    ...
    def testAuthenticatedSession(self):
        """Test AuthenticatedSession"""
