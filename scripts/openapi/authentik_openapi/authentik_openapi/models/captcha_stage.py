...
class CaptchaStage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "public_key", "js_url", "api_url", "score_min_threshold", "score_max_threshold", "error_on_invalid_score"]
