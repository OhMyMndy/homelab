...
class OutpostHealth(BaseModel):
    ...
    fips_enabled: Optional[StrictBool] = Field(description="Get FIPS enabled")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if fips_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.fips_enabled is None and "fips_enabled" in self.model_fields_set:
            _dict['fips_enabled'] = None
