...
class OpenIDConnectConfiguration(BaseModel):
    ...
    end_session_endpoint: StrictStr
    introspection_endpoint: StrictStr
    jwks_uri: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["issuer", "authorization_endpoint", "token_endpoint", "userinfo_endpoint", "end_session_endpoint", "introspection_endpoint", "jwks_uri", "response_types_supported", "id_token_signing_alg_values_supported", "subject_types_supported", "token_endpoint_auth_methods_supported"]
