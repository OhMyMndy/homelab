...
from tailscale_openapi.api_response import ApiResponse, T as ApiResponseT
import tailscale_openapi.models
from tailscale_openapi import rest
from tailscale_openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tailscale_openapi.models, klass)
