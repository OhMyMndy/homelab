...
class ListConfigurationAuditLogs200Response(BaseModel):
    """
    A structured response for all of a Tailnet's audit logs over a period of time.
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="Version of audit logs response.")
    tailnet: Optional[StrictStr] = Field(default=None, description="The tailnet on which the logged configuration changes were made.")
    logs: Optional[List[ConfigurationAuditLog]] = Field(default=None, description="Matching log entries, ordered chronologically.")
    __properties: ClassVar[List[str]] = ["version", "tailnet", "logs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tailnet": obj.get("tailnet"),
            "logs": [ConfigurationAuditLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
