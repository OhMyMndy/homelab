...
class AcceptDeviceInvite200ResponseDevice(BaseModel):
    """
    Information about the device being shared. 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The `nodeId` for the device. ")
    os: Optional[StrictStr] = Field(default=None, description="The operating system that the device is running. ")
    name: Optional[StrictStr] = Field(default=None, description="The name of the device. ")
    fqdn: Optional[StrictStr] = Field(default=None, description="The MagicDNS name of the device. Learn more about MagicDNS at https://tailscale.com/kb/1081/. ")
    ipv4: Optional[StrictStr] = Field(default=None, description="The IPv4 address of the device. ")
    ipv6: Optional[StrictStr] = Field(default=None, description="The IPv6 address of the device. ")
    include_exit_node: Optional[StrictBool] = Field(default=None, description="Specifies whether the invited user is able to use the device as an exit node when the device is advertising as one. ", alias="includeExitNode")
    __properties: ClassVar[List[str]] = ["id", "os", "name", "fqdn", "ipv4", "ipv6", "includeExitNode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipv4": obj.get("ipv4"),
            "ipv6": obj.get("ipv6"),
            "includeExitNode": obj.get("includeExitNode")
        })
        return _obj
