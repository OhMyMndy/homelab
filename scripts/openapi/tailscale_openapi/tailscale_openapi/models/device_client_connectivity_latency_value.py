...
class DeviceClientConnectivityLatencyValue(BaseModel):
    """
    DeviceClientConnectivityLatencyValue
    """ # noqa: E501
    preferred: Optional[StrictBool] = Field(default=None, description="'true' for the node's preferred DERP server for incoming traffic. ")
    latency_ms: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Current latency to DERP server. ", alias="latencyMs")
    __properties: ClassVar[List[str]] = ["preferred", "latencyMs"]
