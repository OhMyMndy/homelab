...
class DevicePostureAttributes(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[Dict[str, ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue]] = Field(default=None, description="Contains all the posture attributes assigned to a node. Attribute values can be strings, numbers or booleans. ")
    expiries: Optional[Dict[str, datetime]] = Field(default=None, description="Contains the expiry time for each posture attribute, if set. ")
    __properties: ClassVar[List[str]] = ["attributes", "expiries"]
