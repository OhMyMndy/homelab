...
class Key(BaseModel):
    ...
    capabilities: Optional[KeyCapabilities] = None
    description: Optional[StrictStr] = None
    invalid: Optional[StrictBool] = Field(default=None, description="Response for a revoked (deleted) or expired key will have an `invalid` field set to true. ")
    user_id: Optional[StrictStr] = Field(default=None, description="ID of the user who created this key, empty for keys created by OAuth clients. ", alias="userId")
    __properties: ClassVar[List[str]] = ["id", "created", "expires", "revoked", "capabilities", "description", "invalid", "userId"]
