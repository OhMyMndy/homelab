...
class CreateAuthKeyRequest(BaseModel):
    """
    CreateAuthKeyRequest
    """ # noqa: E501
    capabilities: KeyCapabilities
    expiry_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Specifies the duration in seconds until the key should expire. Defaults to 90 days if not supplied. ", alias="expirySeconds")
    description: Optional[StrictStr] = Field(default=None, description="A short string specifying the purpose of the key. Can be a maximum of 50 alphanumeric characters. Hyphens and spaces are also allowed. ")
    __properties: ClassVar[List[str]] = ["capabilities", "expirySeconds", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": KeyCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None,
            "expirySeconds": obj.get("expirySeconds"),
