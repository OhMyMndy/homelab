...
class SetDeviceNameRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The new name for the device.  This can be provided as either the fully qualified domain name for the device (e.g. \"nodename.your-domain.ts.net\") or just the base name (e.g. \"nodename\").  If `name` is unset or provided empty, the device's name is reset to be generated from its OS hostname. ")
