...
class GetPostureIntegrations200Response(BaseModel):
    """
    GetPostureIntegrations200Response
    """ # noqa: E501
    integrations: Optional[List[PostureIntegration]] = Field(default=None, description="List of PostureIntegrations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [PostureIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
