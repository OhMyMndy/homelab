...
class DnsPreferences(BaseModel):
    """
    DnsPreferences
    """ # noqa: E501
    magic_dns: StrictBool = Field(description="Whether MagicDNS is active for this tailnet. ", alias="magicDNS")
    __properties: ClassVar[List[str]] = ["magicDNS"]
