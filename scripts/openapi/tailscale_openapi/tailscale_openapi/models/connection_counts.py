...
class ConnectionCounts(BaseModel):
    ...
    ConnectionCounts
    """ # noqa: E501
    proto: Optional[StrictStr] = Field(default=None, description="IP protocol name (or number if no name used).")
    src: Optional[StrictStr] = Field(default=None, description="Source addr:port.")
    dst: Optional[StrictStr] = Field(default=None, description="Destination addr:port.")
    tx_pkts: Optional[StrictInt] = Field(default=None, description="Number of packets sent.", alias="txPkts")
    tx_bytes: Optional[StrictInt] = Field(default=None, description="Number of bytes sent.", alias="txBytes")
    rx_pkts: Optional[StrictInt] = Field(default=None, description="Number of packets received.", alias="rxPkts")
    rx_bytes: Optional[StrictInt] = Field(default=None, description="Number of bytes received.", alias="rxBytes")
    __properties: ClassVar[List[str]] = ["proto", "src", "dst", "txPkts", "txBytes", "rxPkts", "rxBytes"]
    ...
    def proto_validate_enum(cls, value):
        ...
        if value not in set(['ah', 'dccp', 'egp', 'esp', 'gre', 'icmp', 'igmp', 'igp', 'ipv4', 'ipv6-icmp', 'sctp', 'tcp', 'udp']):
            raise ValueError("must be one of enum values ('ah', 'dccp', 'egp', 'esp', 'gre', 'icmp', 'igmp', 'igp', 'ipv4', 'ipv6-icmp', 'sctp', 'tcp', 'udp')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "src": obj.get("src"),
            "dst": obj.get("dst"),
            "txPkts": obj.get("txPkts"),
            "txBytes": obj.get("txBytes"),
            "rxPkts": obj.get("rxPkts"),
