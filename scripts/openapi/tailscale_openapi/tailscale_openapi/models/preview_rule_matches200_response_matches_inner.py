...
class PreviewRuleMatches200ResponseMatchesInner(BaseModel):
    """
    PreviewRuleMatches200ResponseMatchesInner
    """ # noqa: E501
    users: List[StrictStr] = Field(description="Source entities affected by the rule. ")
    ports: List[StrictStr] = Field(description="Destinations that can be accessed. ")
    line_number: Union[StrictFloat, StrictInt] = Field(description="The rule's location in the policy file. ", alias="lineNumber")
    __properties: ClassVar[List[str]] = ["users", "ports", "lineNumber"]
