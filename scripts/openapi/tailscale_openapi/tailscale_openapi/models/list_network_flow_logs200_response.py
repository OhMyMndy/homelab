...
class ListNetworkFlowLogs200Response(BaseModel):
    """
    A structured response for all of a Tailnet's network flow logs over a period of time.
    """ # noqa: E501
    logs: Optional[List[NetworkFlowLog]] = Field(default=None, description="Matching log entries, ordered chronologically.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [NetworkFlowLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
