...
class ConfigurationAuditLogActor(BaseModel):
    """
    The person who caused the action related to this event.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID (user ID or node ID) of the actor.")
    type: Optional[StrictStr] = Field(default=None, description="The entity type of the actor.")
    login_name: Optional[StrictStr] = Field(default=None, description="The login name of the actor at time of the action.", alias="loginName")
    display_name: Optional[StrictStr] = Field(default=None, description="The display name of the actor at time of the action.", alias="displayName")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Indicates the tags owning a node. Its value is only set if `type` is `NODE`.")
    __properties: ClassVar[List[str]] = ["id", "type", "loginName", "displayName", "tags"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['USER', 'NODE', 'AUTOMATED_WORKER', 'OAUTH_CLIENT', 'SCIM', 'MULLVAD', 'LOGSTREAM', 'SECRET_SCANNER']):
            raise ValueError("must be one of enum values ('USER', 'NODE', 'AUTOMATED_WORKER', 'OAUTH_CLIENT', 'SCIM', 'MULLVAD', 'LOGSTREAM', 'SECRET_SCANNER')")
        return value
