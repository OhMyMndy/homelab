...
class CreateWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    endpoint_url: StrictStr = Field(description="The endpoint that events are sent to from Tailscale via POST requests. ", alias="endpointUrl")
    provider_type: Optional[ProviderType] = Field(default=None, alias="providerType")
    subscriptions: List[StrictStr] = Field(description="The list of subscribed events that trigger POST requests to the configured endpoint URL. Learn more about [webhook events](/kb/1213/webhooks#events). ")
    __properties: ClassVar[List[str]] = ["endpointUrl", "providerType", "subscriptions"]
