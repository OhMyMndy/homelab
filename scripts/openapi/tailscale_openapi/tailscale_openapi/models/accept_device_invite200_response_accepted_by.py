...
class AcceptDeviceInvite200ResponseAcceptedBy(BaseModel):
    """
    The user accepting the device share invite. 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the user who accepted the share invite. ")
    display_name: Optional[StrictStr] = Field(default=None, description="The display name of the user who accepted the share invite. ", alias="displayName")
    login_name: Optional[StrictStr] = Field(default=None, description="The email address of the user who accepted the share invite. ", alias="loginName")
    profile_pic_url: Optional[StrictStr] = Field(default=None, description="The profile pic URL for the user who accepted the share invite. ", alias="profilePicURL")
    __properties: ClassVar[List[str]] = ["id", "displayName", "loginName", "profilePicURL"]
