...
class DeviceRoutes(BaseModel):
    ...
    DeviceRoutes
    """ # noqa: E501
    advertised_routes: Optional[List[StrictStr]] = Field(default=None, description="The subnets this device requests to expose. ", alias="advertisedRoutes")
    enabled_routes: Optional[List[StrictStr]] = Field(default=None, description="The subnet routes for this device that have been approved by a tailnet admin. ", alias="enabledRoutes")
    __properties: ClassVar[List[str]] = ["advertisedRoutes", "enabledRoutes"]
