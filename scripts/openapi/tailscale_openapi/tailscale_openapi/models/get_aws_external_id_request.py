...
class GetAwsExternalIdRequest(BaseModel):
    """
    GetAwsExternalIdRequest
    """ # noqa: E501
    reusable: Optional[StrictBool] = Field(default=None, description="If set to true, this same AWS external id will be returned on future calls to this endpoint, if and only if those calls also mark `reusable` as true, and the ID has not yet been linked with an AWS account.")
    __properties: ClassVar[List[str]] = ["reusable"]
