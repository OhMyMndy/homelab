...
class PreviewRuleMatches200Response(BaseModel):
    """
    PreviewRuleMatches200Response
    """ # noqa: E501
    matches: List[PreviewRuleMatches200ResponseMatchesInner]
    type: StrictStr = Field(description="Echoes the `type` provided in the request. ")
    preview_for: StrictStr = Field(description="Echoes the `previewFor` provided in the request. ", alias="previewFor")
    __properties: ClassVar[List[str]] = ["matches", "type", "previewFor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matches": [PreviewRuleMatches200ResponseMatchesInner.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
            "type": obj.get("type"),
            "previewFor": obj.get("previewFor")
        })
        return _obj
