...
class Contact(BaseModel):
    ...
    A tailnet contact.
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The contact's email address.")
    fallback_email: Optional[StrictStr] = Field(default=None, description="The email address used when contact's email address has not been verified.", alias="fallbackEmail")
    needs_verification: Optional[StrictBool] = Field(default=None, description="Indicates whether the contact's email address still needs to be verified.", alias="needsVerification")
    __properties: ClassVar[List[str]] = ["email", "fallbackEmail", "needsVerification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "fallbackEmail": obj.get("fallbackEmail"),
            "needsVerification": obj.get("needsVerification")
        })
        return _obj
