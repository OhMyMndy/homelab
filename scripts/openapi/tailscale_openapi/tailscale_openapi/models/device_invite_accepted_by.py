...
class DeviceInviteAcceptedBy(BaseModel):
    """
    Set when the invite has been accepted. It holds information about the user who accepted the share invite. 
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the user who accepted the share invite. ")
    login_name: Optional[StrictStr] = Field(default=None, description="The login name of the user who accepted the share invite. ", alias="loginName")
    ...
    __properties: ClassVar[List[str]] = ["id", "loginName", "profilePicUrl"]
