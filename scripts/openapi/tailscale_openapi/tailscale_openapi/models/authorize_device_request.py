...
class AuthorizeDeviceRequest(BaseModel):
    ...
    """ # noqa: E501
    authorized: StrictBool = Field(description="- If `true`, authorize a new device or re-authorize a previously deauthorized device. - If `false`, deauthorize an authorized device. ")
