...
class DeviceClientConnectivityClientSupports(BaseModel):
    """
    Identifies features supported by the client. 
    """ # noqa: E501
    hair_pinning: Optional[StrictBool] = Field(default=None, description="'true' if your router can route connections from endpoints on your LAN back to your LAN using those endpoints’ globally-mapped IPv4 addresses/ports. ", alias="hairPinning")
    ipv6: Optional[StrictBool] = Field(default=None, description="'true' if the device OS supports IPv6, regardless of whether IPv6 internet connectivity is available. ")
    pcp: Optional[StrictBool] = Field(default=None, description="'true' if PCP port-mapping service exists on your router. ")
    pmp: Optional[StrictBool] = Field(default=None, description="'true' if NAT-PMP port-mapping service exists on your router. ")
    udp: Optional[StrictBool] = Field(default=None, description="'true' if UDP traffic is enabled on the current network; if 'false', Tailscale may be unable to make direct connections, and will rely on our DERP servers. ")
    upnp: Optional[StrictBool] = Field(default=None, description="'true' if UPnP port-mapping service exists on your router. ")
    __properties: ClassVar[List[str]] = ["hairPinning", "ipv6", "pcp", "pmp", "udp", "upnp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hairPinning": obj.get("hairPinning"),
            "ipv6": obj.get("ipv6"),
            "pcp": obj.get("pcp"),
            "pmp": obj.get("pmp"),
            "udp": obj.get("udp"),
