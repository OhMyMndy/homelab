...
class KeyCapabilitiesDevices(BaseModel):
    """
    `devices` specifies the key's permissions over devices. This field is only populated for auth keys. 
    """ # noqa: E501
    create: Optional[KeyCapabilitiesDevicesCreate] = None
    __properties: ClassVar[List[str]] = ["create"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "create": KeyCapabilitiesDevicesCreate.from_dict(obj["create"]) if obj.get("create") is not None else None
        })
        return _obj
