...
class DnsSearchPaths(BaseModel):
    """
    DnsSearchPaths
    """ # noqa: E501
    search_paths: List[StrictStr] = Field(description="The search domains for the given tailnet. ", alias="searchPaths")
    __properties: ClassVar[List[str]] = ["searchPaths"]
