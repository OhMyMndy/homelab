...
class AcceptDeviceInvite200Response(BaseModel):
    """
    AcceptDeviceInvite200Response
    """ # noqa: E501
    device: Optional[AcceptDeviceInvite200ResponseDevice] = None
    sharer: Optional[AcceptDeviceInvite200ResponseSharer] = None
    accepted_by: Optional[AcceptDeviceInvite200ResponseAcceptedBy] = Field(default=None, alias="acceptedBy")
    __properties: ClassVar[List[str]] = ["device", "sharer", "acceptedBy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sharer
        if self.sharer:
            _dict['sharer'] = self.sharer.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": AcceptDeviceInvite200ResponseDevice.from_dict(obj["device"]) if obj.get("device") is not None else None,
            "sharer": AcceptDeviceInvite200ResponseSharer.from_dict(obj["sharer"]) if obj.get("sharer") is not None else None,
            "acceptedBy": AcceptDeviceInvite200ResponseAcceptedBy.from_dict(obj["acceptedBy"]) if obj.get("acceptedBy") is not None else None
        })
        return _obj
