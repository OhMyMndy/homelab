...
class SetDnsNameservers200Response(BaseModel):
    """
    SetDnsNameservers200Response
    """ # noqa: E501
    dns: Optional[List[StrictStr]] = Field(default=None, description="DNS nameservers. ")
    magic_dns: Optional[StrictBool] = Field(default=None, description="Whether MagicDNS is active for this tailnet. ", alias="magicDNS")
    __properties: ClassVar[List[str]] = ["dns", "magicDNS"]
