...
class AwsExternalId(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="A unique identifier for this AWS external id in the Tailscale system.")
    external_id: Optional[StrictStr] = Field(default=None, description="The actual external id that Tailscale will supply to AWS when authenticating using role-based authentication.", alias="externalId")
    tailscale_aws_account_id: Optional[StrictStr] = Field(default=None, description="The AWS account id that Tailscale will supply to AWS when authenticating using role-based authentication.", alias="tailscaleAwsAccountId")
    __properties: ClassVar[List[str]] = ["id", "externalId", "tailscaleAwsAccountId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tailscaleAwsAccountId": obj.get("tailscaleAwsAccountId")
        })
        return _obj
