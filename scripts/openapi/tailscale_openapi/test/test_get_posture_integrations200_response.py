...
class TestGetPostureIntegrations200Response(unittest.TestCase):
    """GetPostureIntegrations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPostureIntegrations200Response:
        """Test GetPostureIntegrations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPostureIntegrations200Response`
        """
        model = GetPostureIntegrations200Response()
        if include_optional:
            return GetPostureIntegrations200Response(
                integrations = [
                    {id=p56wQiqrn7mfKTM59, provider=intune, cloudId=global, clientId=93013672-b00c-4344-80ca-7ecf74f9dce1, tenantId=d1ae389b-5207-43a2-afca-2de6b03ac7e3, configUpdated=2024-06-18T13:44:28.250168Z, status={error=Invalid Tenant ID.
Microsoft error: AADSTS90002: Tenant 'd1ae389b-5207-43a2-afca-2de6b03ac7e3' not found. Check to make sure you have the correct tenant ID and are signing into the correct cloud. Check with your subscription administrator, this may happen if there are no active subscriptions for the tenant. Trace ID: f6237360-98a2-4889-913b-e3d80aba7d00 Correlation ID: a2024a6e-7757-4406-8a8d-1b6ac2e03ad5 Timestamp: 2024-06-18 13:44:33Z, lastSync=2024-06-18T08:44:33.872282-05:00, matchedCount=0, possibleMatchedCount=0, providerHostCount=0}}
                    ]
            )
        else:
            return GetPostureIntegrations200Response(
    ...
    def testGetPostureIntegrations200Response(self):
        """Test GetPostureIntegrations200Response"""
