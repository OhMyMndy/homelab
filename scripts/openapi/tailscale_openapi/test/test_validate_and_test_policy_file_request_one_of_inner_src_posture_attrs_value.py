...
class TestValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue(unittest.TestCase):
    """ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue:
        """Test ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue`
        """
        model = ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue()
        if include_optional:
            return ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue(
            )
        else:
            return ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue(
        )
    ...
    def testValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue(self):
        """Test ValidateAndTestPolicyFileRequestOneOfInnerSrcPostureAttrsValue"""
