...
class TestNetworkFlowLog(unittest.TestCase):
    """NetworkFlowLog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkFlowLog:
        """Test NetworkFlowLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkFlowLog`
        """
        model = NetworkFlowLog()
        if include_optional:
            return NetworkFlowLog(
                ...
                virtual_traffic = [
                    tailscale_openapi.models.connection_counts.ConnectionCounts(
                        proto = 'ipv4', 
