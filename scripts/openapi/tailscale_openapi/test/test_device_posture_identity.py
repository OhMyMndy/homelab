...
class TestDevicePostureIdentity(unittest.TestCase):
    """DevicePostureIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevicePostureIdentity:
        """Test DevicePostureIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicePostureIdentity`
        """
        model = DevicePostureIdentity()
        if include_optional:
    ...
    def testDevicePostureIdentity(self):
        """Test DevicePostureIdentity"""
