...
class TestDeviceInvitesApi(unittest.TestCase):
    """DeviceInvitesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DeviceInvitesApi()

    def tearDown(self) -> None:
        pass

    def test_accept_device_invite(self) -> None:
        """Test case for accept_device_invite

        Accept a device invite
        """
        pass

    def test_create_device_invites(self) -> None:
        """Test case for create_device_invites

        Create device invites
        """
        pass

    def test_delete_device_invite(self) -> None:
        """Test case for delete_device_invite

        Delete a device invite
        """
        pass

    def test_get_device_invite(self) -> None:
        """Test case for get_device_invite

        Get a device invite
        """
        pass

    def test_list_device_invites(self) -> None:
        """Test case for list_device_invites

        List device invites
        """
        pass

    def test_resend_device_invite(self) -> None:
        """Test case for resend_device_invite
