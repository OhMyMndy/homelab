...
class TestGetContacts200Response(unittest.TestCase):
    """GetContacts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContacts200Response:
        """Test GetContacts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContacts200Response`
        """
        model = GetContacts200Response()
        if include_optional:
            return GetContacts200Response(
                account = {email=user@example.com, fallbackEmail=otheruser@example.com", needsVerification=true},
                support = {email=user@example.com, fallbackEmail=otheruser@example.com", needsVerification=true},
                security = {email=user@example.com, fallbackEmail=otheruser@example.com", needsVerification=true}
            )
        else:
            return GetContacts200Response(
        )
    ...
    def testGetContacts200Response(self):
        """Test GetContacts200Response"""
