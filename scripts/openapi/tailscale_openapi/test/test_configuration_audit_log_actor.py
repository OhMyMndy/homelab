...
class TestConfigurationAuditLogActor(unittest.TestCase):
    """ConfigurationAuditLogActor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationAuditLogActor:
        """Test ConfigurationAuditLogActor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationAuditLogActor`
        """
        model = ConfigurationAuditLogActor()
        if include_optional:
            return ConfigurationAuditLogActor(
    ...
    def testConfigurationAuditLogActor(self):
        """Test ConfigurationAuditLogActor"""
