...
class TestAcceptDeviceInvite200ResponseDevice(unittest.TestCase):
    """AcceptDeviceInvite200ResponseDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptDeviceInvite200ResponseDevice:
        """Test AcceptDeviceInvite200ResponseDevice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptDeviceInvite200ResponseDevice`
        """
        model = AcceptDeviceInvite200ResponseDevice()
        if include_optional:
            return AcceptDeviceInvite200ResponseDevice(
                id = '12346',
                os = 'iOS',
                name = 'my-phone',
    ...
    def testAcceptDeviceInvite200ResponseDevice(self):
        """Test AcceptDeviceInvite200ResponseDevice"""
