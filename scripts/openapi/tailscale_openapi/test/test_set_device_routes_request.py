...
class TestSetDeviceRoutesRequest(unittest.TestCase):
    """SetDeviceRoutesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetDeviceRoutesRequest:
        """Test SetDeviceRoutesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetDeviceRoutesRequest`
        """
        model = SetDeviceRoutesRequest()
        if include_optional:
            return SetDeviceRoutesRequest(
    ...
    def testSetDeviceRoutesRequest(self):
        """Test SetDeviceRoutesRequest"""
