...
class TestSetDeviceTagsRequest(unittest.TestCase):
    """SetDeviceTagsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetDeviceTagsRequest:
        """Test SetDeviceTagsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetDeviceTagsRequest`
        """
        model = SetDeviceTagsRequest()
        if include_optional:
            return SetDeviceTagsRequest(
    ...
    def testSetDeviceTagsRequest(self):
        """Test SetDeviceTagsRequest"""
