...
class TestSetDeviceIpRequest(unittest.TestCase):
    """SetDeviceIpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetDeviceIpRequest:
        """Test SetDeviceIpRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetDeviceIpRequest`
        """
        model = SetDeviceIpRequest()
        if include_optional:
            return SetDeviceIpRequest(
                ipv4 = '100.80.0.1'
            )
        else:
            return SetDeviceIpRequest(
    ...
    def testSetDeviceIpRequest(self):
        """Test SetDeviceIpRequest"""
