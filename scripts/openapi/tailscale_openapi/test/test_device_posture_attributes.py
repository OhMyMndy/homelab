...
class TestDevicePostureAttributes(unittest.TestCase):
    """DevicePostureAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevicePostureAttributes:
        """Test DevicePostureAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicePostureAttributes`
        """
        model = DevicePostureAttributes()
        if include_optional:
    ...
    def testDevicePostureAttributes(self):
        """Test DevicePostureAttributes"""
