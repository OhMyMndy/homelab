...
class TestCreateDeviceInvitesRequestInner(unittest.TestCase):
    """CreateDeviceInvitesRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDeviceInvitesRequestInner:
        """Test CreateDeviceInvitesRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDeviceInvitesRequestInner`
        """
        model = CreateDeviceInvitesRequestInner()
        if include_optional:
            return CreateDeviceInvitesRequestInner(
                multi_use = False,
    ...
    def testCreateDeviceInvitesRequestInner(self):
        """Test CreateDeviceInvitesRequestInner"""
