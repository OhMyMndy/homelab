...
class TestKeyCapabilitiesDevicesCreate(unittest.TestCase):
    """KeyCapabilitiesDevicesCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyCapabilitiesDevicesCreate:
        """Test KeyCapabilitiesDevicesCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyCapabilitiesDevicesCreate`
        """
        model = KeyCapabilitiesDevicesCreate()
        if include_optional:
            return KeyCapabilitiesDevicesCreate(
                reusable = True,
                ephemeral = False,
                preauthorized = True,
                tags = [
    ...
    def testKeyCapabilitiesDevicesCreate(self):
        """Test KeyCapabilitiesDevicesCreate"""
