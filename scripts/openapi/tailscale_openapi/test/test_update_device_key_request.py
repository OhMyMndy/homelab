...
class TestUpdateDeviceKeyRequest(unittest.TestCase):
    """UpdateDeviceKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDeviceKeyRequest:
        """Test UpdateDeviceKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDeviceKeyRequest`
        """
        model = UpdateDeviceKeyRequest()
        if include_optional:
            return UpdateDeviceKeyRequest(
    ...
    def testUpdateDeviceKeyRequest(self):
        """Test UpdateDeviceKeyRequest"""
