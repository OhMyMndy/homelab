...
class TestAcceptDeviceInvite200ResponseAcceptedBy(unittest.TestCase):
    """AcceptDeviceInvite200ResponseAcceptedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptDeviceInvite200ResponseAcceptedBy:
        """Test AcceptDeviceInvite200ResponseAcceptedBy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptDeviceInvite200ResponseAcceptedBy`
        """
        model = AcceptDeviceInvite200ResponseAcceptedBy()
        if include_optional:
            return AcceptDeviceInvite200ResponseAcceptedBy(
                id = '33233',
    ...
    def testAcceptDeviceInvite200ResponseAcceptedBy(self):
        """Test AcceptDeviceInvite200ResponseAcceptedBy"""
