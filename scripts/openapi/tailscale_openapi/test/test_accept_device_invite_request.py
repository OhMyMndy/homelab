...
class TestAcceptDeviceInviteRequest(unittest.TestCase):
    """AcceptDeviceInviteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptDeviceInviteRequest:
        """Test AcceptDeviceInviteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptDeviceInviteRequest`
        """
        model = AcceptDeviceInviteRequest()
        if include_optional:
            return AcceptDeviceInviteRequest(
    ...
    def testAcceptDeviceInviteRequest(self):
        """Test AcceptDeviceInviteRequest"""
