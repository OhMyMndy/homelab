...
class TestSetCustomDevicePostureAttributesRequest(unittest.TestCase):
    """SetCustomDevicePostureAttributesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetCustomDevicePostureAttributesRequest:
        """Test SetCustomDevicePostureAttributesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetCustomDevicePostureAttributesRequest`
        """
        model = SetCustomDevicePostureAttributesRequest()
        if include_optional:
            return SetCustomDevicePostureAttributesRequest(
                value = my_value,
    ...
    def testSetCustomDevicePostureAttributesRequest(self):
        """Test SetCustomDevicePostureAttributesRequest"""
