...
class TestDeviceRoutes(unittest.TestCase):
    """DeviceRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceRoutes:
        """Test DeviceRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceRoutes`
        """
        model = DeviceRoutes()
        if include_optional:
            return DeviceRoutes(
