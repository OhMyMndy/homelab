...
class TestCreateUserInvitesRequestInner(unittest.TestCase):
    """CreateUserInvitesRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateUserInvitesRequestInner:
        """Test CreateUserInvitesRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateUserInvitesRequestInner`
        """
        model = CreateUserInvitesRequestInner()
        if include_optional:
            return CreateUserInvitesRequestInner(
                role = 'member',
    ...
    def testCreateUserInvitesRequestInner(self):
        """Test CreateUserInvitesRequestInner"""
