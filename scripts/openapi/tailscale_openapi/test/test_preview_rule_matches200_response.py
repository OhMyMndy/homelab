...
class TestPreviewRuleMatches200Response(unittest.TestCase):
    """PreviewRuleMatches200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewRuleMatches200Response:
        """Test PreviewRuleMatches200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewRuleMatches200Response`
        """
        model = PreviewRuleMatches200Response()
        if include_optional:
            return PreviewRuleMatches200Response(
                matches = [
                    tailscale_openapi.models.preview_rule_matches_200_response_matches_inner.previewRuleMatches_200_response_matches_inner(
                        users = ["*"], 
                        ports = ["*.*"], 
                        line_number = 19, )
                    ],
    ...
    def testPreviewRuleMatches200Response(self):
        """Test PreviewRuleMatches200Response"""
