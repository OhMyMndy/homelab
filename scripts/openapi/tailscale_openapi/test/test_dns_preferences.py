...
class TestDnsPreferences(unittest.TestCase):
    """DnsPreferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DnsPreferences:
        """Test DnsPreferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DnsPreferences`
        """
        model = DnsPreferences()
        if include_optional:
