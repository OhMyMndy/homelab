...
class TestLoggingApi(unittest.TestCase):
    ...
    def test_disable_log_streaming(self) -> None:
        """Test case for disable_log_streaming

        Disable log streaming
        """
        pass

    def test_get_aws_external_id(self) -> None:
    ...
    def test_get_log_streaming_configuration(self) -> None:
        """Test case for get_log_streaming_configuration

        Get log streaming configuration
        """
        pass

    def test_get_log_streaming_status(self) -> None:
        """Test case for get_log_streaming_status

        Get log streaming status
        """
        pass

    def test_list_configuration_audit_logs(self) -> None:
        """Test case for list_configuration_audit_logs

        List configuration audit logs
        """
        pass

    def test_list_network_flow_logs(self) -> None:
        """Test case for list_network_flow_logs

        List network flow logs
        """
        pass

    def test_set_log_streaming_configuration(self) -> None:
        """Test case for set_log_streaming_configuration
