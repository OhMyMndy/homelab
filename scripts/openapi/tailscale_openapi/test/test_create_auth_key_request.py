...
class TestCreateAuthKeyRequest(unittest.TestCase):
    """CreateAuthKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAuthKeyRequest:
        """Test CreateAuthKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAuthKeyRequest`
        """
        model = CreateAuthKeyRequest()
        if include_optional:
            return CreateAuthKeyRequest(
                capabilities = tailscale_openapi.models.key_capabilities.KeyCapabilities(
                    devices = tailscale_openapi.models.key_capabilities_devices.KeyCapabilities_devices(
                        create = tailscale_openapi.models.key_capabilities_devices_create.KeyCapabilities_devices_create(
                            reusable = True, 
                            ephemeral = False, 
                            preauthorized = True, 
                            tags = [
    ...
    def testCreateAuthKeyRequest(self):
        """Test CreateAuthKeyRequest"""
