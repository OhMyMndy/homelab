...
class TestLogstreamEndpointConfiguration(unittest.TestCase):
    """LogstreamEndpointConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogstreamEndpointConfiguration:
        """Test LogstreamEndpointConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogstreamEndpointConfiguration`
        """
        model = LogstreamEndpointConfiguration()
        if include_optional:
    ...
    def testLogstreamEndpointConfiguration(self):
        """Test LogstreamEndpointConfiguration"""
