...
class TestPreviewRuleMatches200ResponseMatchesInner(unittest.TestCase):
    """PreviewRuleMatches200ResponseMatchesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewRuleMatches200ResponseMatchesInner:
        """Test PreviewRuleMatches200ResponseMatchesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewRuleMatches200ResponseMatchesInner`
        """
        model = PreviewRuleMatches200ResponseMatchesInner()
        if include_optional:
            return PreviewRuleMatches200ResponseMatchesInner(
                users = ["*"],
                ports = ["*.*"],
                line_number = 19
            )
    ...
    def testPreviewRuleMatches200ResponseMatchesInner(self):
        """Test PreviewRuleMatches200ResponseMatchesInner"""
