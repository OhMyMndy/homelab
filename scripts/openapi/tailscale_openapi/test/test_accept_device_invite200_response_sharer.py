...
class TestAcceptDeviceInvite200ResponseSharer(unittest.TestCase):
    """AcceptDeviceInvite200ResponseSharer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptDeviceInvite200ResponseSharer:
        """Test AcceptDeviceInvite200ResponseSharer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptDeviceInvite200ResponseSharer`
        """
        model = AcceptDeviceInvite200ResponseSharer()
        if include_optional:
            return AcceptDeviceInvite200ResponseSharer(
                id = '22012',
    ...
    def testAcceptDeviceInvite200ResponseSharer(self):
        """Test AcceptDeviceInvite200ResponseSharer"""
