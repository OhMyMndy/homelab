...
class TestSetDeviceNameRequest(unittest.TestCase):
    """SetDeviceNameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetDeviceNameRequest:
        """Test SetDeviceNameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetDeviceNameRequest`
        """
        model = SetDeviceNameRequest()
        if include_optional:
            return SetDeviceNameRequest(
                name = 'dev-server'
            )
        else:
            return SetDeviceNameRequest(
    ...
    def testSetDeviceNameRequest(self):
        """Test SetDeviceNameRequest"""
