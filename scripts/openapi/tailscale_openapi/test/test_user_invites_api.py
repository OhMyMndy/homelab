...
class TestUserInvitesApi(unittest.TestCase):
    """UserInvitesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UserInvitesApi()

    def tearDown(self) -> None:
        pass

    def test_create_user_invites(self) -> None:
        """Test case for create_user_invites
    ...
    def test_get_user_invite(self) -> None:
    ...
    def test_list_user_invites(self) -> None:
        """Test case for list_user_invites
