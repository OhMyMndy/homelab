...
class TestValidateAndTestPolicyFileRequest(unittest.TestCase):
    """ValidateAndTestPolicyFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateAndTestPolicyFileRequest:
        """Test ValidateAndTestPolicyFileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateAndTestPolicyFileRequest`
        """
        model = ValidateAndTestPolicyFileRequest()
        if include_optional:
            return ValidateAndTestPolicyFileRequest(
            )
        else:
            return ValidateAndTestPolicyFileRequest(
        )
    ...
    def testValidateAndTestPolicyFileRequest(self):
        """Test ValidateAndTestPolicyFileRequest"""
