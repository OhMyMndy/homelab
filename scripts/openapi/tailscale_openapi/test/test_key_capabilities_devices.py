...
class TestKeyCapabilitiesDevices(unittest.TestCase):
    """KeyCapabilitiesDevices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyCapabilitiesDevices:
        """Test KeyCapabilitiesDevices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyCapabilitiesDevices`
        """
        model = KeyCapabilitiesDevices()
        if include_optional:
            return KeyCapabilitiesDevices(
    ...
    def testKeyCapabilitiesDevices(self):
        """Test KeyCapabilitiesDevices"""
