...
class TestTailnetSettings(unittest.TestCase):
    """TailnetSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TailnetSettings:
        """Test TailnetSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TailnetSettings`
        """
        model = TailnetSettings()
        if include_optional:
