...
class TestAwsExternalId(unittest.TestCase):
    """AwsExternalId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AwsExternalId:
        """Test AwsExternalId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AwsExternalId`
        """
        model = AwsExternalId()
        if include_optional:
