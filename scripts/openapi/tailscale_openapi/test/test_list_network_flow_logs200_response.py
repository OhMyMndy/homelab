...
class TestListNetworkFlowLogs200Response(unittest.TestCase):
    """ListNetworkFlowLogs200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListNetworkFlowLogs200Response:
        """Test ListNetworkFlowLogs200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListNetworkFlowLogs200Response`
        """
        model = ListNetworkFlowLogs200Response()
        if include_optional:
            return ListNetworkFlowLogs200Response(
                logs = [
                    {logged=2024-06-06T15:27:26.583893Z, nodeId=nBLYviWLGB21KTM59, start=2024-06-06T15:25:26.583893Z, end=2024-06-06T15:26:26.583893Z, virtualTraffic=[{proto=ipv4, src=108.86.185.125:52343, dst=108.86.185.126:443, txPkts=10, txBytes=10000, rxPkts=10, rxBytes=10000}], subnetTraffic=[{proto=ipv4, src=108.86.185.125:52343, dst=108.86.185.126:443, txPkts=10, txBytes=10000, rxPkts=10, rxBytes=10000}], exitTraffic=[{proto=ipv4, src=108.86.185.125:52343, dst=108.86.185.126:443, txPkts=10, txBytes=10000, rxPkts=10, rxBytes=10000}], physicalTraffic=[{proto=ipv4, src=108.86.185.125:52343, dst=108.86.185.126:443, txPkts=10, txBytes=10000, rxPkts=10, rxBytes=10000}]}
                    ]
            )
        else:
            return ListNetworkFlowLogs200Response(
    ...
    def testListNetworkFlowLogs200Response(self):
        """Test ListNetworkFlowLogs200Response"""
