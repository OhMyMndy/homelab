...
class TestDeviceInvite(unittest.TestCase):
    """DeviceInvite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInvite:
        """Test DeviceInvite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInvite`
        """
        model = DeviceInvite()
        if include_optional:
            return DeviceInvite(
                ...
                accepted = False,
                accepted_by = tailscale_openapi.models.device_invite_accepted_by.DeviceInvite_acceptedBy(
                    id = 33223, 
