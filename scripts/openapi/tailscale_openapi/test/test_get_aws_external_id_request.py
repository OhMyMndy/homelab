...
class TestGetAwsExternalIdRequest(unittest.TestCase):
    """GetAwsExternalIdRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAwsExternalIdRequest:
        """Test GetAwsExternalIdRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAwsExternalIdRequest`
        """
        model = GetAwsExternalIdRequest()
        if include_optional:
            return GetAwsExternalIdRequest(
                reusable = True
            )
        else:
            return GetAwsExternalIdRequest(
    ...
    def testGetAwsExternalIdRequest(self):
        """Test GetAwsExternalIdRequest"""
