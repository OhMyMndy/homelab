...
class TestDNSApi(unittest.TestCase):
    ...
    def test_get_dns_preferences(self) -> None:
        """Test case for get_dns_preferences

        Get DNS preferences
        """
        pass

    def test_get_split_dns(self) -> None:
        """Test case for get_split_dns

        Get split DNS
        """
        pass

    def test_list_dns_nameservers(self) -> None:
        """Test case for list_dns_nameservers

        List DNS nameservers
        """
        pass

    def test_list_dns_search_paths(self) -> None:
        """Test case for list_dns_search_paths

        List DNS search paths
        """
        pass

    def test_set_dns_nameservers(self) -> None:
        """Test case for set_dns_nameservers

        Set DNS nameservers
        """
        pass

    def test_set_dns_preferences(self) -> None:
        """Test case for set_dns_preferences

        Set DNS preferences
        """
        pass

    def test_set_dns_search_paths(self) -> None:
        """Test case for set_dns_search_paths

        Set DNS search paths
        """
        pass

    def test_set_split_dns(self) -> None:
        """Test case for set_split_dns

        Set split DNS
        """
        pass

    def test_update_split_dns(self) -> None:
        """Test case for update_split_dns
