...
class TestConfigurationAuditLogTarget(unittest.TestCase):
    """ConfigurationAuditLogTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationAuditLogTarget:
        """Test ConfigurationAuditLogTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationAuditLogTarget`
        """
        model = ConfigurationAuditLogTarget()
        if include_optional:
            return ConfigurationAuditLogTarget(
                id = 'nBLYviWLGB21KTM59',
                name = 'silver-robin-horse-albatross-armadillo.taile18a.ts.net',
                type = 'NODE',
                is_ephemeral = True,
                var_property = 'ALLOWED_IPS'
            )
        else:
            return ConfigurationAuditLogTarget(
        )
    ...
    def testConfigurationAuditLogTarget(self):
        """Test ConfigurationAuditLogTarget"""
