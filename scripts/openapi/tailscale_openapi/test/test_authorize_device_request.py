...
class TestAuthorizeDeviceRequest(unittest.TestCase):
    """AuthorizeDeviceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthorizeDeviceRequest:
        """Test AuthorizeDeviceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorizeDeviceRequest`
        """
    ...
    def testAuthorizeDeviceRequest(self):
        """Test AuthorizeDeviceRequest"""
