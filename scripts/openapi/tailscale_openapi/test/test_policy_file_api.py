...
class TestPolicyFileApi(unittest.TestCase):
    """PolicyFileApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PolicyFileApi()

    def tearDown(self) -> None:
        pass

    def test_get_policy_file(self) -> None:
        """Test case for get_policy_file

        Get policy file
        """
        pass

    def test_preview_rule_matches(self) -> None:
        """Test case for preview_rule_matches

        Preview rule matches
        """
        pass

    def test_set_policy_file(self) -> None:
        """Test case for set_policy_file

        Set policy file
        """
        pass

    def test_validate_and_test_policy_file(self) -> None:
        """Test case for validate_and_test_policy_file
