...
class TestValidateAndTestPolicyFileRequestOneOfInner(unittest.TestCase):
    """ValidateAndTestPolicyFileRequestOneOfInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateAndTestPolicyFileRequestOneOfInner:
        """Test ValidateAndTestPolicyFileRequestOneOfInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateAndTestPolicyFileRequestOneOfInner`
        """
        model = ValidateAndTestPolicyFileRequestOneOfInner()
        if include_optional:
            return ValidateAndTestPolicyFileRequestOneOfInner(
    ...
    def testValidateAndTestPolicyFileRequestOneOfInner(self):
        """Test ValidateAndTestPolicyFileRequestOneOfInner"""
