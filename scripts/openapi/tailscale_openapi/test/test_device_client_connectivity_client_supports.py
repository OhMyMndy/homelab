...
class TestDeviceClientConnectivityClientSupports(unittest.TestCase):
    """DeviceClientConnectivityClientSupports unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceClientConnectivityClientSupports:
        """Test DeviceClientConnectivityClientSupports
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceClientConnectivityClientSupports`
        """
        model = DeviceClientConnectivityClientSupports()
        if include_optional:
            return DeviceClientConnectivityClientSupports(
                hair_pinning = False,
                ipv6 = False,
                pcp = False,
                pmp = False,
    ...
    def testDeviceClientConnectivityClientSupports(self):
        """Test DeviceClientConnectivityClientSupports"""
