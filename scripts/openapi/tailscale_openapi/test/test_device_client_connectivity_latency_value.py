...
class TestDeviceClientConnectivityLatencyValue(unittest.TestCase):
    """DeviceClientConnectivityLatencyValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceClientConnectivityLatencyValue:
        """Test DeviceClientConnectivityLatencyValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceClientConnectivityLatencyValue`
        """
        model = DeviceClientConnectivityLatencyValue()
        if include_optional:
            return DeviceClientConnectivityLatencyValue(
                preferred = True,
                latency_ms = 1.337
            )
        else:
    ...
    def testDeviceClientConnectivityLatencyValue(self):
        """Test DeviceClientConnectivityLatencyValue"""
