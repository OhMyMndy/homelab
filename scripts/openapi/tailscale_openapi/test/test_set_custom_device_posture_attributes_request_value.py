...
class TestSetCustomDevicePostureAttributesRequestValue(unittest.TestCase):
    """SetCustomDevicePostureAttributesRequestValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetCustomDevicePostureAttributesRequestValue:
        """Test SetCustomDevicePostureAttributesRequestValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetCustomDevicePostureAttributesRequestValue`
        """
        model = SetCustomDevicePostureAttributesRequestValue()
        if include_optional:
            return SetCustomDevicePostureAttributesRequestValue(
            )
        else:
            return SetCustomDevicePostureAttributesRequestValue(
        )
    ...
    def testSetCustomDevicePostureAttributesRequestValue(self):
        """Test SetCustomDevicePostureAttributesRequestValue"""
