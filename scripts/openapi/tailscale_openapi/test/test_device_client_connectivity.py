...
class TestDeviceClientConnectivity(unittest.TestCase):
    """DeviceClientConnectivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceClientConnectivity:
        """Test DeviceClientConnectivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceClientConnectivity`
        """
        model = DeviceClientConnectivity()
        if include_optional:
            return DeviceClientConnectivity(
                ...
                client_supports = tailscale_openapi.models.device_client_connectivity_client_supports.Device_clientConnectivity_clientSupports(
                    hair_pinning = False, 
                    ipv6 = False, 
                    pcp = False, 
                    pmp = False, 
    ...
    def testDeviceClientConnectivity(self):
        """Test DeviceClientConnectivity"""
