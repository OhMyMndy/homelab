...
class TestDeviceInviteAcceptedBy(unittest.TestCase):
    """DeviceInviteAcceptedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInviteAcceptedBy:
        """Test DeviceInviteAcceptedBy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInviteAcceptedBy`
        """
        model = DeviceInviteAcceptedBy()
        if include_optional:
            return DeviceInviteAcceptedBy(
                id = 33223,
    ...
    def testDeviceInviteAcceptedBy(self):
        """Test DeviceInviteAcceptedBy"""
