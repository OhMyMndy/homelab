...
class TestKeyCapabilities(unittest.TestCase):
    """KeyCapabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyCapabilities:
        """Test KeyCapabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyCapabilities`
        """
