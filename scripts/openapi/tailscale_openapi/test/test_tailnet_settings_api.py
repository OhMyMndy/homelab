...
class TestTailnetSettingsApi(unittest.TestCase):
    """TailnetSettingsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TailnetSettingsApi()

    def tearDown(self) -> None:
        pass

    def test_get_tailnet_settings(self) -> None:
        """Test case for get_tailnet_settings

        Get tailnet settings
        """
        pass

    def test_update_tailnet_settings(self) -> None:
        """Test case for update_tailnet_settings
