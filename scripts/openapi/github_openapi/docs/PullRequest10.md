...
**head** | [**PullRequest10Head**](PullRequest10Head.md) |  | 
**html_url** | **str** |  | 
**id** | **int** |  | 
**issue_url** | **str** |  | 
...
json = "{}"
# create an instance of PullRequest10 from a JSON string
pull_request10_instance = PullRequest10.from_json(json)
# print the JSON string representation of the object
print(PullRequest10.to_json())

# convert the object into a dict
pull_request10_dict = pull_request10_instance.to_dict()
# create an instance of PullRequest10 from a dict
pull_request10_from_dict = PullRequest10.from_dict(pull_request10_dict)
```
