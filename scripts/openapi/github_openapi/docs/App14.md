...
json = "{}"
# create an instance of App14 from a JSON string
app14_instance = App14.from_json(json)
# print the JSON string representation of the object
print(App14.to_json())

# convert the object into a dict
app14_dict = app14_instance.to_dict()
# create an instance of App14 from a dict
app14_from_dict = App14.from_dict(app14_dict)
```
