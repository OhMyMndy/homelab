...
json = "{}"
# create an instance of Issue3 from a JSON string
issue3_instance = Issue3.from_json(json)
# print the JSON string representation of the object
print(Issue3.to_json())

# convert the object into a dict
issue3_dict = issue3_instance.to_dict()
# create an instance of Issue3 from a dict
issue3_from_dict = Issue3.from_dict(issue3_dict)
```
