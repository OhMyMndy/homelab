...
json = "{}"
# create an instance of App9 from a JSON string
app9_instance = App9.from_json(json)
# print the JSON string representation of the object
print(App9.to_json())

# convert the object into a dict
app9_dict = app9_instance.to_dict()
# create an instance of App9 from a dict
app9_from_dict = App9.from_dict(app9_dict)
```
