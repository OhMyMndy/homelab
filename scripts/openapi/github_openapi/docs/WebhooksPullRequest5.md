...
**requested_reviewers** | [**List[WebhooksPullRequest5RequestedReviewersInner]**](WebhooksPullRequest5RequestedReviewersInner.md) |  | 
...
json = "{}"
# create an instance of WebhooksPullRequest5 from a JSON string
webhooks_pull_request5_instance = WebhooksPullRequest5.from_json(json)
# print the JSON string representation of the object
print(WebhooksPullRequest5.to_json())

# convert the object into a dict
webhooks_pull_request5_dict = webhooks_pull_request5_instance.to_dict()
# create an instance of WebhooksPullRequest5 from a dict
webhooks_pull_request5_from_dict = WebhooksPullRequest5.from_dict(webhooks_pull_request5_dict)
```
