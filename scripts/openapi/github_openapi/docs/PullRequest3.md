...
json = "{}"
# create an instance of PullRequest3 from a JSON string
pull_request3_instance = PullRequest3.from_json(json)
# print the JSON string representation of the object
print(PullRequest3.to_json())

# convert the object into a dict
pull_request3_dict = pull_request3_instance.to_dict()
# create an instance of PullRequest3 from a dict
pull_request3_from_dict = PullRequest3.from_dict(pull_request3_dict)
```
