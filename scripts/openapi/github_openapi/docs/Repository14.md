...
**merge_commit_message** | **str** | The default value for a merge commit message. | [optional] 
**merge_commit_title** | **str** | The default value for a merge commit message title. | [optional] 
**merges_url** | **str** |  | 
**milestones_url** | **str** |  | 
**mirror_url** | **str** |  | 
...
json = "{}"
# create an instance of Repository14 from a JSON string
repository14_instance = Repository14.from_json(json)
# print the JSON string representation of the object
print(Repository14.to_json())

# convert the object into a dict
repository14_dict = repository14_instance.to_dict()
# create an instance of Repository14 from a dict
repository14_from_dict = Repository14.from_dict(repository14_dict)
```
