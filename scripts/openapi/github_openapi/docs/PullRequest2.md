...
**head** | [**PullRequest2Head**](PullRequest2Head.md) |  | 
**html_url** | **str** |  | 
**id** | **int** |  | 
**issue_url** | **str** |  | 
...
json = "{}"
# create an instance of PullRequest2 from a JSON string
pull_request2_instance = PullRequest2.from_json(json)
# print the JSON string representation of the object
print(PullRequest2.to_json())

# convert the object into a dict
pull_request2_dict = pull_request2_instance.to_dict()
# create an instance of PullRequest2 from a dict
pull_request2_from_dict = PullRequest2.from_dict(pull_request2_dict)
```
