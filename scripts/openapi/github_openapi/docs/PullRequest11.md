...
json = "{}"
# create an instance of PullRequest11 from a JSON string
pull_request11_instance = PullRequest11.from_json(json)
# print the JSON string representation of the object
print(PullRequest11.to_json())

# convert the object into a dict
pull_request11_dict = pull_request11_instance.to_dict()
# create an instance of PullRequest11 from a dict
pull_request11_from_dict = PullRequest11.from_dict(pull_request11_dict)
```
