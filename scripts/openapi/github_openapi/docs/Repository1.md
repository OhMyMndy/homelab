...
**git_tags_url** | **str** |  | 
**git_url** | **str** |  | 
**has_discussions** | **bool** | Whether the repository has discussions enabled. | [optional] 
...
**watchers** | **int** |  | 
**watchers_count** | **int** |  | 
**web_commit_signoff_required** | **bool** | Whether to require commit signoff. | [optional] 
...
repository1_instance = Repository1.from_json(json)
# print the JSON string representation of the object
print(Repository1.to_json())

# convert the object into a dict
repository1_dict = repository1_instance.to_dict()
# create an instance of Repository1 from a dict
repository1_from_dict = Repository1.from_dict(repository1_dict)
```
