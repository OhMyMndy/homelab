...
**size** | **int** |  | 
**squash_merge_commit_message** | **str** | The default value for a squash merge commit message. | [optional] 
**squash_merge_commit_title** | **str** | The default value for a squash merge commit title. | [optional] 
**ssh_url** | **str** |  | 
...
json = "{}"
# create an instance of Repository10 from a JSON string
repository10_instance = Repository10.from_json(json)
# print the JSON string representation of the object
print(Repository10.to_json())

# convert the object into a dict
repository10_dict = repository10_instance.to_dict()
# create an instance of Repository10 from a dict
repository10_from_dict = Repository10.from_dict(repository10_dict)
```
