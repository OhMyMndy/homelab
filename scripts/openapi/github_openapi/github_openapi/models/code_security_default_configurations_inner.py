...
class CodeSecurityDefaultConfigurationsInner(BaseModel):
    """
    CodeSecurityDefaultConfigurationsInner
    """ # noqa: E501
    default_for_new_repos: Optional[StrictStr] = Field(default=None, description="The visibility of newly created repositories for which the code security configuration will be applied to by default")
    ...
    def default_for_new_repos_validate_enum(cls, value):
        ...
        if value not in set(['public', 'private_and_internal', 'all']):
            raise ValueError("must be one of enum values ('public', 'private_and_internal', 'all')")
        return value
