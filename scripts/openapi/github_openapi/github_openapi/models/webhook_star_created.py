...
class WebhookStarCreated(BaseModel):
    ...
    sender: SimpleUser
    starred_at: Optional[StrictStr] = Field(description="The time the star was created. This is a timestamp in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. Will be `null` for the `deleted` action.")
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "repository", "sender", "starred_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if starred_at (nullable) is None
        # and model_fields_set contains the field
        if self.starred_at is None and "starred_at" in self.model_fields_set:
            _dict['starred_at'] = None
