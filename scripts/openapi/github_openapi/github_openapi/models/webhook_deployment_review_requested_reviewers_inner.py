...
class WebhookDeploymentReviewRequestedReviewersInner(BaseModel):
    """
    WebhookDeploymentReviewRequestedReviewersInner
    """ # noqa: E501
    reviewer: Optional[User6] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reviewer": User6.from_dict(obj["reviewer"]) if obj.get("reviewer") is not None else None,
            "type": obj.get("type")
        })
        return _obj
