...
class WebhookProjectsV2ItemReordered(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['reordered']):
            raise ValueError("must be one of enum values ('reordered')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectsV2ItemReorderedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
