...
class DeploymentWorkflowRun4(BaseModel):
    """
    ...
    def conclusion_validate_enum(cls, value):
        ...
        if value not in set(['success', 'failure', 'neutral', 'cancelled', 'timed_out', 'action_required', 'stale', 'startup_failure']):
            raise ValueError("must be one of enum values ('success', 'failure', 'neutral', 'cancelled', 'timed_out', 'action_required', 'stale', 'startup_failure')")
        return value
