...
class WebhookMarketplacePurchasePendingChangeCancelled(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pending_change_cancelled']):
            raise ValueError("must be one of enum values ('pending_change_cancelled')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "marketplace_purchase": MarketplacePurchase2.from_dict(obj["marketplace_purchase"]) if obj.get("marketplace_purchase") is not None else None,
