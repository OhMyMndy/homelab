...
class DemilestonedIssueEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app", "milestone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "milestone": MilestonedIssueEventMilestone.from_dict(obj["milestone"]) if obj.get("milestone") is not None else None
        })
        return _obj
