...
class WebhookCodeScanningAlertReopenedByUser(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['reopened_by_user']):
            raise ValueError("must be one of enum values ('reopened_by_user')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alert": WebhookCodeScanningAlertReopenedByUserAlert.from_dict(obj["alert"]) if obj.get("alert") is not None else None,
