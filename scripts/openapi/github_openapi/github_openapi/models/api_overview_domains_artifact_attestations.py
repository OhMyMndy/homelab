...
class ApiOverviewDomainsArtifactAttestations(BaseModel):
    """
    ApiOverviewDomainsArtifactAttestations
    """ # noqa: E501
    trust_domain: Optional[StrictStr] = None
    services: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["trust_domain", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trust_domain": obj.get("trust_domain"),
