...
class CodeScanningDefaultSetupUpdateResponse(BaseModel):
    ...
    """ # noqa: E501
    run_id: Optional[StrictInt] = Field(default=None, description="ID of the corresponding run.")
    run_url: Optional[StrictStr] = Field(default=None, description="URL of the corresponding run.")
    __properties: ClassVar[List[str]] = ["run_id", "run_url"]
