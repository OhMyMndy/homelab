...
class TimelineCommitCommentedEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event", "node_id", "commit_id", "comments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comments": [CommitComment.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None
        })
        return _obj
