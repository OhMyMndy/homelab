...
class CodespacesCreateWithPrForAuthenticatedUserRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["location", "geo", "client_ip", "machine", "devcontainer_path", "multi_repo_permissions_opt_out", "working_directory", "idle_timeout_minutes", "display_name", "retention_period_minutes"]
