...
class WebhookStarDeleted(BaseModel):
    ...
    sender: SimpleUser
    starred_at: Optional[Any] = Field(description="The time the star was created. This is a timestamp in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. Will be `null` for the `deleted` action.")
