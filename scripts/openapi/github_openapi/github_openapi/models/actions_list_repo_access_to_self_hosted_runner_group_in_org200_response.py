...
class ActionsListRepoAccessToSelfHostedRunnerGroupInOrg200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["total_count", "repositories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repositories": [MinimalRepository.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None
        })
        return _obj
