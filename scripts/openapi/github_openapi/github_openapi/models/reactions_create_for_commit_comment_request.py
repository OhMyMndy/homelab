...
class ReactionsCreateForCommitCommentRequest(BaseModel):
    """
    ReactionsCreateForCommitCommentRequest
    """ # noqa: E501
    content: StrictStr = Field(description="The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the commit comment.")
