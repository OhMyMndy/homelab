...
class WebhookPullRequestReviewDismissedReview(BaseModel):
    """
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['dismissed', 'approved', 'changes_requested']):
            raise ValueError("must be one of enum values ('dismissed', 'approved', 'changes_requested')")
        return value
