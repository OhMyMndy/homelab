...
class WebhookPullRequestAutoMergeDisabled(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['auto_merge_disabled']):
            raise ValueError("must be one of enum values ('auto_merge_disabled')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_request": PullRequest1.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
