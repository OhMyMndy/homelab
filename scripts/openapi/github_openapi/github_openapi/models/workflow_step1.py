...
class WorkflowStep1(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['in_progress', 'completed', 'queued', 'pending']):
            raise ValueError("must be one of enum values ('in_progress', 'completed', 'queued', 'pending')")
        return value
