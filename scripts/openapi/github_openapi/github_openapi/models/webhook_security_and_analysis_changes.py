...
class WebhookSecurityAndAnalysisChanges(BaseModel):
    """
    WebhookSecurityAndAnalysisChanges
    """ # noqa: E501
    var_from: Optional[WebhookSecurityAndAnalysisChangesFrom] = Field(default=None, alias="from")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": WebhookSecurityAndAnalysisChangesFrom.from_dict(obj["from"]) if obj.get("from") is not None else None
        })
        return _obj
