...
class WebhookInstallationRepositoriesAddedRepositoriesRemovedInner(BaseModel):
    """
    WebhookInstallationRepositoriesAddedRepositoriesRemovedInner
    """ # noqa: E501
    full_name: Optional[StrictStr] = None
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the repository")
    name: Optional[StrictStr] = Field(default=None, description="The name of the repository.")
    node_id: Optional[StrictStr] = None
    private: Optional[StrictBool] = Field(default=None, description="Whether the repository is private or public.")
    __properties: ClassVar[List[str]] = ["full_name", "id", "name", "node_id", "private"]
