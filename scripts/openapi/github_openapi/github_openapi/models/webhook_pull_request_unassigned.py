...
class WebhookPullRequestUnassigned(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    assignee: Optional[WebhooksUserMannequin] = None
    ...
    __properties: ClassVar[List[str]] = ["action", "assignee", "enterprise", "installation", "number", "organization", "pull_request", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unassigned']):
            raise ValueError("must be one of enum values ('unassigned')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignee": WebhooksUserMannequin.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
            ...
            "pull_request": PullRequest11.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
