...
class PullRequest6(BaseModel):
    ...
    diff_url: StrictStr
    draft: StrictBool = Field(description="Indicates whether or not the pull request is a draft.")
    ...
    labels: List[Label]
    locked: StrictBool
    maintainer_can_modify: Optional[StrictBool] = Field(default=None, description="Indicates whether maintainers can modify the pull request.")
    ...
    requested_reviewers: List[PullRequest6RequestedReviewersInner]
    requested_teams: List[Team1]
    review_comment_url: StrictStr
    review_comments: Optional[StrictInt] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if merged (nullable) is None
        # and model_fields_set contains the field
        if self.merged is None and "merged" in self.model_fields_set:
            _dict['merged'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "base": PullRequest6Base.from_dict(obj["base"]) if obj.get("base") is not None else None,
            "body": obj.get("body"),
            ...
            "draft": obj.get("draft"),
            "head": PullRequestBase.from_dict(obj["head"]) if obj.get("head") is not None else None,
            ...
            "merged_by": User2.from_dict(obj["merged_by"]) if obj.get("merged_by") is not None else None,
            ...
            "requested_reviewers": [PullRequest6RequestedReviewersInner.from_dict(_item) for _item in obj["requested_reviewers"]] if obj.get("requested_reviewers") is not None else None,
            "requested_teams": [Team1.from_dict(_item) for _item in obj["requested_teams"]] if obj.get("requested_teams") is not None else None,
