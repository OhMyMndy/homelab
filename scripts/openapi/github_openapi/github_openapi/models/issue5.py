...
class Issue5(BaseModel):
    ...
    node_id: StrictStr
    number: StrictInt
    performed_via_github_app: Optional[App15] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "performed_via_github_app": App15.from_dict(obj["performed_via_github_app"]) if obj.get("performed_via_github_app") is not None else None,
