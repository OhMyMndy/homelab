...
class WebhookPersonalAccessTokenRequestCreated(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "personal_access_token_request", "enterprise", "organization", "sender", "installation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of personal_access_token_request
        if self.personal_access_token_request:
            _dict['personal_access_token_request'] = self.personal_access_token_request.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "personal_access_token_request": PersonalAccessTokenRequest.from_dict(obj["personal_access_token_request"]) if obj.get("personal_access_token_request") is not None else None,
