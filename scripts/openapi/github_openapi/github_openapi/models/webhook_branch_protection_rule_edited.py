...
class WebhookBranchProtectionRuleEdited(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookBranchProtectionRuleEditedChanges] = None
    ...
    rule: WebhooksRule
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "repository", "rule", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookBranchProtectionRuleEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "rule": WebhooksRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
