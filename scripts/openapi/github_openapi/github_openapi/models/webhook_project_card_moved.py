...
class WebhookProjectCardMoved(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookProjectCardMovedChanges] = None
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "project_card", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['moved']):
            raise ValueError("must be one of enum values ('moved')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectCardMovedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "project_card": WebhookProjectCardMovedProjectCard.from_dict(obj["project_card"]) if obj.get("project_card") is not None else None,
