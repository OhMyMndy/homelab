...
class WebhookOrgBlockUnblocked(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    blocked_user: Optional[WebhooksUser]
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "blocked_user", "enterprise", "installation", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unblocked']):
            raise ValueError("must be one of enum values ('unblocked')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of blocked_user
        if self.blocked_user:
            _dict['blocked_user'] = self.blocked_user.to_dict()
        ...
        # set to None if blocked_user (nullable) is None
        # and model_fields_set contains the field
        if self.blocked_user is None and "blocked_user" in self.model_fields_set:
            _dict['blocked_user'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blocked_user": WebhooksUser.from_dict(obj["blocked_user"]) if obj.get("blocked_user") is not None else None,
