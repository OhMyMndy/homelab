...
class ReposUpdateRequestSecurityAndAnalysisSecretScanningNonProviderPatterns(BaseModel):
    """
    ...
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Can be `enabled` or `disabled`.")
