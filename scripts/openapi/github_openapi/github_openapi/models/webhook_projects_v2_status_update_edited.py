...
class WebhookProjectsV2StatusUpdateEdited(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookProjectsV2StatusUpdateEditedChanges] = None
    installation: Optional[SimpleInstallation] = None
    organization: OrganizationSimpleWebhooks
    projects_v2_status_update: ProjectsV2StatusUpdate
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "installation", "organization", "projects_v2_status_update", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['edited']):
            raise ValueError("must be one of enum values ('edited')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of projects_v2_status_update
        if self.projects_v2_status_update:
            _dict['projects_v2_status_update'] = self.projects_v2_status_update.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectsV2StatusUpdateEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "projects_v2_status_update": ProjectsV2StatusUpdate.from_dict(obj["projects_v2_status_update"]) if obj.get("projects_v2_status_update") is not None else None,
