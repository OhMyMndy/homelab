...
class ProjectsMoveCard503Response(BaseModel):
    """
    ...
    errors: Optional[List[ProjectsMoveCard503ResponseErrorsInner]] = None
    __properties: ClassVar[List[str]] = ["code", "message", "documentation_url", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [ProjectsMoveCard503ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
