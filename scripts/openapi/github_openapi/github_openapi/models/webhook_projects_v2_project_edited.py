...
class WebhookProjectsV2ProjectEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "installation", "organization", "projects_v2", "sender"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of projects_v2
        if self.projects_v2:
            _dict['projects_v2'] = self.projects_v2.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectsV2ProjectEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "projects_v2": ProjectsV2.from_dict(obj["projects_v2"]) if obj.get("projects_v2") is not None else None,
