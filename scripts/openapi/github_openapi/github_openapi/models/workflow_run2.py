...
class WorkflowRun2(BaseModel):
    ...
    pull_requests: List[WorkflowRun2PullRequestsInner]
    ...
    def conclusion_validate_enum(cls, value):
        ...
        if value not in set(['success', 'failure', 'neutral', 'cancelled', 'timed_out', 'action_required', 'stale', 'skipped', 'startup_failure']):
            raise ValueError("must be one of enum values ('success', 'failure', 'neutral', 'cancelled', 'timed_out', 'action_required', 'stale', 'skipped', 'startup_failure')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_requests": [WorkflowRun2PullRequestsInner.from_dict(_item) for _item in obj["pull_requests"]] if obj.get("pull_requests") is not None else None,
