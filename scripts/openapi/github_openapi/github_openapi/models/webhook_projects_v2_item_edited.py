...
class WebhookProjectsV2ItemEdited(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookProjectsV2ItemEditedChanges] = None
    installation: Optional[SimpleInstallation] = None
    organization: OrganizationSimpleWebhooks
    projects_v2_item: ProjectsV2Item
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "installation", "organization", "projects_v2_item", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectsV2ItemEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
