...
class WebhookCodeScanningAlertReopenedAlert(BaseModel):
    """
    ...
    dismissed_at: Optional[StrictStr] = Field(description="The time that the alert was dismissed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.")
    dismissed_by: Optional[Dict[str, Any]]
    dismissed_reason: Optional[StrictStr] = Field(description="The reason for dismissing or closing the alert. Can be one of: `false positive`, `won't fix`, and `used in tests`.")
