...
class WebhookCheckSuiteRerequested(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "check_suite", "enterprise", "installation", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['rerequested']):
            raise ValueError("must be one of enum values ('rerequested')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "check_suite": WebhookCheckSuiteRerequestedCheckSuite.from_dict(obj["check_suite"]) if obj.get("check_suite") is not None else None,
