...
class ActionsListRepoOrganizationVariables200Response(BaseModel):
    """
    ActionsListRepoOrganizationVariables200Response
    """ # noqa: E501
    total_count: StrictInt
    variables: List[ActionsVariable]
    __properties: ClassVar[List[str]] = ["total_count", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variables": [ActionsVariable.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
