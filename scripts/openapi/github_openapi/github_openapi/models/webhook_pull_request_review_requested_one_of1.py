...
class WebhookPullRequestReviewRequestedOneOf1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_request": PullRequest9.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
