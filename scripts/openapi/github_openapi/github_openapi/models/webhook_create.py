...
class WebhookCreate(BaseModel):
    ...
    WebhookCreate
    """ # noqa: E501
    description: Optional[StrictStr] = Field(description="The repository's current description.")
    enterprise: Optional[EnterpriseWebhooks] = None
    installation: Optional[SimpleInstallation] = None
    master_branch: StrictStr = Field(description="The name of the repository's default branch (usually `main`).")
    ...
    ref_type: StrictStr = Field(description="The type of Git ref object created in the repository.")
    repository: RepositoryWebhooks
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["description", "enterprise", "installation", "master_branch", "organization", "pusher_type", "ref", "ref_type", "repository", "sender"]
