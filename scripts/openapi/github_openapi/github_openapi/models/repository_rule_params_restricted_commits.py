...
class RepositoryRuleParamsRestrictedCommits(BaseModel):
    ...
    Restricted commit
    """ # noqa: E501
    oid: StrictStr = Field(description="Full or abbreviated commit hash to reject")
    reason: Optional[StrictStr] = Field(default=None, description="Reason for restriction")
    __properties: ClassVar[List[str]] = ["oid", "reason"]
