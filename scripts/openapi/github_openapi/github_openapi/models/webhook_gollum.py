...
class WebhookGollum(BaseModel):
    ...
    pages: List[WebhookGollumPagesInner] = Field(description="The pages that were updated.")
    repository: RepositoryWebhooks
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["enterprise", "installation", "organization", "pages", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [WebhookGollumPagesInner.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
