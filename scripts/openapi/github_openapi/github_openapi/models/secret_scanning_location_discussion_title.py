...
class SecretScanningLocationDiscussionTitle(BaseModel):
    ...
    """ # noqa: E501
    discussion_title_url: StrictStr = Field(description="The URL to the discussion where the secret was detected.")
    __properties: ClassVar[List[str]] = ["discussion_title_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discussion_title_url": obj.get("discussion_title_url")
        })
        return _obj
