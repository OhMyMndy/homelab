...
class WebhookMarketplacePurchasePendingChange(BaseModel):
    ...
    previous_marketplace_purchase: Optional[MarketplacePurchase1] = None
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pending_change']):
            raise ValueError("must be one of enum values ('pending_change')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "previous_marketplace_purchase": MarketplacePurchase1.from_dict(obj["previous_marketplace_purchase"]) if obj.get("previous_marketplace_purchase") is not None else None,
