...
class FileCommit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content", "commit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": FileCommitContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "commit": FileCommitCommit.from_dict(obj["commit"]) if obj.get("commit") is not None else None
        })
        return _obj
