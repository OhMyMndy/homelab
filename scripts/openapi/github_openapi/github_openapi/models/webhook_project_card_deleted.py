...
class WebhookProjectCardDeleted(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "project_card", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project_card": ProjectCard.from_dict(obj["project_card"]) if obj.get("project_card") is not None else None,
