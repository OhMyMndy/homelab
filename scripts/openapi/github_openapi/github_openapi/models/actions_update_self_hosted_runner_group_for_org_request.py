...
class ActionsUpdateSelfHostedRunnerGroupForOrgRequest(BaseModel):
    """
    ActionsUpdateSelfHostedRunnerGroupForOrgRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the runner group.")
    visibility: Optional[StrictStr] = Field(default=None, description="Visibility of a runner group. You can select all repositories, select individual repositories, or all private repositories.")
    ...
    __properties: ClassVar[List[str]] = ["name", "visibility", "allows_public_repositories", "restricted_to_workflows", "selected_workflows"]
