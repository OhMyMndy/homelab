...
class WebhookOrganizationRenamed(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookOrganizationRenamedChanges] = None
    enterprise: Optional[EnterpriseWebhooks] = None
    installation: Optional[SimpleInstallation] = None
    membership: Optional[WebhooksMembership] = None
    organization: OrganizationSimpleWebhooks
    repository: Optional[RepositoryWebhooks] = None
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "membership", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['renamed']):
            raise ValueError("must be one of enum values ('renamed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookOrganizationRenamedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "membership": WebhooksMembership.from_dict(obj["membership"]) if obj.get("membership") is not None else None,
