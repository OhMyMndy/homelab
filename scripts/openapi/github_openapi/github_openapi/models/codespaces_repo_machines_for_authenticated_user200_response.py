...
class CodespacesRepoMachinesForAuthenticatedUser200Response(BaseModel):
    """
    CodespacesRepoMachinesForAuthenticatedUser200Response
    """ # noqa: E501
    total_count: StrictInt
    machines: List[CodespaceMachine]
    __properties: ClassVar[List[str]] = ["total_count", "machines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "machines": [CodespaceMachine.from_dict(_item) for _item in obj["machines"]] if obj.get("machines") is not None else None
        })
        return _obj
