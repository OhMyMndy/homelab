...
class WebhookPullRequestEditedChangesBase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ref", "sha"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sha
        if self.sha:
            _dict['sha'] = self.sha.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ref": WebhookDiscussionCommentEditedChangesBody.from_dict(obj["ref"]) if obj.get("ref") is not None else None,
            "sha": WebhookDiscussionCommentEditedChangesBody.from_dict(obj["sha"]) if obj.get("sha") is not None else None
        })
        return _obj
