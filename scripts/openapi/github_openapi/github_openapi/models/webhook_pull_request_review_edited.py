...
class WebhookPullRequestReviewEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "pull_request", "repository", "review", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookPullRequestReviewEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "pull_request": SimplePullRequest1.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
            "repository": RepositoryWebhooks.from_dict(obj["repository"]) if obj.get("repository") is not None else None,
            "review": WebhooksReview.from_dict(obj["review"]) if obj.get("review") is not None else None,
