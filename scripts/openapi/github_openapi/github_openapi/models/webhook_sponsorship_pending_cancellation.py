...
class WebhookSponsorshipPendingCancellation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "effective_date", "enterprise", "installation", "organization", "repository", "sender", "sponsorship"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pending_cancellation']):
            raise ValueError("must be one of enum values ('pending_cancellation')")
        return value
