...
class WebhookRepositoryUnarchived(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unarchived']):
            raise ValueError("must be one of enum values ('unarchived')")
        return value
