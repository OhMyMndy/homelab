...
class WebhooksTeamParent(BaseModel):
    """
    WebhooksTeamParent
    """ # noqa: E501
    ...
    privacy: StrictStr
    notification_setting: StrictStr = Field(description="Whether team members will receive notifications when their team is @mentioned")
    repositories_url: StrictStr
    slug: StrictStr
    url: StrictStr = Field(description="URL for the team")
    __properties: ClassVar[List[str]] = ["description", "html_url", "id", "members_url", "name", "node_id", "permission", "privacy", "notification_setting", "repositories_url", "slug", "url"]
