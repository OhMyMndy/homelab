...
class WebhookSecretScanningAlertLocationCreated(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "alert", "installation", "location", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": SecretScanningLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
