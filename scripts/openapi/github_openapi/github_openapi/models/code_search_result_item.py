...
class CodeSearchResultItem(BaseModel):
    ...
    line_numbers: Optional[List[StrictStr]] = None
    text_matches: Optional[List[SearchResultTextMatchesInner]] = None
    __properties: ClassVar[List[str]] = ["name", "path", "sha", "url", "git_url", "html_url", "repository", "score", "file_size", "language", "last_modified_at", "line_numbers", "text_matches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "line_numbers": obj.get("line_numbers"),
