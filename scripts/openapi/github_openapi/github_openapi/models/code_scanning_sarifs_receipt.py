...
class CodeScanningSarifsReceipt(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="An identifier for the upload.")
    url: Optional[StrictStr] = Field(default=None, description="The REST API URL for checking the status of the upload.")
