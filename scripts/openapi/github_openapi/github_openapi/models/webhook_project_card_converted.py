...
class WebhookProjectCardConverted(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['converted']):
            raise ValueError("must be one of enum values ('converted')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectCardConvertedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "project_card": WebhooksProjectCard.from_dict(obj["project_card"]) if obj.get("project_card") is not None else None,
