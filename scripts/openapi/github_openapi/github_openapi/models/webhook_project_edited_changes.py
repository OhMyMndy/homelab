...
class WebhookProjectEditedChanges(BaseModel):
    """
    The changes to the project if the action was `edited`.
    """ # noqa: E501
    body: Optional[WebhookProjectEditedChangesBody] = None
    name: Optional[WebhookProjectEditedChangesName] = None
    __properties: ClassVar[List[str]] = ["body", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": WebhookProjectEditedChangesName.from_dict(obj["name"]) if obj.get("name") is not None else None
        })
        return _obj
