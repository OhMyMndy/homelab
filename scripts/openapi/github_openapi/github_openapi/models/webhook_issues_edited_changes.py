...
class WebhookIssuesEditedChanges(BaseModel):
    """
    The changes to the issue.
    """ # noqa: E501
    body: Optional[WebhooksChangesBody] = None
    title: Optional[WebhookIssuesEditedChangesTitle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": WebhooksChangesBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
            "title": WebhookIssuesEditedChangesTitle.from_dict(obj["title"]) if obj.get("title") is not None else None
        })
        return _obj
