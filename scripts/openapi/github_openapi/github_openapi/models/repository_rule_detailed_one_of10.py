...
class RepositoryRuleDetailedOneOf10(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['commit_message_pattern']):
            raise ValueError("must be one of enum values ('commit_message_pattern')")
        return value
