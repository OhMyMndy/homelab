...
class CustomPropertyValue(BaseModel):
    ...
    value: Optional[CustomPropertyValueValue]
    __properties: ClassVar[List[str]] = ["property_name", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": CustomPropertyValueValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
