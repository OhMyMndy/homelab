...
class OrgsListAttestations200ResponseAttestationsInner(BaseModel):
    """
    OrgsListAttestations200ResponseAttestationsInner
    """ # noqa: E501
    bundle: Optional[OrgsListAttestations200ResponseAttestationsInnerBundle] = None
    repository_id: Optional[StrictInt] = None
    bundle_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["bundle", "repository_id", "bundle_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bundle": OrgsListAttestations200ResponseAttestationsInnerBundle.from_dict(obj["bundle"]) if obj.get("bundle") is not None else None,
