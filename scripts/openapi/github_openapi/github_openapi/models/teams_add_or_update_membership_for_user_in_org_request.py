...
class TeamsAddOrUpdateMembershipForUserInOrgRequest(BaseModel):
    """
    TeamsAddOrUpdateMembershipForUserInOrgRequest
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default='member', description="The role that this user should have in the team.")
