...
class ReposGetAllEnvironments200Response(BaseModel):
    """
    ReposGetAllEnvironments200Response
    """ # noqa: E501
    total_count: Optional[StrictInt] = Field(default=None, description="The number of environments in this repository")
    environments: Optional[List[Environment]] = None
    __properties: ClassVar[List[str]] = ["total_count", "environments"]
