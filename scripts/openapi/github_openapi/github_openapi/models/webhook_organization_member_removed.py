...
class WebhookOrganizationMemberRemoved(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "membership", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['member_removed']):
            raise ValueError("must be one of enum values ('member_removed')")
        return value
