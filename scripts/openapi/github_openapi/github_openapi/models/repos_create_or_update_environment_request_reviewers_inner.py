...
class ReposCreateOrUpdateEnvironmentRequestReviewersInner(BaseModel):
    """
    ReposCreateOrUpdateEnvironmentRequestReviewersInner
    """ # noqa: E501
    type: Optional[DeploymentReviewerType] = None
    id: Optional[StrictInt] = Field(default=None, description="The id of the user or team who can review the deployment")
