...
class RepositoryAdvisoryCreateVulnerabilitiesInnerPackage(BaseModel):
    """
    The name of the package affected by the vulnerability.
    """ # noqa: E501
    ecosystem: SecurityAdvisoryEcosystems
    name: Optional[StrictStr] = Field(default=None, description="The unique package name within its ecosystem.")
