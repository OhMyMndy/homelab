...
class CodespacesListDevcontainersInRepositoryForAuthenticatedUser200ResponseDevcontainersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["path", "name", "display_name"]
