...
class WebhookIssuesClosedIssue(BaseModel):
    """
    The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
    """ # noqa: E501
    active_lock_reason: Optional[StrictStr]
    assignee: Optional[Dict[str, Any]] = None
    assignees: List[Optional[Dict[str, Any]]]
    author_association: StrictStr
    ...
    html_url: StrictStr
    id: StrictInt
    labels: Optional[List[Optional[Dict[str, Any]]]] = None
    labels_url: StrictStr
    locked: Optional[StrictBool] = None
    milestone: Optional[Dict[str, Any]]
    node_id: StrictStr
    number: StrictInt
    performed_via_github_app: Optional[Dict[str, Any]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "performed_via_github_app": obj.get("performed_via_github_app"),
            "pull_request": WebhooksIssuePullRequest.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
            "reactions": WebhookIssueCommentCreatedIssueAllOfReactions.from_dict(obj["reactions"]) if obj.get("reactions") is not None else None,
            ...
            "url": obj.get("url"),
            "user": WebhookIssueCommentDeletedIssueAllOfUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
