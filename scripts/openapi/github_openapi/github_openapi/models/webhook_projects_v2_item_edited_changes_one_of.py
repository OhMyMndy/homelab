...
class WebhookProjectsV2ItemEditedChangesOneOf(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field_value": WebhookProjectsV2ItemEditedChangesOneOfFieldValue.from_dict(obj["field_value"]) if obj.get("field_value") is not None else None
        })
        return _obj
