...
class CopilotAddCopilotSeatsForTeams201Response(BaseModel):
    """
    The total number of seats created for members of the specified team(s).
    """ # noqa: E501
    seats_created: StrictInt
    __properties: ClassVar[List[str]] = ["seats_created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "seats_created": obj.get("seats_created")
        })
        return _obj
