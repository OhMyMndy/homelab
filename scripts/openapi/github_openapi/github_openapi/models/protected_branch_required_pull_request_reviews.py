...
class ProtectedBranchRequiredPullRequestReviews(BaseModel):
    """
    ProtectedBranchRequiredPullRequestReviews
    """ # noqa: E501
    url: StrictStr
    dismiss_stale_reviews: Optional[StrictBool] = None
    require_code_owner_reviews: Optional[StrictBool] = None
    ...
    dismissal_restrictions: Optional[ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions] = None
    bypass_pull_request_allowances: Optional[ProtectedBranchRequiredPullRequestReviewsBypassPullRequestAllowances] = None
    __properties: ClassVar[List[str]] = ["url", "dismiss_stale_reviews", "require_code_owner_reviews", "required_approving_review_count", "require_last_push_approval", "dismissal_restrictions", "bypass_pull_request_allowances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dismissal_restrictions": ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.from_dict(obj["dismissal_restrictions"]) if obj.get("dismissal_restrictions") is not None else None,
            "bypass_pull_request_allowances": ProtectedBranchRequiredPullRequestReviewsBypassPullRequestAllowances.from_dict(obj["bypass_pull_request_allowances"]) if obj.get("bypass_pull_request_allowances") is not None else None
        })
        return _obj
