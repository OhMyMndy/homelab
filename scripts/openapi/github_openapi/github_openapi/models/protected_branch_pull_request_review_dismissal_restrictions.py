...
class ProtectedBranchPullRequestReviewDismissalRestrictions(BaseModel):
    """
    ProtectedBranchPullRequestReviewDismissalRestrictions
    """ # noqa: E501
    users: Optional[List[SimpleUser]] = Field(default=None, description="The list of users with review dismissal access.")
    teams: Optional[List[Team]] = Field(default=None, description="The list of teams with review dismissal access.")
    apps: Optional[List[Optional[Integration]]] = Field(default=None, description="The list of apps with review dismissal access.")
    url: Optional[StrictStr] = None
    users_url: Optional[StrictStr] = None
    teams_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["users", "teams", "apps", "url", "users_url", "teams_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [SimpleUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "teams": [Team.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None,
            "apps": [Integration.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
            "url": obj.get("url"),
