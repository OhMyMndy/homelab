...
class ReposCreateOrUpdateCustomPropertiesValuesRequest(BaseModel):
    """
    ReposCreateOrUpdateCustomPropertiesValuesRequest
    """ # noqa: E501
    properties: List[CustomPropertyValue] = Field(description="A list of custom property names and associated values to apply to the repositories.")
