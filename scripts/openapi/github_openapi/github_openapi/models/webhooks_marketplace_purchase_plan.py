...
class WebhooksMarketplacePurchasePlan(BaseModel):
    ...
    """ # noqa: E501
    bullets: List[Optional[StrictStr]]
    ...
    __properties: ClassVar[List[str]] = ["bullets", "description", "has_free_trial", "id", "monthly_price_in_cents", "name", "price_model", "unit_name", "yearly_price_in_cents"]
