...
class WebhookPullRequestAssigned(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    assignee: Optional[WebhooksUser]
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['assigned']):
            raise ValueError("must be one of enum values ('assigned')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignee": WebhooksUser.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
            ...
            "pull_request": PullRequest.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
