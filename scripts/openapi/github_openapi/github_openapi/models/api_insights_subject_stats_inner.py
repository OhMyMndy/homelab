...
class ApiInsightsSubjectStatsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["subject_type", "subject_name", "subject_id", "total_request_count", "rate_limited_request_count", "last_rate_limited_timestamp", "last_request_timestamp"]
