...
class WebhookWorkflowJobQueued(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['queued']):
            raise ValueError("must be one of enum values ('queued')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow_job": WebhookWorkflowJobQueuedWorkflowJob.from_dict(obj["workflow_job"]) if obj.get("workflow_job") is not None else None,
