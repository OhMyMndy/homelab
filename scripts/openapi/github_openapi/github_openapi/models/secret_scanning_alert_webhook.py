...
class SecretScanningAlertWebhook(BaseModel):
    ...
    multi_repo: Optional[StrictBool] = Field(default=None, description="Whether the detected secret was found in multiple repositories in the same organization or business.")
    __properties: ClassVar[List[str]] = ["number", "created_at", "updated_at", "url", "html_url", "locations_url", "resolution", "resolved_at", "resolved_by", "resolution_comment", "secret_type", "secret_type_display_name", "validity", "push_protection_bypassed", "push_protection_bypassed_by", "push_protection_bypassed_at", "push_protection_bypass_request_reviewer", "push_protection_bypass_request_reviewer_comment", "push_protection_bypass_request_comment", "push_protection_bypass_request_html_url", "publicly_leaked", "multi_repo"]
