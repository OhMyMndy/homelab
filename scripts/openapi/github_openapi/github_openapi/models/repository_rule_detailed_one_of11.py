...
class RepositoryRuleDetailedOneOf11(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['commit_author_email_pattern']):
            raise ValueError("must be one of enum values ('commit_author_email_pattern')")
        return value
