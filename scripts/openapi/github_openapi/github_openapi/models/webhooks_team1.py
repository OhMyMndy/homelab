...
class WebhooksTeam1(BaseModel):
    ...
    parent: Optional[WebhooksTeamParent] = None
    ...
    notification_setting: Optional[StrictStr] = Field(default=None, description="Whether team members will receive notifications when their team is @mentioned")
    repositories_url: Optional[StrictStr] = None
    slug: Optional[StrictStr] = None
    url: Optional[StrictStr] = Field(default=None, description="URL for the team")
    __properties: ClassVar[List[str]] = ["deleted", "description", "html_url", "id", "members_url", "name", "node_id", "parent", "permission", "privacy", "notification_setting", "repositories_url", "slug", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": WebhooksTeamParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
