...
class RepositoryRuleDetailedOneOf8(BaseModel):
    """
    RepositoryRuleDetailedOneOf8
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleRequiredStatusChecksParameters] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['required_status_checks']):
            raise ValueError("must be one of enum values ('required_status_checks')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleRequiredStatusChecksParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
