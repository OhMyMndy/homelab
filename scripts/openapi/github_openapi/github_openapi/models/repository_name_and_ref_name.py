...
class RepositoryNameAndRefName(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ref_name", "repository_name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of repository_name
        if self.repository_name:
            _dict['repository_name'] = self.repository_name.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repository_name": RepositoryRulesetConditionsRepositoryNameTargetRepositoryName.from_dict(obj["repository_name"]) if obj.get("repository_name") is not None else None
        })
        return _obj
