...
class PendingDeploymentReviewersInner(BaseModel):
    """
    PendingDeploymentReviewersInner
    """ # noqa: E501
    type: Optional[DeploymentReviewerType] = None
    reviewer: Optional[PendingDeploymentReviewersInnerReviewer] = None
    __properties: ClassVar[List[str]] = ["type", "reviewer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "reviewer": PendingDeploymentReviewersInnerReviewer.from_dict(obj["reviewer"]) if obj.get("reviewer") is not None else None
        })
        return _obj
