...
class TeamsCreateRequest(BaseModel):
    ...
    notification_setting: Optional[StrictStr] = Field(default=None, description="The notification setting the team has chosen. The options are:    * `notifications_enabled` - team members receive notifications when the team is @mentioned.    * `notifications_disabled` - no one receives notifications.   Default: `notifications_enabled`")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "maintainers", "repo_names", "privacy", "notification_setting", "permission", "parent_team_id"]
