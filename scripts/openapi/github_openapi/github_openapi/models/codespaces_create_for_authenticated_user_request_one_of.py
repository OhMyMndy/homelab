...
class CodespacesCreateForAuthenticatedUserRequestOneOf(BaseModel):
    """
    CodespacesCreateForAuthenticatedUserRequestOneOf
    """ # noqa: E501
    repository_id: StrictInt = Field(description="Repository id for this codespace")
    ...
    __properties: ClassVar[List[str]] = ["repository_id", "ref", "location", "geo", "client_ip", "machine", "devcontainer_path", "multi_repo_permissions_opt_out", "working_directory", "idle_timeout_minutes", "display_name", "retention_period_minutes"]
