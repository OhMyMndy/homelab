...
class WebhookLabelEditedChanges(BaseModel):
    """
    The changes to the label if the action was `edited`.
    """ # noqa: E501
    color: Optional[WebhookLabelEditedChangesColor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "color": WebhookLabelEditedChangesColor.from_dict(obj["color"]) if obj.get("color") is not None else None,
