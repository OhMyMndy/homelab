...
class WebhookIssuesDemilestoned(BaseModel):
    ...
    issue: Issue1
    milestone: Optional[WebhooksMilestone] = None
    organization: Optional[OrganizationSimpleWebhooks] = None
    repository: RepositoryWebhooks
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "issue", "milestone", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issue": Issue1.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
            "milestone": WebhooksMilestone.from_dict(obj["milestone"]) if obj.get("milestone") is not None else None,
