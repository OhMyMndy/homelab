...
class RepositoryAdvisoryCreate(BaseModel):
    ...
    vulnerabilities: List[RepositoryAdvisoryCreateVulnerabilitiesInner] = Field(description="A product affected by the vulnerability detailed in a repository security advisory.")
    ...
    __properties: ClassVar[List[str]] = ["summary", "description", "cve_id", "vulnerabilities", "cwe_ids", "credits", "severity", "cvss_vector_string", "start_private_fork"]
