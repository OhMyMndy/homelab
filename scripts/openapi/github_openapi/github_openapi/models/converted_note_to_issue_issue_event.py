...
class ConvertedNoteToIssueIssueEvent(BaseModel):
    ...
    project_card: Optional[AddedToProjectIssueEventProjectCard] = None
    __properties: ClassVar[List[str]] = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app", "project_card"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project_card": AddedToProjectIssueEventProjectCard.from_dict(obj["project_card"]) if obj.get("project_card") is not None else None
        })
        return _obj
