...
class CopilotIdeChat(BaseModel):
    ...
    """ # noqa: E501
    total_engaged_users: Optional[StrictInt] = Field(default=None, description="Total number of users who prompted Copilot Chat in the IDE.")
    editors: Optional[List[CopilotIdeChatEditorsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["total_engaged_users", "editors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "editors": [CopilotIdeChatEditorsInner.from_dict(_item) for _item in obj["editors"]] if obj.get("editors") is not None else None
        })
