...
class SecretScanningLocationIssueComment(BaseModel):
    ...
    """ # noqa: E501
    issue_comment_url: StrictStr = Field(description="The API URL to get the issue comment where the secret was detected.")
    __properties: ClassVar[List[str]] = ["issue_comment_url"]
