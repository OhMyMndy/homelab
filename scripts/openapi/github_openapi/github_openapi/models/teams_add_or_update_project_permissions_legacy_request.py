...
class TeamsAddOrUpdateProjectPermissionsLegacyRequest(BaseModel):
    """
    TeamsAddOrUpdateProjectPermissionsLegacyRequest
    """ # noqa: E501
    permission: Optional[StrictStr] = Field(default=None, description="The permission to grant to the team for this project. Default: the team's `permission` attribute will be used to determine what permission to grant the team on this project. Note that, if you choose not to pass any parameters, you'll need to set `Content-Length` to zero when calling this endpoint. For more information, see \"[HTTP method](https://docs.github.com/rest/guides/getting-started-with-the-rest-api#http-method).\"")
