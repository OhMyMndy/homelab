...
class MigrationsMapCommitAuthorRequest(BaseModel):
    """
    MigrationsMapCommitAuthorRequest
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The new Git author email.")
    name: Optional[StrictStr] = Field(default=None, description="The new Git author name.")
