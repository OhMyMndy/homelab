...
class WebhookIssuesTransferred(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "issue", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['transferred']):
            raise ValueError("must be one of enum values ('transferred')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookIssuesTransferredChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "issue": WebhooksIssue2.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
