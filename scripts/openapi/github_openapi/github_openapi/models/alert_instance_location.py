...
class AlertInstanceLocation(BaseModel):
    """
    AlertInstanceLocation
    """ # noqa: E501
    end_column: Optional[StrictInt] = None
    end_line: Optional[StrictInt] = None
    path: Optional[StrictStr] = None
    start_column: Optional[StrictInt] = None
    start_line: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["end_column", "end_line", "path", "start_column", "start_line"]
