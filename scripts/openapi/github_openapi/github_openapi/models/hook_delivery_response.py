...
class HookDeliveryResponse(BaseModel):
    ...
    """ # noqa: E501
    headers: Optional[Dict[str, Any]] = Field(description="The response headers received when the delivery was made.")
    payload: Optional[Dict[str, Any]] = Field(description="The response payload received.")
