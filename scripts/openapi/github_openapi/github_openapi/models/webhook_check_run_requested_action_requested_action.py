...
class WebhookCheckRunRequestedActionRequestedAction(BaseModel):
    """
    The action requested by the user.
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="The integrator reference of the action requested by the user.")
