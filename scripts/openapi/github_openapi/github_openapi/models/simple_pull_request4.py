...
class SimplePullRequest4(BaseModel):
    """
    SimplePullRequest4
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "base": SimplePullRequest3Base.from_dict(obj["base"]) if obj.get("base") is not None else None,
            "body": obj.get("body"),
            ...
            "draft": obj.get("draft"),
            "head": SimplePullRequest3Base.from_dict(obj["head"]) if obj.get("head") is not None else None,
