...
class IssuesRemoveSubIssueRequest(BaseModel):
    """
    IssuesRemoveSubIssueRequest
    """ # noqa: E501
    sub_issue_id: StrictInt = Field(description="The sub-issue to remove")
    __properties: ClassVar[List[str]] = ["sub_issue_id"]
