...
class ReposUpdateBranchProtectionRequestRequiredStatusChecksChecksInner(BaseModel):
    """
    ReposUpdateBranchProtectionRequestRequiredStatusChecksChecksInner
    """ # noqa: E501
    context: StrictStr = Field(description="The name of the required check")
    app_id: Optional[StrictInt] = Field(default=None, description="The ID of the GitHub App that must provide this check. Omit this field to automatically select the GitHub App that has recently provided this check, or any app if it was not set by a GitHub App. Pass -1 to explicitly allow any app to set the status.")
    __properties: ClassVar[List[str]] = ["context", "app_id"]
