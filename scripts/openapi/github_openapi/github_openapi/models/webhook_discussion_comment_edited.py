...
class WebhookDiscussionCommentEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "comment", "discussion", "enterprise", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookDiscussionCommentEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            "comment": WebhooksComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
