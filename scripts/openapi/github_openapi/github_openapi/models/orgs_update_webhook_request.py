...
class OrgsUpdateWebhookRequest(BaseModel):
    """
    OrgsUpdateWebhookRequest
    """ # noqa: E501
    config: Optional[OrgsUpdateWebhookRequestConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["config", "events", "active", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": OrgsUpdateWebhookRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
