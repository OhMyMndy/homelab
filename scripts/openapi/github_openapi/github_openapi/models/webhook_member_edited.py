...
class WebhookMemberEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "member", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookMemberEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
