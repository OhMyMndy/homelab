...
class ActionsAddCustomLabelsToSelfHostedRunnerForOrgRequest(BaseModel):
    """
    ActionsAddCustomLabelsToSelfHostedRunnerForOrgRequest
    """ # noqa: E501
    labels: Annotated[List[StrictStr], Field(min_length=1, max_length=100)] = Field(description="The names of the custom labels to add to the runner.")
