...
class SecretScanningLocationDiscussionBody(BaseModel):
    ...
    """ # noqa: E501
    discussion_body_url: StrictStr = Field(description="The URL to the discussion where the secret was detected.")
    __properties: ClassVar[List[str]] = ["discussion_body_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discussion_body_url": obj.get("discussion_body_url")
        })
        return _obj
