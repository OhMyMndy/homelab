...
class WebhookCommitCommentCreated(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr = Field(description="The action performed. Can be `created`.")
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "comment", "enterprise", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": WebhookCommitCommentCreatedComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
