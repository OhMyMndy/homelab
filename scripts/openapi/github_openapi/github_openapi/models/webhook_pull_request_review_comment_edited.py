...
class WebhookPullRequestReviewCommentEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "comment", "enterprise", "installation", "organization", "pull_request", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhooksChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            "comment": WebhooksReviewComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
            ...
            "pull_request": WebhookPullRequestReviewCommentEditedPullRequest.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
