...
class CopilotCancelCopilotSeatAssignmentForTeams200Response(BaseModel):
    """
    The total number of seats set to \"pending cancellation\" for members of the specified team(s).
    """ # noqa: E501
    seats_cancelled: StrictInt
    __properties: ClassVar[List[str]] = ["seats_cancelled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "seats_cancelled": obj.get("seats_cancelled")
        })
        return _obj
