...
class MarketplacePurchase(BaseModel):
    ...
    free_trial_ends_on: Optional[StrictStr]
    next_billing_date: Optional[StrictStr] = None
    on_free_trial: Optional[StrictBool]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if on_free_trial (nullable) is None
        # and model_fields_set contains the field
        if self.on_free_trial is None and "on_free_trial" in self.model_fields_set:
            _dict['on_free_trial'] = None
