...
class WebhookCodeScanningAlertCreatedAlert(BaseModel):
    """
    The code scanning alert involved in the event.
    """ # noqa: E501
    created_at: Optional[datetime] = Field(description="The time that the alert was created in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ.`")
    ...
    instances_url: Optional[StrictStr] = None
    ...
    state: Optional[StrictStr] = Field(description="State of a code scanning alert.")
    tool: Optional[WebhookCodeScanningAlertCreatedAlertTool]
    updated_at: Optional[StrictStr] = None
    url: StrictStr
    __properties: ClassVar[List[str]] = ["created_at", "dismissed_at", "dismissed_by", "dismissed_comment", "dismissed_reason", "fixed_at", "html_url", "instances_url", "most_recent_instance", "number", "rule", "state", "tool", "updated_at", "url"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['open', 'dismissed']):
            raise ValueError("must be one of enum values ('open', 'dismissed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "tool": WebhookCodeScanningAlertCreatedAlertTool.from_dict(obj["tool"]) if obj.get("tool") is not None else None,
