...
class WebhookStatusBranchesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["commit", "name", "protected"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commit": WebhookStatusBranchesInnerCommit.from_dict(obj["commit"]) if obj.get("commit") is not None else None,
            "name": obj.get("name"),
