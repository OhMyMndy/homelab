...
class WebhookProjectColumnEditedChanges(BaseModel):
    """
    WebhookProjectColumnEditedChanges
    """ # noqa: E501
    name: Optional[WebhookDiscussionCommentEditedChangesBody] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": WebhookDiscussionCommentEditedChangesBody.from_dict(obj["name"]) if obj.get("name") is not None else None
        })
        return _obj
