...
class WebhookRepositoryTransferredChangesOwner(BaseModel):
    """
    WebhookRepositoryTransferredChangesOwner
    """ # noqa: E501
    var_from: WebhookRepositoryTransferredChangesOwnerFrom = Field(alias="from")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": WebhookRepositoryTransferredChangesOwnerFrom.from_dict(obj["from"]) if obj.get("from") is not None else None
        })
        return _obj
