...
class SigstoreBundle0VerificationMaterialTlogEntriesInnerInclusionPromise(BaseModel):
    """
    SigstoreBundle0VerificationMaterialTlogEntriesInnerInclusionPromise
    """ # noqa: E501
    signed_entry_timestamp: Optional[StrictStr] = Field(default=None, alias="signedEntryTimestamp")
    __properties: ClassVar[List[str]] = ["signedEntryTimestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signedEntryTimestamp": obj.get("signedEntryTimestamp")
        })
        return _obj
