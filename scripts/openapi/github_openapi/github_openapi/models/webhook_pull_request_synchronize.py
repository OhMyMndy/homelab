...
class WebhookPullRequestSynchronize(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "after", "before", "enterprise", "installation", "number", "organization", "pull_request", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['synchronize']):
            raise ValueError("must be one of enum values ('synchronize')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_request": PullRequest10.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
