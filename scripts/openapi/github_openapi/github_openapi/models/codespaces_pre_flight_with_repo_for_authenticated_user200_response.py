...
class CodespacesPreFlightWithRepoForAuthenticatedUser200Response(BaseModel):
    """
    CodespacesPreFlightWithRepoForAuthenticatedUser200Response
    """ # noqa: E501
    billable_owner: Optional[SimpleUser] = None
    defaults: Optional[CodespacesPreFlightWithRepoForAuthenticatedUser200ResponseDefaults] = None
    __properties: ClassVar[List[str]] = ["billable_owner", "defaults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaults": CodespacesPreFlightWithRepoForAuthenticatedUser200ResponseDefaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None
        })
        return _obj
