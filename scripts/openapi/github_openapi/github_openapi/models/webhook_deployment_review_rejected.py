...
class WebhookDeploymentReviewRejected(BaseModel):
    ...
    workflow_job_runs: Optional[List[WebhookDeploymentReviewRejectedWorkflowJobRunsInner]] = None
    workflow_run: Optional[DeploymentWorkflowRun2]
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['rejected']):
            raise ValueError("must be one of enum values ('rejected')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow_job_runs": [WebhookDeploymentReviewRejectedWorkflowJobRunsInner.from_dict(_item) for _item in obj["workflow_job_runs"]] if obj.get("workflow_job_runs") is not None else None,
            "workflow_run": DeploymentWorkflowRun2.from_dict(obj["workflow_run"]) if obj.get("workflow_run") is not None else None
        })
        return _obj
