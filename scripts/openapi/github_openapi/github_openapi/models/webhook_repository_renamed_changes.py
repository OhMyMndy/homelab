...
class WebhookRepositoryRenamedChanges(BaseModel):
    """
    WebhookRepositoryRenamedChanges
    """ # noqa: E501
    repository: WebhookRepositoryRenamedChangesRepository
    __properties: ClassVar[List[str]] = ["repository"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repository": WebhookRepositoryRenamedChangesRepository.from_dict(obj["repository"]) if obj.get("repository") is not None else None
        })
        return _obj
