...
class UserMarketplacePurchase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_cycle", "next_billing_date", "unit_count", "on_free_trial", "free_trial_ends_on", "updated_at", "account", "plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "account": MarketplaceAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
