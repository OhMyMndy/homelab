...
class WebhookFork(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["enterprise", "forkee", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forkee": WebhookForkForkee.from_dict(obj["forkee"]) if obj.get("forkee") is not None else None,
