...
class WebhookRegistryPackageUpdated(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "registry_package", "repository", "sender"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of registry_package
        if self.registry_package:
            _dict['registry_package'] = self.registry_package.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "registry_package": WebhookRegistryPackageUpdatedRegistryPackage.from_dict(obj["registry_package"]) if obj.get("registry_package") is not None else None,
