...
class WebhookPullRequestEdited(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "number", "organization", "pull_request", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookPullRequestEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "pull_request": PullRequestWebhook.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
