...
class Issue1(BaseModel):
    ...
    node_id: StrictStr
    number: StrictInt
    performed_via_github_app: Optional[App11] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignee": User5.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
            ...
            "performed_via_github_app": App11.from_dict(obj["performed_via_github_app"]) if obj.get("performed_via_github_app") is not None else None,
