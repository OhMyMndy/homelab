...
class WebhookProjectEdited(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookProjectEditedChanges] = None
    ...
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "project", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "project": WebhooksProject.from_dict(obj["project"]) if obj.get("project") is not None else None,
