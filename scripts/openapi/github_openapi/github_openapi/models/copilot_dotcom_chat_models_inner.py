...
class CopilotDotcomChatModelsInner(BaseModel):
    """
    ...
    custom_model_training_date: Optional[StrictStr] = Field(default=None, description="The training date for the custom model (if applicable).")
    total_engaged_users: Optional[StrictInt] = Field(default=None, description="Total number of users who prompted Copilot Chat on github.com at least once for each model.")
    total_chats: Optional[StrictInt] = Field(default=None, description="Total number of chats initiated by users on github.com.")
    __properties: ClassVar[List[str]] = ["name", "is_custom_model", "custom_model_training_date", "total_engaged_users", "total_chats"]
