...
class TeamsAddOrUpdateRepoPermissionsLegacyRequest(BaseModel):
    """
    TeamsAddOrUpdateRepoPermissionsLegacyRequest
    """ # noqa: E501
    permission: Optional[StrictStr] = Field(default=None, description="The permission to grant the team on this repository. If no permission is specified, the team's `permission` attribute will be used to determine what permission to grant the team on this repository.")
