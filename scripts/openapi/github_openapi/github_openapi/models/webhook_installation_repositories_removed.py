...
class WebhookInstallationRepositoriesRemoved(BaseModel):
    ...
    repositories_removed: List[WebhooksRepositoriesInner] = Field(description="An array of repository objects, which were removed from the installation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repositories_removed": [WebhooksRepositoriesInner.from_dict(_item) for _item in obj["repositories_removed"]] if obj.get("repositories_removed") is not None else None,
