...
class WebhookIssuesUnpinned(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "issue", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unpinned']):
            raise ValueError("must be one of enum values ('unpinned')")
        return value
