...
class SigstoreBundle0VerificationMaterialX509CertificateChain(BaseModel):
    """
    SigstoreBundle0VerificationMaterialX509CertificateChain
    """ # noqa: E501
    certificates: Optional[List[SigstoreBundle0VerificationMaterialX509CertificateChainCertificatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificates": [SigstoreBundle0VerificationMaterialX509CertificateChainCertificatesInner.from_dict(_item) for _item in obj["certificates"]] if obj.get("certificates") is not None else None
        })
        return _obj
