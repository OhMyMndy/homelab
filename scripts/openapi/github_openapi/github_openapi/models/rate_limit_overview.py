...
class RateLimitOverview(BaseModel):
    ...
    rate: RateLimit
    __properties: ClassVar[List[str]] = ["resources", "rate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": RateLimitOverviewResources.from_dict(obj["resources"]) if obj.get("resources") is not None else None,
            "rate": RateLimit.from_dict(obj["rate"]) if obj.get("rate") is not None else None
        })
        return _obj
