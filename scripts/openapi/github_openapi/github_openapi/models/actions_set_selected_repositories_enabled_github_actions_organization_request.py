...
class ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest(BaseModel):
    """
    ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest
    """ # noqa: E501
    selected_repository_ids: List[StrictInt] = Field(description="List of repository IDs to enable for GitHub Actions.")
    __properties: ClassVar[List[str]] = ["selected_repository_ids"]
