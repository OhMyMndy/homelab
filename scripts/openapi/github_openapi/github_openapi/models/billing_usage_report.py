...
class BillingUsageReport(BaseModel):
    ...
    BillingUsageReport
    """ # noqa: E501
    usage_items: Optional[List[BillingUsageReportUsageItemsInner]] = Field(default=None, alias="usageItems")
    __properties: ClassVar[List[str]] = ["usageItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "usageItems": [BillingUsageReportUsageItemsInner.from_dict(_item) for _item in obj["usageItems"]] if obj.get("usageItems") is not None else None
        })
        return _obj
