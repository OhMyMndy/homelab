...
class RenamedIssueEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app", "rename"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rename": RenamedIssueEventRename.from_dict(obj["rename"]) if obj.get("rename") is not None else None
        })
        return _obj
