...
class User7(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatar_url", "deleted", "email", "events_url", "followers_url", "following_url", "gists_url", "gravatar_id", "html_url", "id", "login", "name", "node_id", "organizations_url", "received_events_url", "repos_url", "site_admin", "starred_url", "subscriptions_url", "type", "user_view_type", "url"]
