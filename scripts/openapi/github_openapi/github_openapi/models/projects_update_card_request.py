...
class ProjectsUpdateCardRequest(BaseModel):
    """
    ProjectsUpdateCardRequest
    """ # noqa: E501
    note: Optional[StrictStr] = Field(default=None, description="The project card's note")
    archived: Optional[StrictBool] = Field(default=None, description="Whether or not the card is archived")
    __properties: ClassVar[List[str]] = ["note", "archived"]
