...
class WebhookRegistryPackagePublished(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "registry_package": WebhookRegistryPackagePublishedRegistryPackage.from_dict(obj["registry_package"]) if obj.get("registry_package") is not None else None,
