...
class OrgsUpdateMembershipForAuthenticatedUserRequest(BaseModel):
    """
    OrgsUpdateMembershipForAuthenticatedUserRequest
    """ # noqa: E501
    state: StrictStr = Field(description="The state that the membership should be in. Only `\"active\"` will be accepted.")
