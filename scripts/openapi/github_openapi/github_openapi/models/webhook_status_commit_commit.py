...
class WebhookStatusCommitCommit(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": WebhookStatusCommitCommitAuthor.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "comment_count": obj.get("comment_count"),
            "committer": WebhookStatusCommitCommitAuthor.from_dict(obj["committer"]) if obj.get("committer") is not None else None,
            "message": obj.get("message"),
            "tree": ShortBranchCommit.from_dict(obj["tree"]) if obj.get("tree") is not None else None,
            "url": obj.get("url"),
            "verification": WebhookStatusCommitCommitVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None
        })
        return _obj
