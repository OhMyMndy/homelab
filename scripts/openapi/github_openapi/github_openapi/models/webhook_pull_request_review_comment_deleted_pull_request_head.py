...
class WebhookPullRequestReviewCommentDeletedPullRequestHead(BaseModel):
    """
    WebhookPullRequestReviewCommentDeletedPullRequestHead
    """ # noqa: E501
    label: StrictStr
    ref: StrictStr
    repo: Optional[Repository4]
    sha: StrictStr
    user: Optional[User1]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "ref": obj.get("ref"),
            "repo": Repository4.from_dict(obj["repo"]) if obj.get("repo") is not None else None,
            "sha": obj.get("sha"),
