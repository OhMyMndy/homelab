...
class RepositoryRuleDetailedOneOf4(BaseModel):
    """
    RepositoryRuleDetailedOneOf4
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleMergeQueueParameters] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['merge_queue']):
            raise ValueError("must be one of enum values ('merge_queue')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleMergeQueueParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
