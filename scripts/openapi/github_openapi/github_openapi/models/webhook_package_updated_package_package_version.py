...
class WebhookPackageUpdatedPackagePackageVersion(BaseModel):
    """
    ...
    name: StrictStr
    package_files: List[WebhookPackageUpdatedPackagePackageVersionPackageFilesInner]
    package_url: Optional[StrictStr] = None
    prerelease: Optional[StrictBool] = None
    release: Optional[WebhookPackageUpdatedPackagePackageVersionRelease] = None
    ...
    version: StrictStr
    __properties: ClassVar[List[str]] = ["author", "body", "body_html", "created_at", "description", "docker_metadata", "draft", "html_url", "id", "installation_command", "manifest", "metadata", "name", "package_files", "package_url", "prerelease", "release", "rubygems_metadata", "source_url", "summary", "tag_name", "target_commitish", "target_oid", "updated_at", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "package_files": [WebhookPackageUpdatedPackagePackageVersionPackageFilesInner.from_dict(_item) for _item in obj["package_files"]] if obj.get("package_files") is not None else None,
            "package_url": obj.get("package_url"),
            "prerelease": obj.get("prerelease"),
            "release": WebhookPackageUpdatedPackagePackageVersionRelease.from_dict(obj["release"]) if obj.get("release") is not None else None,
