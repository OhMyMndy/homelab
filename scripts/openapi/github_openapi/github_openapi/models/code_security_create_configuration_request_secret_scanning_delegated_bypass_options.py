...
class CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions(BaseModel):
    """
    Feature options for secret scanning delegated bypass
    """ # noqa: E501
    reviewers: Optional[List[CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptionsReviewersInner]] = Field(default=None, description="The bypass reviewers for secret scanning delegated bypass")
    __properties: ClassVar[List[str]] = ["reviewers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reviewers": [CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptionsReviewersInner.from_dict(_item) for _item in obj["reviewers"]] if obj.get("reviewers") is not None else None
        })
        return _obj
