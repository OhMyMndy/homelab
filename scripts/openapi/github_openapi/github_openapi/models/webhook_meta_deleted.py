...
class WebhookMetaDeleted(BaseModel):
    ...
    hook_id: StrictInt = Field(description="The id of the modified webhook.")
    ...
    __properties: ClassVar[List[str]] = ["action", "enterprise", "hook", "hook_id", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hook": WebhookMetaDeletedHook.from_dict(obj["hook"]) if obj.get("hook") is not None else None,
