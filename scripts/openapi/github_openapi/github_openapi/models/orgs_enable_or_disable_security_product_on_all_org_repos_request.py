...
class OrgsEnableOrDisableSecurityProductOnAllOrgReposRequest(BaseModel):
    """
    OrgsEnableOrDisableSecurityProductOnAllOrgReposRequest
    """ # noqa: E501
    query_suite: Optional[StrictStr] = Field(default=None, description="CodeQL query suite to be used. If you specify the `query_suite` parameter, the default setup will be configured with this query suite only on all repositories that didn't have default setup already configured. It will not change the query suite on repositories that already have default setup configured. If you don't specify any `query_suite` in your request, the preferred query suite of the organization will be applied.")
    __properties: ClassVar[List[str]] = ["query_suite"]
