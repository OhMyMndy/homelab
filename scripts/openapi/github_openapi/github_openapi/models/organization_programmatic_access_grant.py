...
class OrganizationProgrammaticAccessGrant(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier of the fine-grained personal access token grant. The `pat_id` used to get details about an approved fine-grained personal access token.")
    owner: SimpleUser
    repository_selection: StrictStr = Field(description="Type of repository selection requested.")
    repositories_url: StrictStr = Field(description="URL to the list of repositories the fine-grained personal access token can access. Only follow when `repository_selection` is `subset`.")
    permissions: OrganizationProgrammaticAccessGrantRequestPermissions
    access_granted_at: StrictStr = Field(description="Date and time when the fine-grained personal access token was approved to access the organization.")
    ...
    __properties: ClassVar[List[str]] = ["id", "owner", "repository_selection", "repositories_url", "permissions", "access_granted_at", "token_id", "token_name", "token_expired", "token_expires_at", "token_last_used_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "access_granted_at": obj.get("access_granted_at"),
