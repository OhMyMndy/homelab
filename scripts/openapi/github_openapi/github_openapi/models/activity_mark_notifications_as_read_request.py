...
class ActivityMarkNotificationsAsReadRequest(BaseModel):
    """
    ...
    read: Optional[StrictBool] = Field(default=None, description="Whether the notification has been read.")
    __properties: ClassVar[List[str]] = ["last_read_at", "read"]
