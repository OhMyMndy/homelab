...
class ImportProjectChoicesInner(BaseModel):
    """
    ImportProjectChoicesInner
    """ # noqa: E501
    vcs: Optional[StrictStr] = None
    tfvc_project: Optional[StrictStr] = None
    human_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["vcs", "tfvc_project", "human_name"]
