...
class WebhookTeamEdited(BaseModel):
    ...
    sender: SimpleUser
    team: WebhooksTeam1
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "repository", "sender", "team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookTeamEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "repository": Repository15.from_dict(obj["repository"]) if obj.get("repository") is not None else None,
