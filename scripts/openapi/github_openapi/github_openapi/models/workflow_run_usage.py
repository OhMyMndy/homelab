...
class WorkflowRunUsage(BaseModel):
    ...
    run_duration_ms: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["billable", "run_duration_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billable": WorkflowRunUsageBillable.from_dict(obj["billable"]) if obj.get("billable") is not None else None,
            "run_duration_ms": obj.get("run_duration_ms")
        })
        return _obj
