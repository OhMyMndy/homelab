...
class ChecksUpdateRequestOutput(BaseModel):
    """
    Check runs can accept a variety of data in the `output` object, including a `title` and `summary` and can optionally provide descriptive details about the run.
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="**Required**.")
    summary: Annotated[str, Field(strict=True, max_length=65535)] = Field(description="Can contain Markdown.")
    text: Optional[Annotated[str, Field(strict=True, max_length=65535)]] = Field(default=None, description="Can contain Markdown.")
