...
class RepositoryRuleDetailedOneOf3(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "ruleset_source_type", "ruleset_source", "ruleset_id"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['required_linear_history']):
            raise ValueError("must be one of enum values ('required_linear_history')")
        return value
