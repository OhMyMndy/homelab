...
class CodeSecurityCreateConfigurationForEnterpriseRequest(BaseModel):
    """
    CodeSecurityCreateConfigurationForEnterpriseRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the code security configuration. Must be unique within the enterprise.")
