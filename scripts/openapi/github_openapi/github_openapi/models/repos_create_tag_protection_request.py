...
class ReposCreateTagProtectionRequest(BaseModel):
    """
    ReposCreateTagProtectionRequest
    """ # noqa: E501
    pattern: StrictStr = Field(description="An optional glob pattern to match against when enforcing tag protection.")
