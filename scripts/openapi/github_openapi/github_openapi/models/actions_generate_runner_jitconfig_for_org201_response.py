...
class ActionsGenerateRunnerJitconfigForOrg201Response(BaseModel):
    """
    ActionsGenerateRunnerJitconfigForOrg201Response
    """ # noqa: E501
    runner: Runner
    encoded_jit_config: StrictStr = Field(description="The base64 encoded runner configuration.")
    __properties: ClassVar[List[str]] = ["runner", "encoded_jit_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "runner": Runner.from_dict(obj["runner"]) if obj.get("runner") is not None else None,
            "encoded_jit_config": obj.get("encoded_jit_config")
        })
        return _obj
