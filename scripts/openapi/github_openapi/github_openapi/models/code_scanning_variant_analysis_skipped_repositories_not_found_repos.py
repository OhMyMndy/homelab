...
class CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos(BaseModel):
    """
    ...
    repository_full_names: List[StrictStr] = Field(description="A list of full repository names that were skipped. This list may not include all repositories that were skipped.")
    __properties: ClassVar[List[str]] = ["repository_count", "repository_full_names"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repository_full_names": obj.get("repository_full_names")
        })
        return _obj
