...
class WebhookSponsorshipEdited(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "repository", "sender", "sponsorship"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookSponsorshipEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
