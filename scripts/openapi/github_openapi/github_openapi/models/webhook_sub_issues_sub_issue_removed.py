...
class WebhookSubIssuesSubIssueRemoved(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "sub_issue_id", "sub_issue", "sub_issue_repo", "parent_issue_id", "parent_issue", "installation", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sub_issue_removed']):
            raise ValueError("must be one of enum values ('sub_issue_removed')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sub_issue_repo
        if self.sub_issue_repo:
            _dict['sub_issue_repo'] = self.sub_issue_repo.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sub_issue_repo": Repository.from_dict(obj["sub_issue_repo"]) if obj.get("sub_issue_repo") is not None else None,
