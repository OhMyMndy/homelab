...
class OrgsCreateOrUpdateCustomPropertiesRequest(BaseModel):
    """
    OrgsCreateOrUpdateCustomPropertiesRequest
    """ # noqa: E501
    properties: Annotated[List[CustomProperty], Field(min_length=1, max_length=100)] = Field(description="The array of custom properties to create or update.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": [CustomProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
