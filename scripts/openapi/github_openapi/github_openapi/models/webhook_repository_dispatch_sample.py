...
class WebhookRepositoryDispatchSample(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr = Field(description="The `event_type` that was specified in the `POST /repos/{owner}/{repo}/dispatches` request body.")
    branch: StrictStr
    client_payload: Optional[Dict[str, Any]] = Field(description="The `client_payload` that was specified in the `POST /repos/{owner}/{repo}/dispatches` request body.")
    enterprise: Optional[EnterpriseWebhooks] = None
    installation: SimpleInstallation
    organization: Optional[OrganizationSimpleWebhooks] = None
    repository: RepositoryWebhooks
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "branch", "client_payload", "enterprise", "installation", "organization", "repository", "sender"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if client_payload (nullable) is None
        # and model_fields_set contains the field
        if self.client_payload is None and "client_payload" in self.model_fields_set:
            _dict['client_payload'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client_payload": obj.get("client_payload"),
