...
class App2(BaseModel):
    ...
    client_id: Optional[StrictStr] = Field(default=None, description="The client ID of the GitHub app")
    name: StrictStr = Field(description="The name of the GitHub app")
    node_id: StrictStr
    owner: Optional[User2]
    permissions: Optional[App2Permissions] = None
    slug: Optional[StrictStr] = Field(default=None, description="The slug name of the GitHub app")
    updated_at: Optional[datetime]
    __properties: ClassVar[List[str]] = ["created_at", "description", "events", "external_url", "html_url", "id", "client_id", "name", "node_id", "owner", "permissions", "slug", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": App2Permissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None,
            "slug": obj.get("slug"),
