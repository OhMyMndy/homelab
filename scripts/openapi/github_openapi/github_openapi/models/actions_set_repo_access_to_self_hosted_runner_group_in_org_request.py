...
class ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequest(BaseModel):
    """
    ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequest
    """ # noqa: E501
    selected_repository_ids: List[StrictInt] = Field(description="List of repository IDs that can access the runner group.")
