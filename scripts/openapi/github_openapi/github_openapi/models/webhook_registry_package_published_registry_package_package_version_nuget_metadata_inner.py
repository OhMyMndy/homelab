...
class WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInner(BaseModel):
    """
    WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInner
    """ # noqa: E501
    id: Optional[WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInnerId] = None
    name: Optional[StrictStr] = None
    value: Optional[WebhookPackagePublishedPackagePackageVersionNugetMetadataInnerValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInnerId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "name": obj.get("name"),
            "value": WebhookPackagePublishedPackagePackageVersionNugetMetadataInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
