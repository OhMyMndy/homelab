...
class WebhookCodeScanningAlertAppearedInBranch(BaseModel):
    ...
    commit_oid: StrictStr = Field(description="The commit SHA of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, the event was triggered by the `sender` and this value will be empty.")
    ...
    ref: StrictStr = Field(description="The Git reference of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, the event was triggered by the `sender` and this value will be empty.")
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['appeared_in_branch']):
            raise ValueError("must be one of enum values ('appeared_in_branch')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alert": WebhookCodeScanningAlertAppearedInBranchAlert.from_dict(obj["alert"]) if obj.get("alert") is not None else None,
