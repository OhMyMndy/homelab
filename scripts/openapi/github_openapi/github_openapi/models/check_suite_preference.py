...
class CheckSuitePreference(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preferences", "repository"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preferences": CheckSuitePreferencePreferences.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None,
