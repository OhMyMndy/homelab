...
class WebhookPackagePublishedPackagePackageVersionNugetMetadataInner(BaseModel):
    """
    WebhookPackagePublishedPackagePackageVersionNugetMetadataInner
    """ # noqa: E501
    id: Optional[ActionsGetWorkflowWorkflowIdParameter] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": ActionsGetWorkflowWorkflowIdParameter.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "name": obj.get("name"),
