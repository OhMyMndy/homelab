...
class WebhookRegistryPackageUpdatedRegistryPackage(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "package_version": WebhookRegistryPackageUpdatedRegistryPackagePackageVersion.from_dict(obj["package_version"]) if obj.get("package_version") is not None else None,
