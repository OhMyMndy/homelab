...
class SecretScanningLocationPullRequestReviewComment(BaseModel):
    ...
    """ # noqa: E501
    pull_request_review_comment_url: StrictStr = Field(description="The API URL to get the pull request review comment where the secret was detected.")
    __properties: ClassVar[List[str]] = ["pull_request_review_comment_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pull_request_review_comment_url": obj.get("pull_request_review_comment_url")
        })
        return _obj
