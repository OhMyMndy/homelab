...
class WebhookRepositoryRulesetEditedChangesRulesUpdatedInner(BaseModel):
    """
    WebhookRepositoryRulesetEditedChangesRulesUpdatedInner
    """ # noqa: E501
    rule: Optional[RepositoryRule] = None
    changes: Optional[WebhookRepositoryRulesetEditedChangesRulesUpdatedInnerChanges] = None
    __properties: ClassVar[List[str]] = ["rule", "changes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rule": RepositoryRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
            "changes": WebhookRepositoryRulesetEditedChangesRulesUpdatedInnerChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None
        })
        return _obj
