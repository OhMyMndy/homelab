...
class TimelineReviewedEventLinks(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "html": TimelineReviewedEventLinksHtml.from_dict(obj["html"]) if obj.get("html") is not None else None,
            "pull_request": TimelineReviewedEventLinksHtml.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None
        })
        return _obj
