...
class CodeSecuritySetConfigurationAsDefaultForEnterpriseRequest(BaseModel):
    """
    CodeSecuritySetConfigurationAsDefaultForEnterpriseRequest
    """ # noqa: E501
    default_for_new_repos: Optional[StrictStr] = Field(default=None, description="Specify which types of repository this security configuration should be applied to by default.")
    __properties: ClassVar[List[str]] = ["default_for_new_repos"]
