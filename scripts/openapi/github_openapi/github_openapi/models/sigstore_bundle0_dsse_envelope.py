...
class SigstoreBundle0DsseEnvelope(BaseModel):
    """
    ...
    signatures: Optional[List[SigstoreBundle0DsseEnvelopeSignaturesInner]] = None
    __properties: ClassVar[List[str]] = ["payload", "payloadType", "signatures"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signatures": [SigstoreBundle0DsseEnvelopeSignaturesInner.from_dict(_item) for _item in obj["signatures"]] if obj.get("signatures") is not None else None
        })
        return _obj
