...
class WebhookPullRequestDemilestoned(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "enterprise", "milestone", "number", "organization", "pull_request", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['demilestoned']):
            raise ValueError("must be one of enum values ('demilestoned')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_request": WebhooksPullRequest5.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
