...
class IssuePullRequest(BaseModel):
    ...
    diff_url: Optional[StrictStr]
    html_url: Optional[StrictStr]
    patch_url: Optional[StrictStr]
    url: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["merged_at", "diff_url", "html_url", "patch_url", "url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if diff_url (nullable) is None
        # and model_fields_set contains the field
        if self.diff_url is None and "diff_url" in self.model_fields_set:
            _dict['diff_url'] = None
        ...
        # set to None if patch_url (nullable) is None
        # and model_fields_set contains the field
        if self.patch_url is None and "patch_url" in self.model_fields_set:
            _dict['patch_url'] = None
