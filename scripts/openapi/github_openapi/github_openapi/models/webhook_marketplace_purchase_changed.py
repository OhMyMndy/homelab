...
class WebhookMarketplacePurchaseChanged(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['changed']):
            raise ValueError("must be one of enum values ('changed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "previous_marketplace_purchase": MarketplacePurchase.from_dict(obj["previous_marketplace_purchase"]) if obj.get("previous_marketplace_purchase") is not None else None,
