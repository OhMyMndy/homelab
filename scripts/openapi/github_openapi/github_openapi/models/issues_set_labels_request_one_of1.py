...
class IssuesSetLabelsRequestOneOf1(BaseModel):
    """
    IssuesSetLabelsRequestOneOf1
    """ # noqa: E501
    labels: Optional[Annotated[List[IssuesSetLabelsRequestOneOf1LabelsInner], Field(min_length=1)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": [IssuesSetLabelsRequestOneOf1LabelsInner.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None
        })
        return _obj
