...
class ActionsSetSelfHostedRunnersInGroupForOrgRequest(BaseModel):
    """
    ActionsSetSelfHostedRunnersInGroupForOrgRequest
    """ # noqa: E501
    runners: List[StrictInt] = Field(description="List of runner IDs to add to the runner group.")
    __properties: ClassVar[List[str]] = ["runners"]
