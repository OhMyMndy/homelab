...
class WebhookIssueCommentEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "comment", "enterprise", "installation", "issue", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": WebhooksIssueComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
            ...
            "issue": WebhookIssueCommentEditedIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
