...
class WebhookProjectColumnDeleted(BaseModel):
    ...
    repository: Optional[NullableRepositoryWebhooks] = None
    sender: Optional[SimpleUser] = None
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "project_column", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repository": NullableRepositoryWebhooks.from_dict(obj["repository"]) if obj.get("repository") is not None else None,
