...
class CopilotDotcomPullRequests(BaseModel):
    ...
    """ # noqa: E501
    total_engaged_users: Optional[StrictInt] = Field(default=None, description="The number of users who used Copilot for Pull Requests on github.com to generate a pull request summary at least once.")
    repositories: Optional[List[CopilotDotcomPullRequestsRepositoriesInner]] = Field(default=None, description="Repositories in which users used Copilot for Pull Requests to generate pull request summaries")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["total_engaged_users", "repositories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repositories": [CopilotDotcomPullRequestsRepositoriesInner.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None
        })
