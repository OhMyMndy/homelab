...
class WebhookIssuesOpened(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookIssuesOpenedChanges] = None
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['opened']):
            raise ValueError("must be one of enum values ('opened')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookIssuesOpenedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "issue": Issue7.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
