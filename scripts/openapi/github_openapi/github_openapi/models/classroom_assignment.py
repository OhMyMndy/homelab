...
class ClassroomAssignment(BaseModel):
    ...
    students_are_repo_admins: StrictBool = Field(description="Whether students are admins on created repository when a student accepts the assignment.")
    feedback_pull_requests_enabled: StrictBool = Field(description="Whether feedback pull request will be created when a student accepts the assignment.")
    max_teams: Optional[StrictInt] = Field(description="The maximum allowable teams for the assignment.")
    max_members: Optional[StrictInt] = Field(description="The maximum allowable members per team.")
    ...
    classroom: Classroom
    __properties: ClassVar[List[str]] = ["id", "public_repo", "title", "type", "invite_link", "invitations_enabled", "slug", "students_are_repo_admins", "feedback_pull_requests_enabled", "max_teams", "max_members", "editor", "accepted", "submitted", "passing", "language", "deadline", "starter_code_repository", "classroom"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of starter_code_repository
        if self.starter_code_repository:
            _dict['starter_code_repository'] = self.starter_code_repository.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "starter_code_repository": SimpleClassroomRepository.from_dict(obj["starter_code_repository"]) if obj.get("starter_code_repository") is not None else None,
            "classroom": Classroom.from_dict(obj["classroom"]) if obj.get("classroom") is not None else None
        })
        return _obj
