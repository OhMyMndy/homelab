...
class GistHistory(BaseModel):
    ...
    change_status: Optional[GistHistoryChangeStatus] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["user", "version", "committed_at", "change_status", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "change_status": GistHistoryChangeStatus.from_dict(obj["change_status"]) if obj.get("change_status") is not None else None,
            "url": obj.get("url")
        })
        return _obj
