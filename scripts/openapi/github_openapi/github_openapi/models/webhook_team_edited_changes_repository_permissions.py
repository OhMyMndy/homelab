...
class WebhookTeamEditedChangesRepositoryPermissions(BaseModel):
    """
    WebhookTeamEditedChangesRepositoryPermissions
    """ # noqa: E501
    var_from: WebhookTeamEditedChangesRepositoryPermissionsFrom = Field(alias="from")
    __properties: ClassVar[List[str]] = ["from"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": WebhookTeamEditedChangesRepositoryPermissionsFrom.from_dict(obj["from"]) if obj.get("from") is not None else None
        })
        return _obj
