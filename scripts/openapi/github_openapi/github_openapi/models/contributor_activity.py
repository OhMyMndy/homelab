...
class ContributorActivity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author", "total", "weeks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "weeks": [ContributorActivityWeeksInner.from_dict(_item) for _item in obj["weeks"]] if obj.get("weeks") is not None else None
        })
        return _obj
