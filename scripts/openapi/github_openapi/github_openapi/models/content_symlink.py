...
class ContentSymlink(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "target", "size", "name", "path", "sha", "url", "git_url", "html_url", "download_url", "_links"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['symlink']):
            raise ValueError("must be one of enum values ('symlink')")
        return value
