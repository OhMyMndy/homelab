...
class WorkflowStep3(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['completed', 'in_progress', 'queued', 'pending']):
            raise ValueError("must be one of enum values ('completed', 'in_progress', 'queued', 'pending')")
        return value
