...
class WebhookPullRequestReviewThreadResolvedThread(BaseModel):
    """
    WebhookPullRequestReviewThreadResolvedThread
    """ # noqa: E501
    comments: List[PullRequestReviewComment1]
    node_id: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comments": [PullRequestReviewComment1.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
