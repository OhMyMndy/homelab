...
class ActionsSetCustomLabelsForSelfHostedRunnerForOrgRequest(BaseModel):
    """
    ActionsSetCustomLabelsForSelfHostedRunnerForOrgRequest
    """ # noqa: E501
    labels: Annotated[List[StrictStr], Field(min_length=0, max_length=100)] = Field(description="The names of the custom labels to set for the runner. You can pass an empty array to remove all custom labels.")
