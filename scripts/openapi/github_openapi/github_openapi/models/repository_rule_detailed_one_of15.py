...
class RepositoryRuleDetailedOneOf15(BaseModel):
    """
    RepositoryRuleDetailedOneOf15
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleWorkflowsParameters] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['workflows']):
            raise ValueError("must be one of enum values ('workflows')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleWorkflowsParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
