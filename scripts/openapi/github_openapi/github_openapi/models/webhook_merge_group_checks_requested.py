...
class WebhookMergeGroupChecksRequested(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "installation", "merge_group", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['checks_requested']):
            raise ValueError("must be one of enum values ('checks_requested')")
        return value
