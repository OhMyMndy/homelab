...
class WebhookReleaseEdited(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "release", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookReleaseEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "release": WebhooksRelease.from_dict(obj["release"]) if obj.get("release") is not None else None,
