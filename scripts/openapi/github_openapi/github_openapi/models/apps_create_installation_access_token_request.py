...
class AppsCreateInstallationAccessTokenRequest(BaseModel):
    """
    AppsCreateInstallationAccessTokenRequest
    """ # noqa: E501
    repositories: Optional[List[StrictStr]] = Field(default=None, description="List of repository names that the token should have access to")
    repository_ids: Optional[List[StrictInt]] = Field(default=None, description="List of repository IDs that the token should have access to")
    permissions: Optional[AppPermissions] = None
    __properties: ClassVar[List[str]] = ["repositories", "repository_ids", "permissions"]
