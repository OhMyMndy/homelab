...
class CheckRunPullRequestBase(BaseModel):
    """
    ...
    repo: RepoRef
    sha: StrictStr
    __properties: ClassVar[List[str]] = ["ref", "repo", "sha"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ref": obj.get("ref"),
            "repo": RepoRef.from_dict(obj["repo"]) if obj.get("repo") is not None else None,
            "sha": obj.get("sha")
        })
        return _obj
