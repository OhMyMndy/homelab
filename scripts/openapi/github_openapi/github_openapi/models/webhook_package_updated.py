...
class WebhookPackageUpdated(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "package", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "package": WebhookPackageUpdatedPackage.from_dict(obj["package"]) if obj.get("package") is not None else None,
