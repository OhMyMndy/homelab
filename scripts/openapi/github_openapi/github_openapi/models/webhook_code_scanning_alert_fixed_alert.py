...
class WebhookCodeScanningAlertFixedAlert(BaseModel):
    """
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["created_at", "dismissed_at", "dismissed_by", "dismissed_reason", "html_url", "instances_url", "most_recent_instance", "number", "rule", "state", "tool", "url"]
