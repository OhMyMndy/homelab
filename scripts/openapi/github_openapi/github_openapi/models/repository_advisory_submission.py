...
class RepositoryAdvisorySubmission(BaseModel):
    """
    RepositoryAdvisorySubmission
    """ # noqa: E501
    accepted: StrictBool = Field(description="Whether a private vulnerability report was accepted by the repository's administrators.")
