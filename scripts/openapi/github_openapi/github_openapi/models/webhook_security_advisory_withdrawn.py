...
class WebhookSecurityAdvisoryWithdrawn(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "repository", "security_advisory", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['withdrawn']):
            raise ValueError("must be one of enum values ('withdrawn')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "security_advisory": WebhookSecurityAdvisoryWithdrawnSecurityAdvisory.from_dict(obj["security_advisory"]) if obj.get("security_advisory") is not None else None,
