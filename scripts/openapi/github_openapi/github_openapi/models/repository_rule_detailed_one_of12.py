...
class RepositoryRuleDetailedOneOf12(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['committer_email_pattern']):
            raise ValueError("must be one of enum values ('committer_email_pattern')")
        return value
