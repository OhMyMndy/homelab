...
class WebhookDeploymentCreated(BaseModel):
    ...
    workflow_run: Optional[DeploymentWorkflowRun]
    __properties: ClassVar[List[str]] = ["action", "deployment", "enterprise", "installation", "organization", "repository", "sender", "workflow", "workflow_run"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow_run": DeploymentWorkflowRun.from_dict(obj["workflow_run"]) if obj.get("workflow_run") is not None else None
        })
        return _obj
