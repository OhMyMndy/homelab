...
class WebhookRegistryPackagePublishedRegistryPackageRegistry(BaseModel):
    """
    WebhookRegistryPackagePublishedRegistryPackageRegistry
    """ # noqa: E501
    about_url: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    vendor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["about_url", "name", "type", "url", "vendor"]
