...
class WebhookIssueCommentDeleted(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "comment", "enterprise", "installation", "issue", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issue": WebhookIssueCommentDeletedIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
