...
class RepositoryRuleViolationErrorMetadata(BaseModel):
    """
    RepositoryRuleViolationErrorMetadata
    """ # noqa: E501
    secret_scanning: Optional[RepositoryRuleViolationErrorMetadataSecretScanning] = None
    __properties: ClassVar[List[str]] = ["secret_scanning"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secret_scanning": RepositoryRuleViolationErrorMetadataSecretScanning.from_dict(obj["secret_scanning"]) if obj.get("secret_scanning") is not None else None
        })
        return _obj
