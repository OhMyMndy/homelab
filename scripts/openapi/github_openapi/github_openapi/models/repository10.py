...
class Repository10(BaseModel):
    ...
    has_discussions: StrictBool = Field(description="Whether discussions are enabled.")
    ...
    size: StrictInt
    squash_merge_commit_message: Optional[StrictStr] = Field(default=None, description="The default value for a squash merge commit message.")
    squash_merge_commit_title: Optional[StrictStr] = Field(default=None, description="The default value for a squash merge commit title.")
    ssh_url: StrictStr
