...
class ReposCreateDeploymentProtectionRuleRequest(BaseModel):
    """
    ReposCreateDeploymentProtectionRuleRequest
    """ # noqa: E501
    integration_id: Optional[StrictInt] = Field(default=None, description="The ID of the custom app that will be enabled on the environment.")
    __properties: ClassVar[List[str]] = ["integration_id"]
