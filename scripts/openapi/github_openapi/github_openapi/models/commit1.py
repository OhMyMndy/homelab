...
class Commit1(BaseModel):
    ...
    Commit1
    """ # noqa: E501
    added: Optional[List[StrictStr]] = Field(default=None, description="An array of files added in the commit.")
    author: Committer
    committer: Committer
    ...
    modified: Optional[List[StrictStr]] = Field(default=None, description="An array of files modified by the commit.")
    removed: Optional[List[StrictStr]] = Field(default=None, description="An array of files removed in the commit.")
