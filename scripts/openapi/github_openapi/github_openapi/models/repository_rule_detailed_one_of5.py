...
class RepositoryRuleDetailedOneOf5(BaseModel):
    """
    RepositoryRuleDetailedOneOf5
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleRequiredDeploymentsParameters] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['required_deployments']):
            raise ValueError("must be one of enum values ('required_deployments')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleRequiredDeploymentsParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
