...
class WebhookSecretScanningAlertLocationCreatedFormEncoded(BaseModel):
    ...
    """ # noqa: E501
    payload: StrictStr = Field(description="A URL-encoded string of the secret_scanning_alert_location.created JSON payload. The decoded payload is a JSON object.")
