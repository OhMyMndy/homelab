...
class WebhookProjectsV2ItemArchived(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['archived']):
            raise ValueError("must be one of enum values ('archived')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhooksProjectChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
