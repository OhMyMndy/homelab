...
class WebhookCustomPropertyDeletedDefinition(BaseModel):
    """
    WebhookCustomPropertyDeletedDefinition
    """ # noqa: E501
    property_name: StrictStr = Field(description="The name of the property that was deleted.")
    __properties: ClassVar[List[str]] = ["property_name"]
