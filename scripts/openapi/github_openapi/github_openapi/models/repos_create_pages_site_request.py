...
class ReposCreatePagesSiteRequest(BaseModel):
    """
    The source branch and directory used to publish your Pages site.
    """ # noqa: E501
    build_type: Optional[StrictStr] = Field(default=None, description="The process in which the Page will be built. Possible values are `\"legacy\"` and `\"workflow\"`.")
    source: Optional[ReposCreatePagesSiteRequestSource] = None
