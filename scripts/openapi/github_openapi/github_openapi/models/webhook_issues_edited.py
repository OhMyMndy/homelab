...
class WebhookIssuesEdited(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "issue", "label", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookIssuesEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "issue": Issue2.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
