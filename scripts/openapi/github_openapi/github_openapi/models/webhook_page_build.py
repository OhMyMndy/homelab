...
class WebhookPageBuild(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["build", "enterprise", "id", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "build": WebhookPageBuildBuild.from_dict(obj["build"]) if obj.get("build") is not None else None,
