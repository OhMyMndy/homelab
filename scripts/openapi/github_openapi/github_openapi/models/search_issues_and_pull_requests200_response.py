...
class SearchIssuesAndPullRequests200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["total_count", "incomplete_results", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incomplete_results": obj.get("incomplete_results"),
            "items": [IssueSearchResultItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
