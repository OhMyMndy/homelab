...
class WebhookCustomPropertyUpdated(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "definition", "enterprise", "installation", "organization", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definition": CustomProperty.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
