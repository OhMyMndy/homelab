...
class WebhookInstallationTargetRenamed(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account", "action", "changes", "enterprise", "installation", "organization", "repository", "sender", "target_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": WebhookInstallationTargetRenamedAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "action": obj.get("action"),
            "changes": WebhookInstallationTargetRenamedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
