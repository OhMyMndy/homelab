...
class WebhookSponsorshipEditedChanges(BaseModel):
    """
    WebhookSponsorshipEditedChanges
    """ # noqa: E501
    privacy_level: Optional[WebhookSponsorshipEditedChangesPrivacyLevel] = None
    __properties: ClassVar[List[str]] = ["privacy_level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "privacy_level": WebhookSponsorshipEditedChangesPrivacyLevel.from_dict(obj["privacy_level"]) if obj.get("privacy_level") is not None else None
        })
        return _obj
