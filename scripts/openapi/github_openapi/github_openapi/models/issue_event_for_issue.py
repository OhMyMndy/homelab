...
class IssueEventForIssue(BaseModel):
    ...
    # data type: AssignedIssueEvent
    anyof_schema_3_validator: Optional[AssignedIssueEvent] = None
    # data type: UnassignedIssueEvent
    anyof_schema_4_validator: Optional[UnassignedIssueEvent] = None
    # data type: MilestonedIssueEvent
    anyof_schema_5_validator: Optional[MilestonedIssueEvent] = None
    # data type: DemilestonedIssueEvent
    anyof_schema_6_validator: Optional[DemilestonedIssueEvent] = None
    # data type: RenamedIssueEvent
    anyof_schema_7_validator: Optional[RenamedIssueEvent] = None
    # data type: ReviewRequestedIssueEvent
    anyof_schema_8_validator: Optional[ReviewRequestedIssueEvent] = None
    # data type: ReviewRequestRemovedIssueEvent
    anyof_schema_9_validator: Optional[ReviewRequestRemovedIssueEvent] = None
    # data type: ReviewDismissedIssueEvent
    anyof_schema_10_validator: Optional[ReviewDismissedIssueEvent] = None
    # data type: LockedIssueEvent
    anyof_schema_11_validator: Optional[LockedIssueEvent] = None
    # data type: AddedToProjectIssueEvent
    anyof_schema_12_validator: Optional[AddedToProjectIssueEvent] = None
    # data type: MovedColumnInProjectIssueEvent
    anyof_schema_13_validator: Optional[MovedColumnInProjectIssueEvent] = None
    # data type: RemovedFromProjectIssueEvent
    anyof_schema_14_validator: Optional[RemovedFromProjectIssueEvent] = None
    # data type: ConvertedNoteToIssueIssueEvent
    anyof_schema_15_validator: Optional[ConvertedNoteToIssueIssueEvent] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AddedToProjectIssueEvent, AssignedIssueEvent, ConvertedNoteToIssueIssueEvent, DemilestonedIssueEvent, LabeledIssueEvent, LockedIssueEvent, MilestonedIssueEvent, MovedColumnInProjectIssueEvent, RemovedFromProjectIssueEvent, RenamedIssueEvent, ReviewDismissedIssueEvent, ReviewRequestRemovedIssueEvent, ReviewRequestedIssueEvent, UnassignedIssueEvent, UnlabeledIssueEvent]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "AddedToProjectIssueEvent", "AssignedIssueEvent", "ConvertedNoteToIssueIssueEvent", "DemilestonedIssueEvent", "LabeledIssueEvent", "LockedIssueEvent", "MilestonedIssueEvent", "MovedColumnInProjectIssueEvent", "RemovedFromProjectIssueEvent", "RenamedIssueEvent", "ReviewDismissedIssueEvent", "ReviewRequestRemovedIssueEvent", "ReviewRequestedIssueEvent", "UnassignedIssueEvent", "UnlabeledIssueEvent" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = IssueEventForIssue.model_construct()
        error_messages = []
        ...
        # validate data type: AssignedIssueEvent
        if not isinstance(v, AssignedIssueEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AssignedIssueEvent`")
        else:
            return v

        # validate data type: UnassignedIssueEvent
        if not isinstance(v, UnassignedIssueEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `UnassignedIssueEvent`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in IssueEventForIssue with anyOf schemas: AddedToProjectIssueEvent, AssignedIssueEvent, ConvertedNoteToIssueIssueEvent, DemilestonedIssueEvent, LabeledIssueEvent, LockedIssueEvent, MilestonedIssueEvent, MovedColumnInProjectIssueEvent, RemovedFromProjectIssueEvent, RenamedIssueEvent, ReviewDismissedIssueEvent, ReviewRequestRemovedIssueEvent, ReviewRequestedIssueEvent, UnassignedIssueEvent, UnlabeledIssueEvent. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_3_validator: Optional[AssignedIssueEvent] = None
        try:
            instance.actual_instance = AssignedIssueEvent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[UnassignedIssueEvent] = None
        try:
            instance.actual_instance = UnassignedIssueEvent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_5_validator: Optional[MilestonedIssueEvent] = None
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into IssueEventForIssue with anyOf schemas: AddedToProjectIssueEvent, AssignedIssueEvent, ConvertedNoteToIssueIssueEvent, DemilestonedIssueEvent, LabeledIssueEvent, LockedIssueEvent, MilestonedIssueEvent, MovedColumnInProjectIssueEvent, RemovedFromProjectIssueEvent, RenamedIssueEvent, ReviewDismissedIssueEvent, ReviewRequestRemovedIssueEvent, ReviewRequestedIssueEvent, UnassignedIssueEvent, UnlabeledIssueEvent. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AddedToProjectIssueEvent, AssignedIssueEvent, ConvertedNoteToIssueIssueEvent, DemilestonedIssueEvent, LabeledIssueEvent, LockedIssueEvent, MilestonedIssueEvent, MovedColumnInProjectIssueEvent, RemovedFromProjectIssueEvent, RenamedIssueEvent, ReviewDismissedIssueEvent, ReviewRequestRemovedIssueEvent, ReviewRequestedIssueEvent, UnassignedIssueEvent, UnlabeledIssueEvent]]:
