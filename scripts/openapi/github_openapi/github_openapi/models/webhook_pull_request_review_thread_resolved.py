...
class WebhookPullRequestReviewThreadResolved(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['resolved']):
            raise ValueError("must be one of enum values ('resolved')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_request": SimplePullRequest3.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
            ...
            "thread": WebhookPullRequestReviewThreadResolvedThread.from_dict(obj["thread"]) if obj.get("thread") is not None else None
        })
        return _obj
