...
class WebhookOrganizationMemberInvited(BaseModel):
    ...
    sender: SimpleUser
    user: Optional[WebhooksUser] = None
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "invitation", "organization", "repository", "sender", "user"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['member_invited']):
            raise ValueError("must be one of enum values ('member_invited')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invitation": WebhookOrganizationMemberInvitedInvitation.from_dict(obj["invitation"]) if obj.get("invitation") is not None else None,
            ...
            "user": WebhooksUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
