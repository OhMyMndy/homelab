...
class RepositoryRuleViolationError(BaseModel):
    ...
    metadata: Optional[RepositoryRuleViolationErrorMetadata] = None
    __properties: ClassVar[List[str]] = ["message", "documentation_url", "status", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": RepositoryRuleViolationErrorMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
