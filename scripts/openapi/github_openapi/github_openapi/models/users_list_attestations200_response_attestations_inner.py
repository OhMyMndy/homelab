...
class UsersListAttestations200ResponseAttestationsInner(BaseModel):
    """
    UsersListAttestations200ResponseAttestationsInner
    """ # noqa: E501
    bundle: Optional[SigstoreBundle0] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bundle": SigstoreBundle0.from_dict(obj["bundle"]) if obj.get("bundle") is not None else None,
