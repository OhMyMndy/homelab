...
class WebhookPullRequestReviewThreadUnresolvedThread(BaseModel):
    """
    WebhookPullRequestReviewThreadUnresolvedThread
    """ # noqa: E501
    comments: List[PullRequestReviewComment2]
    node_id: StrictStr
    __properties: ClassVar[List[str]] = ["comments", "node_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comments": [PullRequestReviewComment2.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
