...
class OrgsListAttestations200ResponseAttestationsInnerBundle(BaseModel):
    """
    ...
    verification_material: Optional[Dict[str, Any]] = Field(default=None, alias="verificationMaterial")
    dsse_envelope: Optional[Dict[str, Any]] = Field(default=None, alias="dsseEnvelope")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verificationMaterial": obj.get("verificationMaterial"),
            "dsseEnvelope": obj.get("dsseEnvelope")
        })
        return _obj
