...
class GistsGet403Response(BaseModel):
    """
    GistsGet403Response
    """ # noqa: E501
    block: Optional[GistsGet403ResponseBlock] = None
    message: Optional[StrictStr] = None
    documentation_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["block", "message", "documentation_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "block": GistsGet403ResponseBlock.from_dict(obj["block"]) if obj.get("block") is not None else None,
