...
class PullRequest13(BaseModel):
    ...
    auto_merge: Optional[PullRequestAutoMerge1]
    ...
    requested_reviewers: List[PullRequest3RequestedReviewersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_merge": PullRequestAutoMerge1.from_dict(obj["auto_merge"]) if obj.get("auto_merge") is not None else None,
            ...
            "draft": obj.get("draft"),
            "head": WebhookPullRequestReviewCommentDeletedPullRequestHead.from_dict(obj["head"]) if obj.get("head") is not None else None,
            ...
            "requested_reviewers": [PullRequest3RequestedReviewersInner.from_dict(_item) for _item in obj["requested_reviewers"]] if obj.get("requested_reviewers") is not None else None,
