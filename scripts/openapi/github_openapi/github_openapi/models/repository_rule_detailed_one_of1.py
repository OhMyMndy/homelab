...
class RepositoryRuleDetailedOneOf1(BaseModel):
    """
    RepositoryRuleDetailedOneOf1
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRuleUpdateParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRuleUpdateParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
