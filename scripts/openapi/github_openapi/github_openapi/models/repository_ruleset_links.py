...
class RepositoryRulesetLinks(BaseModel):
    ...
    """ # noqa: E501
    var_self: Optional[RepositoryRulesetLinksSelf] = Field(default=None, alias="self")
    html: Optional[RepositoryRulesetLinksHtml] = None
    __properties: ClassVar[List[str]] = ["self", "html"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": RepositoryRulesetLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "html": RepositoryRulesetLinksHtml.from_dict(obj["html"]) if obj.get("html") is not None else None
        })
        return _obj
