...
class OrgsListAppInstallations200Response(BaseModel):
    """
    OrgsListAppInstallations200Response
    """ # noqa: E501
    total_count: StrictInt
    installations: List[Installation]
    __properties: ClassVar[List[str]] = ["total_count", "installations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "installations": [Installation.from_dict(_item) for _item in obj["installations"]] if obj.get("installations") is not None else None
        })
        return _obj
