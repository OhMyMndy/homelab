...
class WebhookIssuesUnassigned(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "assignee", "enterprise", "installation", "issue", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issue": WebhooksIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
