...
class Repository(BaseModel):
    ...
    updated_at: datetime
    url: StrictStr
    use_squash_pr_title_as_default: Optional[StrictBool] = Field(default=False, description="Whether a squash merge commit can use the pull request title as default.")
