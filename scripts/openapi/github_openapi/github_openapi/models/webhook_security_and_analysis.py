...
class WebhookSecurityAndAnalysis(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["changes", "enterprise", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": WebhookSecurityAndAnalysisChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "repository": FullRepository.from_dict(obj["repository"]) if obj.get("repository") is not None else None,
