...
class ProjectsMoveCard403Response(BaseModel):
    """
    ProjectsMoveCard403Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    documentation_url: Optional[StrictStr] = None
    errors: Optional[List[ProjectsMoveCard403ResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [ProjectsMoveCard403ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
