...
class ContentDirectoryInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "size", "name", "path", "content", "sha", "url", "git_url", "html_url", "download_url", "_links"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['dir', 'file', 'submodule', 'symlink']):
            raise ValueError("must be one of enum values ('dir', 'file', 'submodule', 'symlink')")
        return value
