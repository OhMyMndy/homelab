...
class PullRequestReviewCommentLinks(BaseModel):
    """
    PullRequestReviewCommentLinks
    """ # noqa: E501
    var_self: PullRequestReviewCommentLinksSelf = Field(alias="self")
    html: PullRequestReviewCommentLinksHtml
    pull_request: PullRequestReviewCommentLinksPullRequest
    __properties: ClassVar[List[str]] = ["self", "html", "pull_request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": PullRequestReviewCommentLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "html": PullRequestReviewCommentLinksHtml.from_dict(obj["html"]) if obj.get("html") is not None else None,
            "pull_request": PullRequestReviewCommentLinksPullRequest.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None
        })
        return _obj
