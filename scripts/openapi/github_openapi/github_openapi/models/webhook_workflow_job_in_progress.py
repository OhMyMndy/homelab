...
class WebhookWorkflowJobInProgress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "repository", "sender", "workflow_job", "deployment"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['in_progress']):
            raise ValueError("must be one of enum values ('in_progress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow_job": WebhookWorkflowJobInProgressWorkflowJob.from_dict(obj["workflow_job"]) if obj.get("workflow_job") is not None else None,
