...
class WebhookRegistryPackagePublishedRegistryPackagePackageVersionContainerMetadata(BaseModel):
    """
    WebhookRegistryPackagePublishedRegistryPackagePackageVersionContainerMetadata
    """ # noqa: E501
    labels: Optional[Dict[str, Any]] = None
    manifest: Optional[Dict[str, Any]] = None
    tag: Optional[WebhookPackagePublishedPackagePackageVersionContainerMetadataTag] = None
    __properties: ClassVar[List[str]] = ["labels", "manifest", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": WebhookPackagePublishedPackagePackageVersionContainerMetadataTag.from_dict(obj["tag"]) if obj.get("tag") is not None else None
        })
        return _obj
