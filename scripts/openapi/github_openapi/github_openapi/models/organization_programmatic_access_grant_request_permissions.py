...
class OrganizationProgrammaticAccessGrantRequestPermissions(BaseModel):
    """
    Permissions requested, categorized by type of permission.
    """ # noqa: E501
    organization: Optional[Dict[str, StrictStr]] = None
    repository: Optional[Dict[str, StrictStr]] = None
    other: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["organization", "repository", "other"]
