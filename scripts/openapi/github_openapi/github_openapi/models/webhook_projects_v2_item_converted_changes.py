...
class WebhookProjectsV2ItemConvertedChanges(BaseModel):
    """
    WebhookProjectsV2ItemConvertedChanges
    """ # noqa: E501
    content_type: Optional[WebhookProjectsV2ItemConvertedChangesContentType] = None
    __properties: ClassVar[List[str]] = ["content_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content_type": WebhookProjectsV2ItemConvertedChangesContentType.from_dict(obj["content_type"]) if obj.get("content_type") is not None else None
        })
        return _obj
