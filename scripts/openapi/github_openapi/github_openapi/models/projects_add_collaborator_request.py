...
class ProjectsAddCollaboratorRequest(BaseModel):
    """
    ProjectsAddCollaboratorRequest
    """ # noqa: E501
    permission: Optional[StrictStr] = Field(default='write', description="The permission to grant the collaborator.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permission": obj.get("permission") if obj.get("permission") is not None else 'write'
        })
        return _obj
