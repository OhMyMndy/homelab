...
class WebhookDiscussionAnswered(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "answer", "discussion", "enterprise", "installation", "organization", "repository", "sender"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['answered']):
            raise ValueError("must be one of enum values ('answered')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "answer": WebhooksAnswer.from_dict(obj["answer"]) if obj.get("answer") is not None else None,
