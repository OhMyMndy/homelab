...
class ActionsListWorkflowRunsForRepo200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow_runs": [WorkflowRun.from_dict(_item) for _item in obj["workflow_runs"]] if obj.get("workflow_runs") is not None else None
        })
        return _obj
