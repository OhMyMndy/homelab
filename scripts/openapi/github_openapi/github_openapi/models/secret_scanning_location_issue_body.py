...
class SecretScanningLocationIssueBody(BaseModel):
    ...
    """ # noqa: E501
    issue_body_url: StrictStr = Field(description="The API URL to get the issue where the secret was detected.")
    __properties: ClassVar[List[str]] = ["issue_body_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issue_body_url": obj.get("issue_body_url")
        })
        return _obj
