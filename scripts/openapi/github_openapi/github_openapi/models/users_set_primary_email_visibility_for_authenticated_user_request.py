...
class UsersSetPrimaryEmailVisibilityForAuthenticatedUserRequest(BaseModel):
    """
    UsersSetPrimaryEmailVisibilityForAuthenticatedUserRequest
    """ # noqa: E501
    visibility: StrictStr = Field(description="Denotes whether an email is publicly visible.")
