...
class WebhookOrganizationRenamedChanges(BaseModel):
    """
    WebhookOrganizationRenamedChanges
    """ # noqa: E501
    login: Optional[WebhookOrganizationRenamedChangesLogin] = None
    __properties: ClassVar[List[str]] = ["login"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "login": WebhookOrganizationRenamedChangesLogin.from_dict(obj["login"]) if obj.get("login") is not None else None
        })
        return _obj
