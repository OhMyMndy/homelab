...
class WebhookMilestoneOpened(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "milestone", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "milestone": WebhooksMilestone3.from_dict(obj["milestone"]) if obj.get("milestone") is not None else None,
