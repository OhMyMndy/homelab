...
class ActivitySetThreadSubscriptionRequest(BaseModel):
    """
    ActivitySetThreadSubscriptionRequest
    """ # noqa: E501
    ignored: Optional[StrictBool] = Field(default=False, description="Whether to block all notifications from a thread.")
    __properties: ClassVar[List[str]] = ["ignored"]
