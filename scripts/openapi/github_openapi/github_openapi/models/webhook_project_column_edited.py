...
class WebhookProjectColumnEdited(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "changes", "enterprise", "installation", "organization", "project_column", "repository", "sender"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of project_column
        if self.project_column:
            _dict['project_column'] = self.project_column.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookProjectColumnEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            ...
            "project_column": WebhooksProjectColumn.from_dict(obj["project_column"]) if obj.get("project_column") is not None else None,
