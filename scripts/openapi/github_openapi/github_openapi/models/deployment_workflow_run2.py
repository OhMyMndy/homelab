...
class DeploymentWorkflowRun2(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['requested', 'in_progress', 'completed', 'queued', 'waiting']):
            raise ValueError("must be one of enum values ('requested', 'in_progress', 'completed', 'queued', 'waiting')")
        return value
