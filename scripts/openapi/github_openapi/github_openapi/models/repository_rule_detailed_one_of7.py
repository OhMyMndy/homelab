...
class RepositoryRuleDetailedOneOf7(BaseModel):
    """
    RepositoryRuleDetailedOneOf7
    """ # noqa: E501
    type: StrictStr
    parameters: Optional[RepositoryRulePullRequestParameters] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pull_request']):
            raise ValueError("must be one of enum values ('pull_request')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": RepositoryRulePullRequestParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
