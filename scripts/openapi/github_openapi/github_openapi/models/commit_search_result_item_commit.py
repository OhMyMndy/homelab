...
class CommitSearchResultItemCommit(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["author", "committer", "comment_count", "message", "tree", "url", "verification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": CommitSearchResultItemCommitAuthor.from_dict(obj["author"]) if obj.get("author") is not None else None,
