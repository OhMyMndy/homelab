...
class WebhooksPullRequest5(BaseModel):
    ...
    requested_reviewers: List[WebhooksPullRequest5RequestedReviewersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "base": WebhooksPullRequest5Base.from_dict(obj["base"]) if obj.get("base") is not None else None,
            "body": obj.get("body"),
            ...
            "draft": obj.get("draft"),
            "head": WebhooksPullRequest5Base.from_dict(obj["head"]) if obj.get("head") is not None else None,
            ...
            "merged_by": User4.from_dict(obj["merged_by"]) if obj.get("merged_by") is not None else None,
            ...
            "requested_reviewers": [WebhooksPullRequest5RequestedReviewersInner.from_dict(_item) for _item in obj["requested_reviewers"]] if obj.get("requested_reviewers") is not None else None,
