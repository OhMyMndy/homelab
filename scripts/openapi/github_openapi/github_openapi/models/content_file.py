...
class ContentFile(BaseModel):
    ...
    submodule_git_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "encoding", "size", "name", "path", "content", "sha", "url", "git_url", "html_url", "download_url", "_links", "target", "submodule_git_url"]
