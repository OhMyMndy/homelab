...
class WebhookRepositoryRulesetEdited(BaseModel):
    ...
    changes: Optional[WebhookRepositoryRulesetEditedChanges] = None
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "enterprise", "installation", "organization", "repository", "repository_ruleset", "changes", "sender"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of repository_ruleset
        if self.repository_ruleset:
            _dict['repository_ruleset'] = self.repository_ruleset.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repository_ruleset": RepositoryRuleset.from_dict(obj["repository_ruleset"]) if obj.get("repository_ruleset") is not None else None,
            "changes": WebhookRepositoryRulesetEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
