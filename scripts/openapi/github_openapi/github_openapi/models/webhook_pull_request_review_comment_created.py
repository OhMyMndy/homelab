...
class WebhookPullRequestReviewCommentCreated(BaseModel):
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "comment", "enterprise", "installation", "organization", "pull_request", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": PullRequestReviewComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
            ...
            "pull_request": WebhookPullRequestReviewCommentCreatedPullRequest.from_dict(obj["pull_request"]) if obj.get("pull_request") is not None else None,
