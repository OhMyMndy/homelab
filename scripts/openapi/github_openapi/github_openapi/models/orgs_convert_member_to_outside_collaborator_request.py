...
class OrgsConvertMemberToOutsideCollaboratorRequest(BaseModel):
    """
    OrgsConvertMemberToOutsideCollaboratorRequest
    """ # noqa: E501
    var_async: Optional[StrictBool] = Field(default=False, description="When set to `true`, the request will be performed asynchronously. Returns a 202 status code when the job is successfully queued.", alias="async")
