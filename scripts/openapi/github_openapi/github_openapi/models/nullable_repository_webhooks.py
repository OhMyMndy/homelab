...
class NullableRepositoryWebhooks(BaseModel):
    ...
    template_repository: Optional[RepositoryWebhooksTemplateRepository] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "template_repository": RepositoryWebhooksTemplateRepository.from_dict(obj["template_repository"]) if obj.get("template_repository") is not None else None,
