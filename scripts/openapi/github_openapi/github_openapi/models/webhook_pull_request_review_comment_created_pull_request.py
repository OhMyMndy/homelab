...
class WebhookPullRequestReviewCommentCreatedPullRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "draft": obj.get("draft"),
            "head": WebhookPullRequestReviewCommentCreatedPullRequestHead.from_dict(obj["head"]) if obj.get("head") is not None else None,
