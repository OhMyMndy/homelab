...
class Issue4(BaseModel):
    ...
    html_url: StrictStr
    id: StrictInt
    labels: Optional[List[Optional[Label1]]] = None
    labels_url: StrictStr
    locked: StrictBool
    milestone: Optional[Milestone1]
    node_id: StrictStr
    number: StrictInt
    performed_via_github_app: Optional[App14] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "labels": [Label1.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
            ...
            "performed_via_github_app": App14.from_dict(obj["performed_via_github_app"]) if obj.get("performed_via_github_app") is not None else None,
