...
class WebhookDiscussionEdited(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr
    changes: Optional[WebhookDiscussionEditedChanges] = None
    ...
    sender: SimpleUser
    __properties: ClassVar[List[str]] = ["action", "changes", "discussion", "enterprise", "installation", "organization", "repository", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": WebhookDiscussionEditedChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
