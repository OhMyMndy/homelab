...
class CodeSecurityDetachConfigurationRequest(BaseModel):
    """
    CodeSecurityDetachConfigurationRequest
    """ # noqa: E501
    selected_repository_ids: Optional[List[StrictInt]] = Field(default=None, description="An array of repository IDs to detach from configurations.")
