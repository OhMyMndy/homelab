...
class RateLimitApi:
    ...
    def rate_limit_get(
        ...
        _param = self._rate_limit_get_serialize(
    ...
    @validate_call
    def rate_limit_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def rate_limit_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
