...
class GitignoreApi:
    ...
    def gitignore_get_all_templates(
        ...
        _param = self._gitignore_get_all_templates_serialize(
    ...
    @validate_call
    def gitignore_get_all_templates_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def gitignore_get_all_templates_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _gitignore_get_all_templates_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def gitignore_get_template(
        ...
        _param = self._gitignore_get_template_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def gitignore_get_template_with_http_info(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def gitignore_get_template_without_preload_content(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _gitignore_get_template_serialize(
        self,
        name,
        _request_auth,
        _content_type,
