...
class TestWebhookProjectColumnMoved(unittest.TestCase):
    """WebhookProjectColumnMoved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectColumnMoved:
        """Test WebhookProjectColumnMoved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectColumnMoved`
        """
        model = WebhookProjectColumnMoved()
        if include_optional:
    ...
    def testWebhookProjectColumnMoved(self):
        """Test WebhookProjectColumnMoved"""
