...
class TestWebhookDiscussionPinned(unittest.TestCase):
    """WebhookDiscussionPinned unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionPinned:
        """Test WebhookDiscussionPinned
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionPinned`
        """
        model = WebhookDiscussionPinned()
        if include_optional:
    ...
    def testWebhookDiscussionPinned(self):
        """Test WebhookDiscussionPinned"""
