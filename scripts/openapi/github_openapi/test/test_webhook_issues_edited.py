...
class TestWebhookIssuesEdited(unittest.TestCase):
    """WebhookIssuesEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssuesEdited:
        """Test WebhookIssuesEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssuesEdited`
        """
        model = WebhookIssuesEdited()
        if include_optional:
            return WebhookIssuesEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_issues_edited_changes.webhook_issues_edited_changes(
    ...
    def testWebhookIssuesEdited(self):
        """Test WebhookIssuesEdited"""
