...
class TestConvertedNoteToIssueIssueEvent(unittest.TestCase):
    """ConvertedNoteToIssueIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConvertedNoteToIssueIssueEvent:
        """Test ConvertedNoteToIssueIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConvertedNoteToIssueIssueEvent`
        """
        model = ConvertedNoteToIssueIssueEvent()
        if include_optional:
    ...
    def testConvertedNoteToIssueIssueEvent(self):
        """Test ConvertedNoteToIssueIssueEvent"""
