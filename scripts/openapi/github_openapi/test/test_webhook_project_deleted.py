...
class TestWebhookProjectDeleted(unittest.TestCase):
    """WebhookProjectDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectDeleted:
        """Test WebhookProjectDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectDeleted`
        """
        model = WebhookProjectDeleted()
        if include_optional:
    ...
    def testWebhookProjectDeleted(self):
        """Test WebhookProjectDeleted"""
