...
class TestWebhookRepositoryRulesetEditedChangesConditionsUpdatedInner(unittest.TestCase):
    """WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner:
        """Test WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner`
        """
        model = WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner()
        if include_optional:
            return WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner(
    ...
    def testWebhookRepositoryRulesetEditedChangesConditionsUpdatedInner(self):
        """Test WebhookRepositoryRulesetEditedChangesConditionsUpdatedInner"""
