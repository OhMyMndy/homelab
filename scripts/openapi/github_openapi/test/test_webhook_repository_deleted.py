...
class TestWebhookRepositoryDeleted(unittest.TestCase):
    """WebhookRepositoryDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryDeleted:
        """Test WebhookRepositoryDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryDeleted`
        """
        model = WebhookRepositoryDeleted()
        if include_optional:
            return WebhookRepositoryDeleted(
                action = 'deleted',
    ...
    def testWebhookRepositoryDeleted(self):
        """Test WebhookRepositoryDeleted"""
