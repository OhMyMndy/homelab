...
class TestCodeSecurityConfiguration(unittest.TestCase):
    """CodeSecurityConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeSecurityConfiguration:
        """Test CodeSecurityConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeSecurityConfiguration`
        """
        model = CodeSecurityConfiguration()
        if include_optional:
    ...
    def testCodeSecurityConfiguration(self):
        """Test CodeSecurityConfiguration"""
