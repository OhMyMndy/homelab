...
class TestWebhookProjectColumnDeleted(unittest.TestCase):
    """WebhookProjectColumnDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectColumnDeleted:
        """Test WebhookProjectColumnDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectColumnDeleted`
        """
        model = WebhookProjectColumnDeleted()
        if include_optional:
    ...
    def testWebhookProjectColumnDeleted(self):
        """Test WebhookProjectColumnDeleted"""
