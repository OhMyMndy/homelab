...
class TestWebhookIssuesOpened(unittest.TestCase):
    """WebhookIssuesOpened unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssuesOpened:
        """Test WebhookIssuesOpened
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssuesOpened`
        """
        model = WebhookIssuesOpened()
        if include_optional:
            return WebhookIssuesOpened(
                action = 'opened',
                changes = github_openapi.models.webhook_issues_opened_changes.webhook_issues_opened_changes(
    ...
    def testWebhookIssuesOpened(self):
        """Test WebhookIssuesOpened"""
