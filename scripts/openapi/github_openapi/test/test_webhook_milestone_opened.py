...
class TestWebhookMilestoneOpened(unittest.TestCase):
    """WebhookMilestoneOpened unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMilestoneOpened:
        """Test WebhookMilestoneOpened
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMilestoneOpened`
        """
        model = WebhookMilestoneOpened()
        if include_optional:
            return WebhookMilestoneOpened(
                action = 'opened',
    ...
    def testWebhookMilestoneOpened(self):
        """Test WebhookMilestoneOpened"""
