...
class TestWebhookOrganizationDeleted(unittest.TestCase):
    """WebhookOrganizationDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookOrganizationDeleted:
        """Test WebhookOrganizationDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookOrganizationDeleted`
        """
        model = WebhookOrganizationDeleted()
        if include_optional:
    ...
    def testWebhookOrganizationDeleted(self):
        """Test WebhookOrganizationDeleted"""
