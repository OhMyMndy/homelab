...
class TestWebhookMemberAdded(unittest.TestCase):
    """WebhookMemberAdded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMemberAdded:
        """Test WebhookMemberAdded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMemberAdded`
        """
        model = WebhookMemberAdded()
        if include_optional:
            return WebhookMemberAdded(
                action = 'added',
                changes = github_openapi.models.webhook_member_added_changes.webhook_member_added_changes(
    ...
    def testWebhookMemberAdded(self):
        """Test WebhookMemberAdded"""
