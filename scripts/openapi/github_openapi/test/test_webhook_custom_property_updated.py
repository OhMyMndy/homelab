...
class TestWebhookCustomPropertyUpdated(unittest.TestCase):
    """WebhookCustomPropertyUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookCustomPropertyUpdated:
        """Test WebhookCustomPropertyUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookCustomPropertyUpdated`
        """
        model = WebhookCustomPropertyUpdated()
        if include_optional:
            return WebhookCustomPropertyUpdated(
                action = 'updated',
                definition = github_openapi.models.organization_custom_property.Organization Custom Property(
                    property_name = '', 
                    url = '', 
    ...
    def testWebhookCustomPropertyUpdated(self):
        """Test WebhookCustomPropertyUpdated"""
