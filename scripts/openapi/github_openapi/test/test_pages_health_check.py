...
class TestPagesHealthCheck(unittest.TestCase):
    """PagesHealthCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagesHealthCheck:
        """Test PagesHealthCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagesHealthCheck`
        """
        model = PagesHealthCheck()
        if include_optional:
            return PagesHealthCheck(
                domain = github_openapi.models.pages_health_check_domain.pages_health_check_domain(
                    host = '', 
                    uri = '', 
                    nameservers = '', 
                    dns_resolves = True, 
                    ...
                    caa_error = '', ),
                alt_domain = github_openapi.models.pages_health_check_alt_domain.pages_health_check_alt_domain(
                    host = '', 
                    uri = '', 
                    nameservers = '', 
                    dns_resolves = True, 
