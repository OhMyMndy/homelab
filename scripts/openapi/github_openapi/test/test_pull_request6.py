...
class TestPullRequest6(unittest.TestCase):
    """PullRequest6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest6:
        """Test PullRequest6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest6`
        """
        model = PullRequest6()
        if include_optional:
            return PullRequest6(
