...
class TestSearchCommits200Response(unittest.TestCase):
    """SearchCommits200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchCommits200Response:
        """Test SearchCommits200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCommits200Response`
        """
        model = SearchCommits200Response()
        if include_optional:
            return SearchCommits200Response(
                total_count = 56,
                incomplete_results = True,
                items = [
                    github_openapi.models.commit_search_result_item.Commit Search Result Item(
                        url = '', 
                        sha = '', 
                        html_url = '', 
                        comments_url = '', 
...
', 
    ...
    def testSearchCommits200Response(self):
        """Test SearchCommits200Response"""
