...
class TestWebhookWorkflowJobCompleted(unittest.TestCase):
    """WebhookWorkflowJobCompleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookWorkflowJobCompleted:
        """Test WebhookWorkflowJobCompleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookWorkflowJobCompleted`
        """
        model = WebhookWorkflowJobCompleted()
        if include_optional:
    ...
    def testWebhookWorkflowJobCompleted(self):
        """Test WebhookWorkflowJobCompleted"""
