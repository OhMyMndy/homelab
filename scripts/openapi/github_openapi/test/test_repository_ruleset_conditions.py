...
class TestRepositoryRulesetConditions(unittest.TestCase):
    """RepositoryRulesetConditions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepositoryRulesetConditions:
        """Test RepositoryRulesetConditions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepositoryRulesetConditions`
        """
        model = RepositoryRulesetConditions()
        if include_optional:
    ...
    def testRepositoryRulesetConditions(self):
        """Test RepositoryRulesetConditions"""
