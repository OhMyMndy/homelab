...
class TestWebhookTeamCreated(unittest.TestCase):
    """WebhookTeamCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookTeamCreated:
        """Test WebhookTeamCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookTeamCreated`
        """
        model = WebhookTeamCreated()
        if include_optional:
    ...
    def testWebhookTeamCreated(self):
        """Test WebhookTeamCreated"""
