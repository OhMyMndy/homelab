...
class TestPullRequest1(unittest.TestCase):
    """PullRequest1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest1:
        """Test PullRequest1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest1`
        """
        model = PullRequest1()
        if include_optional:
            return PullRequest1(
