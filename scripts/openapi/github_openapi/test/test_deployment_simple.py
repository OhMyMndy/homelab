...
class TestDeploymentSimple(unittest.TestCase):
    """DeploymentSimple unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentSimple:
        """Test DeploymentSimple
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentSimple`
        """
        model = DeploymentSimple()
        if include_optional:
