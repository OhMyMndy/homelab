...
class TestRepository9(unittest.TestCase):
    """Repository9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Repository9:
        """Test Repository9
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Repository9`
        """
        model = Repository9()
        if include_optional:
            return Repository9(
