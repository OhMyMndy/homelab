...
class TestWebhookLabelEdited(unittest.TestCase):
    """WebhookLabelEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookLabelEdited:
        """Test WebhookLabelEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookLabelEdited`
        """
        model = WebhookLabelEdited()
        if include_optional:
            return WebhookLabelEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_label_edited_changes.webhook_label_edited_changes(
    ...
    def testWebhookLabelEdited(self):
        """Test WebhookLabelEdited"""
