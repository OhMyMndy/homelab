...
class TestWebhookSubIssuesParentIssueRemoved(unittest.TestCase):
    """WebhookSubIssuesParentIssueRemoved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSubIssuesParentIssueRemoved:
        """Test WebhookSubIssuesParentIssueRemoved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSubIssuesParentIssueRemoved`
        """
        model = WebhookSubIssuesParentIssueRemoved()
        if include_optional:
            return WebhookSubIssuesParentIssueRemoved(
                action = 'parent_issue_removed',
                parent_issue_id = 1.337,
                parent_issue = github_openapi.models.issue.Issue(
                    id = 56, 
                    node_id = '', 
                ...
                parent_issue_repo = github_openapi.models.repository.Repository(
                    id = 42, 
                    node_id = 'MDEwOlJlcG9zaXRvcnkxMjk2MjY5', 
                    name = 'Team Environment', 
                    full_name = 'octocat/Hello-World', 
                    ...
                    anonymous_access_enabled = True, ),
                sub_issue_id = 1.337,
                sub_issue = github_openapi.models.issue.Issue(
                    id = 56, 
                    node_id = '', 
                    url = 'https://api.github.com/repositories/42/issues/1', 
                    repository_url = '', 
    ...
    def testWebhookSubIssuesParentIssueRemoved(self):
        """Test WebhookSubIssuesParentIssueRemoved"""
