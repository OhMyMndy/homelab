...
class TestWebhookWorkflowJobInProgress(unittest.TestCase):
    """WebhookWorkflowJobInProgress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookWorkflowJobInProgress:
        """Test WebhookWorkflowJobInProgress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookWorkflowJobInProgress`
        """
        model = WebhookWorkflowJobInProgress()
        if include_optional:
    ...
    def testWebhookWorkflowJobInProgress(self):
        """Test WebhookWorkflowJobInProgress"""
