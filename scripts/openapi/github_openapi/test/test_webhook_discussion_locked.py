...
class TestWebhookDiscussionLocked(unittest.TestCase):
    """WebhookDiscussionLocked unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionLocked:
        """Test WebhookDiscussionLocked
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionLocked`
        """
        model = WebhookDiscussionLocked()
        if include_optional:
            return WebhookDiscussionLocked(
                action = 'locked',
    ...
    def testWebhookDiscussionLocked(self):
        """Test WebhookDiscussionLocked"""
