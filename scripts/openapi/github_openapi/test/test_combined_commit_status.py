...
class TestCombinedCommitStatus(unittest.TestCase):
    """CombinedCommitStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CombinedCommitStatus:
        """Test CombinedCommitStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CombinedCommitStatus`
        """
        model = CombinedCommitStatus()
        if include_optional:
            return CombinedCommitStatus(
                state = '',
                statuses = [
                    github_openapi.models.simple_commit_status.Simple Commit Status(
                        description = '', 
                        id = 56, 
                        node_id = '', 
                        state = '', 
...
', 
    ...
    def testCombinedCommitStatus(self):
        """Test CombinedCommitStatus"""
