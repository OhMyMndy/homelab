...
class TestCodeSecurityConfigurationForRepository(unittest.TestCase):
    """CodeSecurityConfigurationForRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeSecurityConfigurationForRepository:
        """Test CodeSecurityConfigurationForRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeSecurityConfigurationForRepository`
        """
        model = CodeSecurityConfigurationForRepository()
        if include_optional:
    ...
    def testCodeSecurityConfigurationForRepository(self):
        """Test CodeSecurityConfigurationForRepository"""
