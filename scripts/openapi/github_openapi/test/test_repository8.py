...
class TestRepository8(unittest.TestCase):
    """Repository8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Repository8:
        """Test Repository8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Repository8`
        """
        model = Repository8()
        if include_optional:
            return Repository8(
