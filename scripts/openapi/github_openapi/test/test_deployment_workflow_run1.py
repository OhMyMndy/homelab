...
class TestDeploymentWorkflowRun1(unittest.TestCase):
    """DeploymentWorkflowRun1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentWorkflowRun1:
        """Test DeploymentWorkflowRun1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentWorkflowRun1`
        """
        model = DeploymentWorkflowRun1()
        if include_optional:
            return DeploymentWorkflowRun1(
    ...
    def testDeploymentWorkflowRun1(self):
        """Test DeploymentWorkflowRun1"""
