    ...
    def make_instance(self, include_optional) -> Event:
        ...
        if include_optional:
            return Event(
                id = '',
                type = '',
                actor = github_openapi.models.actor.Actor(
                    id = 56, 
                    login = '', 
                    display_login = '', 
                    gravatar_id = '', 
                    url = '', 
                    avatar_url = '', ),
                repo = github_openapi.models.event_repo.event_repo(
                    id = 56, 
                    name = '', 
                    url = '', ),
                org = github_openapi.models.actor.Actor(
                    id = 56, 
                    login = '', 
                    display_login = '', 
                    gravatar_id = '', 
                    url = '', 
                    avatar_url = '', ),
                payload = github_openapi.models.event_payload.event_payload(
                    action = '', 
                    ...
                    comment = github_openapi.models.issue_comment.Issue Comment(
                        ...
                        author_association = 'OWNER', ), 
                    pages = [
                        github_openapi.models.event_payload_pages_inner.event_payload_pages_inner(
                            page_name = '', 
                            title = '', 
                            summary = '', 
                            action = '', 
