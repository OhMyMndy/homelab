...
class TestWebhookIssuesClosed(unittest.TestCase):
    """WebhookIssuesClosed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssuesClosed:
        """Test WebhookIssuesClosed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssuesClosed`
        """
        model = WebhookIssuesClosed()
        if include_optional:
    ...
    def testWebhookIssuesClosed(self):
        """Test WebhookIssuesClosed"""
