...
class TestProtectedBranchPullRequestReview(unittest.TestCase):
    """ProtectedBranchPullRequestReview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectedBranchPullRequestReview:
        """Test ProtectedBranchPullRequestReview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectedBranchPullRequestReview`
        """
        model = ProtectedBranchPullRequestReview()
        if include_optional:
    ...
    def testProtectedBranchPullRequestReview(self):
        """Test ProtectedBranchPullRequestReview"""
