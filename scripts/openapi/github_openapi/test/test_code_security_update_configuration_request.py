...
class TestCodeSecurityUpdateConfigurationRequest(unittest.TestCase):
    """CodeSecurityUpdateConfigurationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeSecurityUpdateConfigurationRequest:
        """Test CodeSecurityUpdateConfigurationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeSecurityUpdateConfigurationRequest`
        """
        model = CodeSecurityUpdateConfigurationRequest()
        if include_optional:
    ...
    def testCodeSecurityUpdateConfigurationRequest(self):
        """Test CodeSecurityUpdateConfigurationRequest"""
