...
class TestWebhookDependabotAlertFixed(unittest.TestCase):
    """WebhookDependabotAlertFixed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDependabotAlertFixed:
        """Test WebhookDependabotAlertFixed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDependabotAlertFixed`
        """
        model = WebhookDependabotAlertFixed()
        if include_optional:
    ...
    def testWebhookDependabotAlertFixed(self):
        """Test WebhookDependabotAlertFixed"""
