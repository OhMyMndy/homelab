...
class TestWebhookInstallationCreated(unittest.TestCase):
    """WebhookInstallationCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookInstallationCreated:
        """Test WebhookInstallationCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookInstallationCreated`
        """
        model = WebhookInstallationCreated()
        if include_optional:
    ...
    def testWebhookInstallationCreated(self):
        """Test WebhookInstallationCreated"""
