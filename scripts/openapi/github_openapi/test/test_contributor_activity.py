...
class TestContributorActivity(unittest.TestCase):
    """ContributorActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContributorActivity:
        """Test ContributorActivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContributorActivity`
        """
    ...
    def testContributorActivity(self):
        """Test ContributorActivity"""
