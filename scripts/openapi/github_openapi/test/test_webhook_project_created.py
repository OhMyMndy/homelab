...
class TestWebhookProjectCreated(unittest.TestCase):
    """WebhookProjectCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectCreated:
        """Test WebhookProjectCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectCreated`
        """
        model = WebhookProjectCreated()
        if include_optional:
            return WebhookProjectCreated(
                action = 'created',
    ...
    def testWebhookProjectCreated(self):
        """Test WebhookProjectCreated"""
