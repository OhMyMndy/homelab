...
class TestNullableIntegration(unittest.TestCase):
    """NullableIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NullableIntegration:
        """Test NullableIntegration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NullableIntegration`
        """
        model = NullableIntegration()
        if include_optional:
            return NullableIntegration(
                id = 37,
                slug = 'probot-owners',
    ...
    def testNullableIntegration(self):
        """Test NullableIntegration"""
