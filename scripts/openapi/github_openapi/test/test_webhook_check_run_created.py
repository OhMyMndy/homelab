...
class TestWebhookCheckRunCreated(unittest.TestCase):
    """WebhookCheckRunCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookCheckRunCreated:
        """Test WebhookCheckRunCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookCheckRunCreated`
        """
        model = WebhookCheckRunCreated()
        if include_optional:
...
', 
    ...
    def testWebhookCheckRunCreated(self):
        """Test WebhookCheckRunCreated"""
