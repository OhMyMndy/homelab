...
class TestWebhookProjectReopened(unittest.TestCase):
    """WebhookProjectReopened unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectReopened:
        """Test WebhookProjectReopened
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectReopened`
        """
        model = WebhookProjectReopened()
        if include_optional:
    ...
    def testWebhookProjectReopened(self):
        """Test WebhookProjectReopened"""
