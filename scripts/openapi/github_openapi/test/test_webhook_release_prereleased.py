...
class TestWebhookReleasePrereleased(unittest.TestCase):
    """WebhookReleasePrereleased unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookReleasePrereleased:
        """Test WebhookReleasePrereleased
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookReleasePrereleased`
        """
        model = WebhookReleasePrereleased()
        if include_optional:
    ...
    def testWebhookReleasePrereleased(self):
        """Test WebhookReleasePrereleased"""
