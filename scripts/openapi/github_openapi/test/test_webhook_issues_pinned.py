...
class TestWebhookIssuesPinned(unittest.TestCase):
    """WebhookIssuesPinned unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssuesPinned:
        """Test WebhookIssuesPinned
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssuesPinned`
        """
        model = WebhookIssuesPinned()
        if include_optional:
    ...
    def testWebhookIssuesPinned(self):
        """Test WebhookIssuesPinned"""
