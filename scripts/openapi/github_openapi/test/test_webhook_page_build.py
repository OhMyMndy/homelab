...
class TestWebhookPageBuild(unittest.TestCase):
    """WebhookPageBuild unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookPageBuild:
        """Test WebhookPageBuild
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookPageBuild`
        """
        model = WebhookPageBuild()
        if include_optional:
            return WebhookPageBuild(
                build = github_openapi.models.webhook_page_build_build.webhook_page_build_build(
                    commit = '', 
                    created_at = '', 
                    duration = 56, 
