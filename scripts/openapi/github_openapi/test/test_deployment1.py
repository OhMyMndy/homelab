...
class TestDeployment1(unittest.TestCase):
    """Deployment1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Deployment1:
        """Test Deployment1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Deployment1`
        """
        model = Deployment1()
        if include_optional:
            return Deployment1(
