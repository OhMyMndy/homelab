...
class TestWebhookDeploymentProtectionRuleRequested(unittest.TestCase):
    """WebhookDeploymentProtectionRuleRequested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDeploymentProtectionRuleRequested:
        """Test WebhookDeploymentProtectionRuleRequested
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDeploymentProtectionRuleRequested`
        """
        model = WebhookDeploymentProtectionRuleRequested()
        if include_optional:
            return WebhookDeploymentProtectionRuleRequested(
                action = 'requested',
                environment = '',
                event = '',
                ...
                pull_requests = [
                    github_openapi.models.pull_request.Pull Request(
                        ...
                        labels = [
                            github_openapi.models.pull_request_labels_inner.pull_request_labels_inner(
                                id = 56, 
                                node_id = '', 
                                url = '', 
                                name = '', 
                        ...
                        head = github_openapi.models.pull_request_head.pull_request_head(
                            ...
                            sha = '', 
                            user = , ), 
                        base = github_openapi.models.pull_request_head.pull_request_head(
                            label = '', 
                            ref = '', 
                            repo = github_openapi.models.repository.Repository(
                                id = 42, 
                            ...
                            sha = '', 
                            user = , ), 
                        _links = github_openapi.models.pull_request_simple__links.pull_request_simple__links(
                        ...
                        auto_merge = github_openapi.models.auto_merge.Auto merge(
                            enabled_by = , 
                            merge_method = 'merge', 
                            commit_title = '', 
                            commit_message = '', ), 
    ...
    def testWebhookDeploymentProtectionRuleRequested(self):
        """Test WebhookDeploymentProtectionRuleRequested"""
