...
class TestProtectedBranchRequiredPullRequestReviews(unittest.TestCase):
    """ProtectedBranchRequiredPullRequestReviews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectedBranchRequiredPullRequestReviews:
        """Test ProtectedBranchRequiredPullRequestReviews
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectedBranchRequiredPullRequestReviews`
        """
        model = ProtectedBranchRequiredPullRequestReviews()
        if include_optional:
    ...
    def testProtectedBranchRequiredPullRequestReviews(self):
        """Test ProtectedBranchRequiredPullRequestReviews"""
