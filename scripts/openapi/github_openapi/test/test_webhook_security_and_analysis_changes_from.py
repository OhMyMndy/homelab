...
class TestWebhookSecurityAndAnalysisChangesFrom(unittest.TestCase):
    """WebhookSecurityAndAnalysisChangesFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSecurityAndAnalysisChangesFrom:
        """Test WebhookSecurityAndAnalysisChangesFrom
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSecurityAndAnalysisChangesFrom`
        """
        model = WebhookSecurityAndAnalysisChangesFrom()
        if include_optional:
            return WebhookSecurityAndAnalysisChangesFrom(
    ...
    def testWebhookSecurityAndAnalysisChangesFrom(self):
        """Test WebhookSecurityAndAnalysisChangesFrom"""
