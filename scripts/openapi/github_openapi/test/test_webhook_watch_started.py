...
class TestWebhookWatchStarted(unittest.TestCase):
    """WebhookWatchStarted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookWatchStarted:
        """Test WebhookWatchStarted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookWatchStarted`
        """
        model = WebhookWatchStarted()
        if include_optional:
            return WebhookWatchStarted(
                action = 'started',
    ...
    def testWebhookWatchStarted(self):
        """Test WebhookWatchStarted"""
