...
class TestWebhookDiscussionLabeled(unittest.TestCase):
    """WebhookDiscussionLabeled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionLabeled:
        """Test WebhookDiscussionLabeled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionLabeled`
        """
        model = WebhookDiscussionLabeled()
        if include_optional:
            return WebhookDiscussionLabeled(
                action = 'labeled',
    ...
    def testWebhookDiscussionLabeled(self):
        """Test WebhookDiscussionLabeled"""
