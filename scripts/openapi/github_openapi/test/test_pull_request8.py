...
class TestPullRequest8(unittest.TestCase):
    """PullRequest8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest8:
        """Test PullRequest8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest8`
        """
        model = PullRequest8()
        if include_optional:
            return PullRequest8(
