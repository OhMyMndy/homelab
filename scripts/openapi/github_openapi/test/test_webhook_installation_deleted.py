...
class TestWebhookInstallationDeleted(unittest.TestCase):
    """WebhookInstallationDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookInstallationDeleted:
        """Test WebhookInstallationDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookInstallationDeleted`
        """
        model = WebhookInstallationDeleted()
        if include_optional:
    ...
    def testWebhookInstallationDeleted(self):
        """Test WebhookInstallationDeleted"""
