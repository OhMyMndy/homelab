...
class TestWebhookGollum(unittest.TestCase):
    """WebhookGollum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookGollum:
        """Test WebhookGollum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookGollum`
        """
        model = WebhookGollum()
        if include_optional:
            return WebhookGollum(
                ...
                pages = [
                    github_openapi.models.webhook_gollum_pages_inner.webhook_gollum_pages_inner(
                        action = 'created', 
                        html_url = '', 
                        page_name = '', 
                        sha = '', 
