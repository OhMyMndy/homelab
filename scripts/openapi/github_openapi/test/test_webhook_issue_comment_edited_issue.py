...
class TestWebhookIssueCommentEditedIssue(unittest.TestCase):
    """WebhookIssueCommentEditedIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssueCommentEditedIssue:
        """Test WebhookIssueCommentEditedIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssueCommentEditedIssue`
        """
        model = WebhookIssueCommentEditedIssue()
        if include_optional:
            return WebhookIssueCommentEditedIssue(
                active_lock_reason = '',
    ...
    def testWebhookIssueCommentEditedIssue(self):
        """Test WebhookIssueCommentEditedIssue"""
