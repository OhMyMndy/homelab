...
class TestWebhookReleasePublished(unittest.TestCase):
    """WebhookReleasePublished unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookReleasePublished:
        """Test WebhookReleasePublished
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookReleasePublished`
        """
        model = WebhookReleasePublished()
        if include_optional:
    ...
    def testWebhookReleasePublished(self):
        """Test WebhookReleasePublished"""
