...
class TestWebhookSponsorshipCancelled(unittest.TestCase):
    """WebhookSponsorshipCancelled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSponsorshipCancelled:
        """Test WebhookSponsorshipCancelled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSponsorshipCancelled`
        """
        model = WebhookSponsorshipCancelled()
        if include_optional:
    ...
    def testWebhookSponsorshipCancelled(self):
        """Test WebhookSponsorshipCancelled"""
