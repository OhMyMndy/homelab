...
class TestWebhookProjectColumnEdited(unittest.TestCase):
    """WebhookProjectColumnEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectColumnEdited:
        """Test WebhookProjectColumnEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectColumnEdited`
        """
        model = WebhookProjectColumnEdited()
        if include_optional:
            return WebhookProjectColumnEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_project_column_edited_changes.webhook_project_column_edited_changes(
                ...
                project_column = github_openapi.models.project_column.Project Column(
                    after_id = 56, 
                    cards_url = '', 
    ...
    def testWebhookProjectColumnEdited(self):
        """Test WebhookProjectColumnEdited"""
