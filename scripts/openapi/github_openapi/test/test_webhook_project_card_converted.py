...
class TestWebhookProjectCardConverted(unittest.TestCase):
    """WebhookProjectCardConverted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectCardConverted:
        """Test WebhookProjectCardConverted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectCardConverted`
        """
        model = WebhookProjectCardConverted()
        if include_optional:
            return WebhookProjectCardConverted(
                action = 'converted',
                changes = github_openapi.models.webhook_project_card_converted_changes.webhook_project_card_converted_changes(
                    note = github_openapi.models.webhook_discussion_comment_edited_changes_body.webhook_discussion_comment_edited_changes_body(
                        from = '', ), ),
                ...
                project_card = github_openapi.models.project_card.Project Card(
                    after_id = 56, 
                    archived = True, 
                    column_id = 56, 
                    column_url = '', 
    ...
    def testWebhookProjectCardConverted(self):
        """Test WebhookProjectCardConverted"""
