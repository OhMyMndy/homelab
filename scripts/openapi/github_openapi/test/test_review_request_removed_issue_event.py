...
class TestReviewRequestRemovedIssueEvent(unittest.TestCase):
    """ReviewRequestRemovedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewRequestRemovedIssueEvent:
        """Test ReviewRequestRemovedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewRequestRemovedIssueEvent`
        """
        model = ReviewRequestRemovedIssueEvent()
        if include_optional:
    ...
    def testReviewRequestRemovedIssueEvent(self):
        """Test ReviewRequestRemovedIssueEvent"""
