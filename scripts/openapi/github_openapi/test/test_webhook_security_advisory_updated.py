...
class TestWebhookSecurityAdvisoryUpdated(unittest.TestCase):
    """WebhookSecurityAdvisoryUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSecurityAdvisoryUpdated:
        """Test WebhookSecurityAdvisoryUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSecurityAdvisoryUpdated`
        """
        model = WebhookSecurityAdvisoryUpdated()
        if include_optional:
    ...
    def testWebhookSecurityAdvisoryUpdated(self):
        """Test WebhookSecurityAdvisoryUpdated"""
