...
class TestWebhookWorkflowDispatch(unittest.TestCase):
    """WebhookWorkflowDispatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookWorkflowDispatch:
        """Test WebhookWorkflowDispatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookWorkflowDispatch`
        """
        model = WebhookWorkflowDispatch()
        if include_optional:
    ...
    def testWebhookWorkflowDispatch(self):
        """Test WebhookWorkflowDispatch"""
