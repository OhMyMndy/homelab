...
class TestPullRequestSimpleHead(unittest.TestCase):
    """PullRequestSimpleHead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequestSimpleHead:
        """Test PullRequestSimpleHead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequestSimpleHead`
        """
        model = PullRequestSimpleHead()
        if include_optional:
    ...
    def testPullRequestSimpleHead(self):
        """Test PullRequestSimpleHead"""
