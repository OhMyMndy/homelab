...
class TestLabeledIssueEvent(unittest.TestCase):
    """LabeledIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabeledIssueEvent:
        """Test LabeledIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabeledIssueEvent`
        """
        model = LabeledIssueEvent()
        if include_optional:
    ...
    def testLabeledIssueEvent(self):
        """Test LabeledIssueEvent"""
