...
class TestWebhookDiscussionEdited(unittest.TestCase):
    """WebhookDiscussionEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionEdited:
        """Test WebhookDiscussionEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionEdited`
        """
        model = WebhookDiscussionEdited()
        if include_optional:
            return WebhookDiscussionEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_discussion_edited_changes.webhook_discussion_edited_changes(
    ...
    def testWebhookDiscussionEdited(self):
        """Test WebhookDiscussionEdited"""
