...
class TestWebhookReleaseReleased(unittest.TestCase):
    """WebhookReleaseReleased unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookReleaseReleased:
        """Test WebhookReleaseReleased
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookReleaseReleased`
        """
        model = WebhookReleaseReleased()
        if include_optional:
            return WebhookReleaseReleased(
                action = 'released',
    ...
    def testWebhookReleaseReleased(self):
        """Test WebhookReleaseReleased"""
