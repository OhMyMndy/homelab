...
class TestWebhookMilestoneCreated(unittest.TestCase):
    """WebhookMilestoneCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMilestoneCreated:
        """Test WebhookMilestoneCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMilestoneCreated`
        """
        model = WebhookMilestoneCreated()
        if include_optional:
            return WebhookMilestoneCreated(
                action = 'created',
    ...
    def testWebhookMilestoneCreated(self):
        """Test WebhookMilestoneCreated"""
