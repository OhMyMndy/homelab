...
class TestWebhookProjectColumnCreated(unittest.TestCase):
    """WebhookProjectColumnCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectColumnCreated:
        """Test WebhookProjectColumnCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectColumnCreated`
        """
        model = WebhookProjectColumnCreated()
        if include_optional:
    ...
    def testWebhookProjectColumnCreated(self):
        """Test WebhookProjectColumnCreated"""
