...
class TestNullableMinimalRepository(unittest.TestCase):
    """NullableMinimalRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NullableMinimalRepository:
        """Test NullableMinimalRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NullableMinimalRepository`
        """
        model = NullableMinimalRepository()
        if include_optional:
...
', 
    ...
    def testNullableMinimalRepository(self):
        """Test NullableMinimalRepository"""
