...
class TestTimelineAssignedIssueEvent(unittest.TestCase):
    """TimelineAssignedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimelineAssignedIssueEvent:
        """Test TimelineAssignedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimelineAssignedIssueEvent`
        """
        model = TimelineAssignedIssueEvent()
        if include_optional:
            return TimelineAssignedIssueEvent(
                id = 56,
                node_id = '',
                url = '',
    ...
    def testTimelineAssignedIssueEvent(self):
        """Test TimelineAssignedIssueEvent"""
