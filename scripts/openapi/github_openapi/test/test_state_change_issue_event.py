...
class TestStateChangeIssueEvent(unittest.TestCase):
    """StateChangeIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateChangeIssueEvent:
        """Test StateChangeIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateChangeIssueEvent`
        """
        model = StateChangeIssueEvent()
        if include_optional:
    ...
    def testStateChangeIssueEvent(self):
        """Test StateChangeIssueEvent"""
