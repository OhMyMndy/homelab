...
class TestIssueSearchResultItem(unittest.TestCase):
    """IssueSearchResultItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IssueSearchResultItem:
        """Test IssueSearchResultItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IssueSearchResultItem`
        """
        model = IssueSearchResultItem()
        if include_optional:
    ...
    def testIssueSearchResultItem(self):
        """Test IssueSearchResultItem"""
