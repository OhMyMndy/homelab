...
class TestRepository7(unittest.TestCase):
    """Repository7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Repository7:
        """Test Repository7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Repository7`
        """
        model = Repository7()
        if include_optional:
            return Repository7(
