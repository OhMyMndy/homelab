...
class TestInstallationToken(unittest.TestCase):
    """InstallationToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstallationToken:
        """Test InstallationToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstallationToken`
        """
    ...
    def testInstallationToken(self):
        """Test InstallationToken"""
