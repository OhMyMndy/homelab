...
class TestWebhookLabelCreated(unittest.TestCase):
    """WebhookLabelCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookLabelCreated:
        """Test WebhookLabelCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookLabelCreated`
        """
        model = WebhookLabelCreated()
        if include_optional:
    ...
    def testWebhookLabelCreated(self):
        """Test WebhookLabelCreated"""
