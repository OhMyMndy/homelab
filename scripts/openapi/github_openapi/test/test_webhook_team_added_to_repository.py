...
class TestWebhookTeamAddedToRepository(unittest.TestCase):
    """WebhookTeamAddedToRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookTeamAddedToRepository:
        """Test WebhookTeamAddedToRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookTeamAddedToRepository`
        """
        model = WebhookTeamAddedToRepository()
        if include_optional:
    ...
    def testWebhookTeamAddedToRepository(self):
        """Test WebhookTeamAddedToRepository"""
