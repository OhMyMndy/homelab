...
class TestWebhookRepositoryCreated(unittest.TestCase):
    """WebhookRepositoryCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryCreated:
        """Test WebhookRepositoryCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryCreated`
        """
        model = WebhookRepositoryCreated()
        if include_optional:
            return WebhookRepositoryCreated(
                action = 'created',
    ...
    def testWebhookRepositoryCreated(self):
        """Test WebhookRepositoryCreated"""
