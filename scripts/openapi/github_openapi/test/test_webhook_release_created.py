...
class TestWebhookReleaseCreated(unittest.TestCase):
    """WebhookReleaseCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookReleaseCreated:
        """Test WebhookReleaseCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookReleaseCreated`
        """
        model = WebhookReleaseCreated()
        if include_optional:
    ...
    def testWebhookReleaseCreated(self):
        """Test WebhookReleaseCreated"""
