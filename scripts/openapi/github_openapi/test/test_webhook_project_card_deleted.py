...
class TestWebhookProjectCardDeleted(unittest.TestCase):
    """WebhookProjectCardDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectCardDeleted:
        """Test WebhookProjectCardDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectCardDeleted`
        """
        model = WebhookProjectCardDeleted()
        if include_optional:
    ...
    def testWebhookProjectCardDeleted(self):
        """Test WebhookProjectCardDeleted"""
