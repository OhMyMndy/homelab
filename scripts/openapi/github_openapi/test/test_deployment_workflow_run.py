...
class TestDeploymentWorkflowRun(unittest.TestCase):
    """DeploymentWorkflowRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentWorkflowRun:
        """Test DeploymentWorkflowRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentWorkflowRun`
        """
        model = DeploymentWorkflowRun()
        if include_optional:
    ...
    def testDeploymentWorkflowRun(self):
        """Test DeploymentWorkflowRun"""
