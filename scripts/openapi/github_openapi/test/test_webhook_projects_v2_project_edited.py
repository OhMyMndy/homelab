...
class TestWebhookProjectsV2ProjectEdited(unittest.TestCase):
    """WebhookProjectsV2ProjectEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectsV2ProjectEdited:
        """Test WebhookProjectsV2ProjectEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectsV2ProjectEdited`
        """
        model = WebhookProjectsV2ProjectEdited()
        if include_optional:
            return WebhookProjectsV2ProjectEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_projects_v2_project_edited_changes.webhook_projects_v2_project_edited_changes(
    ...
    def testWebhookProjectsV2ProjectEdited(self):
        """Test WebhookProjectsV2ProjectEdited"""
