...
class TestWebhookRepositoryRenamed(unittest.TestCase):
    """WebhookRepositoryRenamed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryRenamed:
        """Test WebhookRepositoryRenamed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryRenamed`
        """
        model = WebhookRepositoryRenamed()
        if include_optional:
            return WebhookRepositoryRenamed(
                action = 'renamed',
                changes = github_openapi.models.webhook_repository_renamed_changes.webhook_repository_renamed_changes(
    ...
    def testWebhookRepositoryRenamed(self):
        """Test WebhookRepositoryRenamed"""
