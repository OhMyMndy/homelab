...
class TestWebhookMilestoneEdited(unittest.TestCase):
    """WebhookMilestoneEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMilestoneEdited:
        """Test WebhookMilestoneEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMilestoneEdited`
        """
        model = WebhookMilestoneEdited()
        if include_optional:
            return WebhookMilestoneEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_milestone_edited_changes.webhook_milestone_edited_changes(
    ...
    def testWebhookMilestoneEdited(self):
        """Test WebhookMilestoneEdited"""
