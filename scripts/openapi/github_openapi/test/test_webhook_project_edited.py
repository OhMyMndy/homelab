...
class TestWebhookProjectEdited(unittest.TestCase):
    """WebhookProjectEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectEdited:
        """Test WebhookProjectEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectEdited`
        """
        model = WebhookProjectEdited()
        if include_optional:
            return WebhookProjectEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_project_edited_changes.webhook_project_edited_changes(
                ...
                project = github_openapi.models.project.Project(
                    body = '', 
                    columns_url = '', 
    ...
    def testWebhookProjectEdited(self):
        """Test WebhookProjectEdited"""
