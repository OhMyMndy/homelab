...
class TestWebhookStarCreated(unittest.TestCase):
    """WebhookStarCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookStarCreated:
        """Test WebhookStarCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookStarCreated`
        """
        model = WebhookStarCreated()
        if include_optional:
            return WebhookStarCreated(
                action = 'created',
    ...
    def testWebhookStarCreated(self):
        """Test WebhookStarCreated"""
