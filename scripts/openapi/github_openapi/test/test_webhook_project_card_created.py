...
class TestWebhookProjectCardCreated(unittest.TestCase):
    """WebhookProjectCardCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectCardCreated:
        """Test WebhookProjectCardCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectCardCreated`
        """
        model = WebhookProjectCardCreated()
        if include_optional:
    ...
    def testWebhookProjectCardCreated(self):
        """Test WebhookProjectCardCreated"""
