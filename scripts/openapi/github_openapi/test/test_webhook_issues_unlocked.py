...
class TestWebhookIssuesUnlocked(unittest.TestCase):
    """WebhookIssuesUnlocked unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssuesUnlocked:
        """Test WebhookIssuesUnlocked
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssuesUnlocked`
        """
        model = WebhookIssuesUnlocked()
        if include_optional:
            return WebhookIssuesUnlocked(
                action = 'unlocked',
    ...
    def testWebhookIssuesUnlocked(self):
        """Test WebhookIssuesUnlocked"""
