...
class TestWebhookStarDeleted(unittest.TestCase):
    """WebhookStarDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookStarDeleted:
        """Test WebhookStarDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookStarDeleted`
        """
        model = WebhookStarDeleted()
        if include_optional:
    ...
    def testWebhookStarDeleted(self):
        """Test WebhookStarDeleted"""
