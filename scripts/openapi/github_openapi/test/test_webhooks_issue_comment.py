...
class TestWebhooksIssueComment(unittest.TestCase):
    """WebhooksIssueComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksIssueComment:
        """Test WebhooksIssueComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksIssueComment`
        """
        model = WebhooksIssueComment()
        if include_optional:
    ...
    def testWebhooksIssueComment(self):
        """Test WebhooksIssueComment"""
