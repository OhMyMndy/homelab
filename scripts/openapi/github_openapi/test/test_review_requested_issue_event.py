...
class TestReviewRequestedIssueEvent(unittest.TestCase):
    """ReviewRequestedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewRequestedIssueEvent:
        """Test ReviewRequestedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewRequestedIssueEvent`
        """
        model = ReviewRequestedIssueEvent()
        if include_optional:
    ...
    def testReviewRequestedIssueEvent(self):
        """Test ReviewRequestedIssueEvent"""
