...
class TestWebhookProjectClosed(unittest.TestCase):
    """WebhookProjectClosed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectClosed:
        """Test WebhookProjectClosed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectClosed`
        """
        model = WebhookProjectClosed()
        if include_optional:
    ...
    def testWebhookProjectClosed(self):
        """Test WebhookProjectClosed"""
