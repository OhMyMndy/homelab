...
class TestCheckSuitePreference(unittest.TestCase):
    """CheckSuitePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckSuitePreference:
        """Test CheckSuitePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckSuitePreference`
        """
        model = CheckSuitePreference()
        if include_optional:
            return CheckSuitePreference(
                preferences = github_openapi.models.check_suite_preference_preferences.check_suite_preference_preferences(
                    auto_trigger_checks = [
...
', 
    ...
    def testCheckSuitePreference(self):
        """Test CheckSuitePreference"""
