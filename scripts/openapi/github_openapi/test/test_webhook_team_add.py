...
class TestWebhookTeamAdd(unittest.TestCase):
    """WebhookTeamAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookTeamAdd:
        """Test WebhookTeamAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookTeamAdd`
        """
        model = WebhookTeamAdd()
        if include_optional:
