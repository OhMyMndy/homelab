...
class TestProtectedBranchPullRequestReviewBypassPullRequestAllowances(unittest.TestCase):
    """ProtectedBranchPullRequestReviewBypassPullRequestAllowances unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectedBranchPullRequestReviewBypassPullRequestAllowances:
        """Test ProtectedBranchPullRequestReviewBypassPullRequestAllowances
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectedBranchPullRequestReviewBypassPullRequestAllowances`
        """
        model = ProtectedBranchPullRequestReviewBypassPullRequestAllowances()
        if include_optional:
            return ProtectedBranchPullRequestReviewBypassPullRequestAllowances(
                users = [
    ...
    def testProtectedBranchPullRequestReviewBypassPullRequestAllowances(self):
        """Test ProtectedBranchPullRequestReviewBypassPullRequestAllowances"""
