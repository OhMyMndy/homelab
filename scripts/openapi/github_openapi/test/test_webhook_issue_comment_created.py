...
class TestWebhookIssueCommentCreated(unittest.TestCase):
    """WebhookIssueCommentCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssueCommentCreated:
        """Test WebhookIssueCommentCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssueCommentCreated`
        """
        model = WebhookIssueCommentCreated()
        if include_optional:
    ...
    def testWebhookIssueCommentCreated(self):
        """Test WebhookIssueCommentCreated"""
