...
class TestPullRequest9(unittest.TestCase):
    """PullRequest9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest9:
        """Test PullRequest9
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest9`
        """
        model = PullRequest9()
        if include_optional:
            return PullRequest9(
