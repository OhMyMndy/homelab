...
class TestNullableRepositoryWebhooks(unittest.TestCase):
    """NullableRepositoryWebhooks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NullableRepositoryWebhooks:
        """Test NullableRepositoryWebhooks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NullableRepositoryWebhooks`
        """
        model = NullableRepositoryWebhooks()
        if include_optional:
            return NullableRepositoryWebhooks(
                id = 42,
    ...
    def testNullableRepositoryWebhooks(self):
        """Test NullableRepositoryWebhooks"""
