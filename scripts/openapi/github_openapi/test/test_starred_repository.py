...
class TestStarredRepository(unittest.TestCase):
    """StarredRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StarredRepository:
        """Test StarredRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StarredRepository`
        """
        model = StarredRepository()
        if include_optional:
            return StarredRepository(
                starred_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
    ...
    def testStarredRepository(self):
        """Test StarredRepository"""
