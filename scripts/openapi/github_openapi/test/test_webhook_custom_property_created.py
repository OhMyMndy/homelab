...
class TestWebhookCustomPropertyCreated(unittest.TestCase):
    """WebhookCustomPropertyCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookCustomPropertyCreated:
        """Test WebhookCustomPropertyCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookCustomPropertyCreated`
        """
        model = WebhookCustomPropertyCreated()
        if include_optional:
    ...
    def testWebhookCustomPropertyCreated(self):
        """Test WebhookCustomPropertyCreated"""
