...
class TestWebhookCheckSuiteRequested(unittest.TestCase):
    """WebhookCheckSuiteRequested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookCheckSuiteRequested:
        """Test WebhookCheckSuiteRequested
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookCheckSuiteRequested`
        """
        model = WebhookCheckSuiteRequested()
        if include_optional:
            return WebhookCheckSuiteRequested(
                action = 'requested',
                check_suite = github_openapi.models.webhook_check_suite_requested_check_suite.webhook_check_suite_requested_check_suite(
                    after = '', 
    ...
    def testWebhookCheckSuiteRequested(self):
        """Test WebhookCheckSuiteRequested"""
