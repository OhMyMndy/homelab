...
class TestPullRequest4(unittest.TestCase):
    """PullRequest4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest4:
        """Test PullRequest4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest4`
        """
        model = PullRequest4()
        if include_optional:
            return PullRequest4(
