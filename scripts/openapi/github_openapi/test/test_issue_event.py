    ...
    def make_instance(self, include_optional) -> IssueEvent:
        ...
        if include_optional:
            return IssueEvent(
                ...
                label = github_openapi.models.issue_event_label.Issue Event Label(
                    name = '', 
                    color = '', ),
                assignee = github_openapi.models.simple_user.Simple User(
                    name = '', 
                ...
                dismissed_review = github_openapi.models.issue_event_dismissed_review.Issue Event Dismissed Review(
                    state = '', 
                    review_id = 56, 
                    dismissal_message = '', 
                    dismissal_commit_id = '', ),
                milestone = github_openapi.models.issue_event_milestone.Issue Event Milestone(
                    title = '', ),
                project_card = github_openapi.models.issue_event_project_card.Issue Event Project Card(
                    url = '', 
                    id = 56, 
                    project_url = '', 
                    project_id = 56, 
                ...
                rename = github_openapi.models.issue_event_rename.Issue Event Rename(
                    from = '', 
                    to = '', ),
                author_association = 'OWNER',
                lock_reason = '',
