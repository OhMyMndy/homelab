...
class TestWebhookSponsorshipEdited(unittest.TestCase):
    """WebhookSponsorshipEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSponsorshipEdited:
        """Test WebhookSponsorshipEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSponsorshipEdited`
        """
        model = WebhookSponsorshipEdited()
        if include_optional:
            return WebhookSponsorshipEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_sponsorship_edited_changes.webhook_sponsorship_edited_changes(
    ...
    def testWebhookSponsorshipEdited(self):
        """Test WebhookSponsorshipEdited"""
