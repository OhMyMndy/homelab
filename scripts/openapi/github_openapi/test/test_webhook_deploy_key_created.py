...
class TestWebhookDeployKeyCreated(unittest.TestCase):
    """WebhookDeployKeyCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDeployKeyCreated:
        """Test WebhookDeployKeyCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDeployKeyCreated`
        """
        model = WebhookDeployKeyCreated()
        if include_optional:
    ...
    def testWebhookDeployKeyCreated(self):
        """Test WebhookDeployKeyCreated"""
