...
class TestWebhookRepositoryArchived(unittest.TestCase):
    """WebhookRepositoryArchived unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryArchived:
        """Test WebhookRepositoryArchived
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryArchived`
        """
        model = WebhookRepositoryArchived()
        if include_optional:
    ...
    def testWebhookRepositoryArchived(self):
        """Test WebhookRepositoryArchived"""
