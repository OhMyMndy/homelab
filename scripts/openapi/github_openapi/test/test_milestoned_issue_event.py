...
class TestMilestonedIssueEvent(unittest.TestCase):
    """MilestonedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MilestonedIssueEvent:
        """Test MilestonedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MilestonedIssueEvent`
        """
        model = MilestonedIssueEvent()
        if include_optional:
    ...
    def testMilestonedIssueEvent(self):
        """Test MilestonedIssueEvent"""
