...
class TestWebhookDiscussionDeleted(unittest.TestCase):
    """WebhookDiscussionDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionDeleted:
        """Test WebhookDiscussionDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionDeleted`
        """
        model = WebhookDiscussionDeleted()
        if include_optional:
    ...
    def testWebhookDiscussionDeleted(self):
        """Test WebhookDiscussionDeleted"""
