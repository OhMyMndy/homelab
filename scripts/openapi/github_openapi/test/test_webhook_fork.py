...
class TestWebhookFork(unittest.TestCase):
    """WebhookFork unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFork:
        """Test WebhookFork
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFork`
        """
        model = WebhookFork()
        if include_optional:
            return WebhookFork(
