...
class TestWebhookMilestoneDeleted(unittest.TestCase):
    """WebhookMilestoneDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMilestoneDeleted:
        """Test WebhookMilestoneDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMilestoneDeleted`
        """
        model = WebhookMilestoneDeleted()
        if include_optional:
            return WebhookMilestoneDeleted(
                action = 'deleted',
    ...
    def testWebhookMilestoneDeleted(self):
        """Test WebhookMilestoneDeleted"""
