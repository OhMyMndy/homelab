...
class TestWebhookRepositoryImport(unittest.TestCase):
    """WebhookRepositoryImport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryImport:
        """Test WebhookRepositoryImport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryImport`
        """
        model = WebhookRepositoryImport()
        if include_optional:
    ...
    def testWebhookRepositoryImport(self):
        """Test WebhookRepositoryImport"""
