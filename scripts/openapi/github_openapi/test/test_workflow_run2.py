...
class TestWorkflowRun2(unittest.TestCase):
    """WorkflowRun2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowRun2:
        """Test WorkflowRun2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowRun2`
        """
        model = WorkflowRun2()
        if include_optional:
            return WorkflowRun2(
