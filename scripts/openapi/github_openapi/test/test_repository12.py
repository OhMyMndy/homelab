...
class TestRepository12(unittest.TestCase):
    """Repository12 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Repository12:
        """Test Repository12
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Repository12`
        """
        model = Repository12()
        if include_optional:
            return Repository12(
