...
class TestRepositoryRuleViolationError(unittest.TestCase):
    """RepositoryRuleViolationError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepositoryRuleViolationError:
        """Test RepositoryRuleViolationError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepositoryRuleViolationError`
        """
        model = RepositoryRuleViolationError()
        if include_optional:
    ...
    def testRepositoryRuleViolationError(self):
        """Test RepositoryRuleViolationError"""
