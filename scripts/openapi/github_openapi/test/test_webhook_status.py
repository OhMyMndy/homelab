...
class TestWebhookStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebhookStatus:
        """Test WebhookStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookStatus`
        """
        model = WebhookStatus()
        if include_optional:
            return WebhookStatus(
                avatar_url = '',
                branches = [
                    github_openapi.models.webhook_status_branches_inner.webhook_status_branches_inner(
                ...
                commit = github_openapi.models.webhook_status_commit.webhook_status_commit(
