...
class TestWebhookSponsorshipCreated(unittest.TestCase):
    """WebhookSponsorshipCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSponsorshipCreated:
        """Test WebhookSponsorshipCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSponsorshipCreated`
        """
        model = WebhookSponsorshipCreated()
        if include_optional:
    ...
    def testWebhookSponsorshipCreated(self):
        """Test WebhookSponsorshipCreated"""
