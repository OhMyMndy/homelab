...
class TestWebhookProjectCardMoved(unittest.TestCase):
    """WebhookProjectCardMoved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectCardMoved:
        """Test WebhookProjectCardMoved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectCardMoved`
        """
        model = WebhookProjectCardMoved()
        if include_optional:
            return WebhookProjectCardMoved(
                action = 'moved',
                changes = github_openapi.models.webhook_project_card_moved_changes.webhook_project_card_moved_changes(
                    column_id = github_openapi.models.webhook_project_card_moved_changes_column_id.webhook_project_card_moved_changes_column_id(
                        from = 56, ), ),
    ...
    def testWebhookProjectCardMoved(self):
        """Test WebhookProjectCardMoved"""
