...
class TestPagesHealthCheckDomain(unittest.TestCase):
    """PagesHealthCheckDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagesHealthCheckDomain:
        """Test PagesHealthCheckDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagesHealthCheckDomain`
        """
        model = PagesHealthCheckDomain()
        if include_optional:
    ...
    def testPagesHealthCheckDomain(self):
        """Test PagesHealthCheckDomain"""
