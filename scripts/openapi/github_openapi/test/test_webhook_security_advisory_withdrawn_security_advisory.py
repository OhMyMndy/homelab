...
class TestWebhookSecurityAdvisoryWithdrawnSecurityAdvisory(unittest.TestCase):
    """WebhookSecurityAdvisoryWithdrawnSecurityAdvisory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSecurityAdvisoryWithdrawnSecurityAdvisory:
        """Test WebhookSecurityAdvisoryWithdrawnSecurityAdvisory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSecurityAdvisoryWithdrawnSecurityAdvisory`
        """
        model = WebhookSecurityAdvisoryWithdrawnSecurityAdvisory()
        if include_optional:
    ...
    def testWebhookSecurityAdvisoryWithdrawnSecurityAdvisory(self):
        """Test WebhookSecurityAdvisoryWithdrawnSecurityAdvisory"""
