...
class TestWebhookDeployKeyDeleted(unittest.TestCase):
    """WebhookDeployKeyDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDeployKeyDeleted:
        """Test WebhookDeployKeyDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDeployKeyDeleted`
        """
        model = WebhookDeployKeyDeleted()
        if include_optional:
            return WebhookDeployKeyDeleted(
                action = 'deleted',
                ...
                key = github_openapi.models.webhooks_deploy_key.webhooks_deploy_key(
                    added_by = '', 
                    created_at = '', 
                    id = 56, 
                    key = '', 
    ...
    def testWebhookDeployKeyDeleted(self):
        """Test WebhookDeployKeyDeleted"""
