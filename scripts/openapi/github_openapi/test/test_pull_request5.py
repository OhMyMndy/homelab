...
class TestPullRequest5(unittest.TestCase):
    """PullRequest5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest5:
        """Test PullRequest5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest5`
        """
        model = PullRequest5()
        if include_optional:
            return PullRequest5(
