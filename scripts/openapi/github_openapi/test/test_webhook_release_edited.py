...
class TestWebhookReleaseEdited(unittest.TestCase):
    """WebhookReleaseEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookReleaseEdited:
        """Test WebhookReleaseEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookReleaseEdited`
        """
        model = WebhookReleaseEdited()
        if include_optional:
            return WebhookReleaseEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_release_edited_changes.webhook_release_edited_changes(
                ...
                release = github_openapi.models.release.Release(
                    assets = [
    ...
    def testWebhookReleaseEdited(self):
        """Test WebhookReleaseEdited"""
