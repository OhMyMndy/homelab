...
class TestTimelineUnassignedIssueEvent(unittest.TestCase):
    """TimelineUnassignedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimelineUnassignedIssueEvent:
        """Test TimelineUnassignedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimelineUnassignedIssueEvent`
        """
        model = TimelineUnassignedIssueEvent()
        if include_optional:
            return TimelineUnassignedIssueEvent(
                id = 56,
                node_id = '',
                url = '',
    ...
    def testTimelineUnassignedIssueEvent(self):
        """Test TimelineUnassignedIssueEvent"""
