...
class TestDemilestonedIssueEvent(unittest.TestCase):
    """DemilestonedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemilestonedIssueEvent:
        """Test DemilestonedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemilestonedIssueEvent`
        """
        model = DemilestonedIssueEvent()
        if include_optional:
    ...
    def testDemilestonedIssueEvent(self):
        """Test DemilestonedIssueEvent"""
