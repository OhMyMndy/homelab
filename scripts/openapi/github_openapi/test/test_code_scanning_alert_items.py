...
class TestCodeScanningAlertItems(unittest.TestCase):
    """CodeScanningAlertItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeScanningAlertItems:
        """Test CodeScanningAlertItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeScanningAlertItems`
        """
        model = CodeScanningAlertItems()
        if include_optional:
    ...
    def testCodeScanningAlertItems(self):
        """Test CodeScanningAlertItems"""
