...
class TestCodeSearchResultItem(unittest.TestCase):
    """CodeSearchResultItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodeSearchResultItem:
        """Test CodeSearchResultItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeSearchResultItem`
        """
...
', 
    ...
    def testCodeSearchResultItem(self):
        """Test CodeSearchResultItem"""
