...
class TestPullRequest12(unittest.TestCase):
    """PullRequest12 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest12:
        """Test PullRequest12
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest12`
        """
        model = PullRequest12()
        if include_optional:
            return PullRequest12(
