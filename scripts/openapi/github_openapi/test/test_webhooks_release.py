...
class TestWebhooksRelease(unittest.TestCase):
    """WebhooksRelease unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksRelease:
        """Test WebhooksRelease
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksRelease`
        """
        model = WebhooksRelease()
        if include_optional:
