...
class TestWebhookMergeGroupDestroyed(unittest.TestCase):
    """WebhookMergeGroupDestroyed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMergeGroupDestroyed:
        """Test WebhookMergeGroupDestroyed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMergeGroupDestroyed`
        """
        model = WebhookMergeGroupDestroyed()
        if include_optional:
    ...
    def testWebhookMergeGroupDestroyed(self):
        """Test WebhookMergeGroupDestroyed"""
