...
class TestSearchCode200Response(unittest.TestCase):
    """SearchCode200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchCode200Response:
        """Test SearchCode200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCode200Response`
        """
        model = SearchCode200Response()
        if include_optional:
            return SearchCode200Response(
                total_count = 56,
                incomplete_results = True,
                items = [
                    github_openapi.models.code_search_result_item.Code Search Result Item(
                        name = '', 
                        path = '', 
                        sha = '', 
                        url = '', 
...
', 
    ...
    def testSearchCode200Response(self):
        """Test SearchCode200Response"""
