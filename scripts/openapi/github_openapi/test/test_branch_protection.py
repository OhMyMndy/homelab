        ...
        if include_optional:
            return BranchProtection(
                ...
                allow_force_pushes = github_openapi.models.branch_protection_required_linear_history.branch_protection_required_linear_history(
                    enabled = True, ),
                allow_deletions = github_openapi.models.branch_protection_required_linear_history.branch_protection_required_linear_history(
                    enabled = True, ),
                block_creations = github_openapi.models.branch_protection_required_linear_history.branch_protection_required_linear_history(
                    enabled = True, ),
                required_conversation_resolution = github_openapi.models.branch_protection_required_linear_history.branch_protection_required_linear_history(
                    enabled = True, ),
