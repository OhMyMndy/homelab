...
class TestWebhookIssuesLocked(unittest.TestCase):
    """WebhookIssuesLocked unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIssuesLocked:
        """Test WebhookIssuesLocked
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIssuesLocked`
        """
        model = WebhookIssuesLocked()
        if include_optional:
            return WebhookIssuesLocked(
                action = 'locked',
    ...
    def testWebhookIssuesLocked(self):
        """Test WebhookIssuesLocked"""
