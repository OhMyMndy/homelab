...
class TestWebhooksRelease1(unittest.TestCase):
    """WebhooksRelease1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksRelease1:
        """Test WebhooksRelease1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksRelease1`
        """
        model = WebhooksRelease1()
        if include_optional:
            return WebhooksRelease1(
                assets = [
