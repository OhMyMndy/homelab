...
class TestWebhookProjectCardEdited(unittest.TestCase):
    """WebhookProjectCardEdited unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookProjectCardEdited:
        """Test WebhookProjectCardEdited
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookProjectCardEdited`
        """
        model = WebhookProjectCardEdited()
        if include_optional:
            return WebhookProjectCardEdited(
                action = 'edited',
                changes = github_openapi.models.webhook_project_card_edited_changes.webhook_project_card_edited_changes(
    ...
    def testWebhookProjectCardEdited(self):
        """Test WebhookProjectCardEdited"""
