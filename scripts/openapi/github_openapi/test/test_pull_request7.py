...
class TestPullRequest7(unittest.TestCase):
    """PullRequest7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequest7:
        """Test PullRequest7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequest7`
        """
        model = PullRequest7()
        if include_optional:
            return PullRequest7(
