...
class TestWebhookPullRequestClosed(unittest.TestCase):
    """WebhookPullRequestClosed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookPullRequestClosed:
        """Test WebhookPullRequestClosed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookPullRequestClosed`
        """
        model = WebhookPullRequestClosed()
        if include_optional:
            return WebhookPullRequestClosed(
                action = 'closed',
    ...
    def testWebhookPullRequestClosed(self):
        """Test WebhookPullRequestClosed"""
