...
class TestRenamedIssueEvent(unittest.TestCase):
    """RenamedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RenamedIssueEvent:
        """Test RenamedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenamedIssueEvent`
        """
        model = RenamedIssueEvent()
        if include_optional:
            return RenamedIssueEvent(
                id = 56,
                node_id = '',
                url = '',
    ...
    def testRenamedIssueEvent(self):
        """Test RenamedIssueEvent"""
