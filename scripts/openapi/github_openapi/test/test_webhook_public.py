...
class TestWebhookPublic(unittest.TestCase):
    """WebhookPublic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookPublic:
        """Test WebhookPublic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookPublic`
        """
        model = WebhookPublic()
        if include_optional:
