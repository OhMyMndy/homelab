...
class TestTimelineCommentEvent(unittest.TestCase):
    """TimelineCommentEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimelineCommentEvent:
        """Test TimelineCommentEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimelineCommentEvent`
        """
        model = TimelineCommentEvent()
        if include_optional:
    ...
    def testTimelineCommentEvent(self):
        """Test TimelineCommentEvent"""
