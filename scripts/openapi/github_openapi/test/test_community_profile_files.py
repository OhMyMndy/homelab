...
class TestCommunityProfileFiles(unittest.TestCase):
    """CommunityProfileFiles unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunityProfileFiles:
        """Test CommunityProfileFiles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunityProfileFiles`
        """
        model = CommunityProfileFiles()
        if include_optional:
            return CommunityProfileFiles(
                ...
                contributing = github_openapi.models.community_health_file.Community Health File(
                    url = '', 
                    html_url = '', ),
                readme = github_openapi.models.community_health_file.Community Health File(
                    url = '', 
                    html_url = '', ),
                issue_template = github_openapi.models.community_health_file.Community Health File(
                    url = '', 
                    html_url = '', ),
                pull_request_template = github_openapi.models.community_health_file.Community Health File(
                    url = '', 
                    html_url = '', )
            )
        else:
    ...
    def testCommunityProfileFiles(self):
        """Test CommunityProfileFiles"""
