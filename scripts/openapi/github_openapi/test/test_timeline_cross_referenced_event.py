...
class TestTimelineCrossReferencedEvent(unittest.TestCase):
    """TimelineCrossReferencedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimelineCrossReferencedEvent:
        """Test TimelineCrossReferencedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimelineCrossReferencedEvent`
        """
        model = TimelineCrossReferencedEvent()
        if include_optional:
    ...
    def testTimelineCrossReferencedEvent(self):
        """Test TimelineCrossReferencedEvent"""
