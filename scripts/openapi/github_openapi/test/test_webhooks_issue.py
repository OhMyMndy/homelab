...
class TestWebhooksIssue(unittest.TestCase):
    """WebhooksIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksIssue:
        """Test WebhooksIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksIssue`
        """
        model = WebhooksIssue()
        if include_optional:
            return WebhooksIssue(
