...
class TestWebhookOrgBlockBlocked(unittest.TestCase):
    """WebhookOrgBlockBlocked unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookOrgBlockBlocked:
        """Test WebhookOrgBlockBlocked
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookOrgBlockBlocked`
        """
        model = WebhookOrgBlockBlocked()
        if include_optional:
            return WebhookOrgBlockBlocked(
                action = 'blocked',
                blocked_user = github_openapi.models.user.User(
                    avatar_url = '', 
                    deleted = True, 
                    email = '', 
                    events_url = '', 
    ...
    def testWebhookOrgBlockBlocked(self):
        """Test WebhookOrgBlockBlocked"""
