...
class TestWebhookOrgBlockUnblocked(unittest.TestCase):
    """WebhookOrgBlockUnblocked unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookOrgBlockUnblocked:
        """Test WebhookOrgBlockUnblocked
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookOrgBlockUnblocked`
        """
        model = WebhookOrgBlockUnblocked()
        if include_optional:
    ...
    def testWebhookOrgBlockUnblocked(self):
        """Test WebhookOrgBlockUnblocked"""
