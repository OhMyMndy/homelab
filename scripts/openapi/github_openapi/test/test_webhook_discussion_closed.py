...
class TestWebhookDiscussionClosed(unittest.TestCase):
    """WebhookDiscussionClosed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionClosed:
        """Test WebhookDiscussionClosed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionClosed`
        """
        model = WebhookDiscussionClosed()
        if include_optional:
    ...
    def testWebhookDiscussionClosed(self):
        """Test WebhookDiscussionClosed"""
