...
class TestWebhookPullRequestOpened(unittest.TestCase):
    """WebhookPullRequestOpened unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookPullRequestOpened:
        """Test WebhookPullRequestOpened
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookPullRequestOpened`
        """
        model = WebhookPullRequestOpened()
        if include_optional:
            return WebhookPullRequestOpened(
                action = 'opened',
    ...
    def testWebhookPullRequestOpened(self):
        """Test WebhookPullRequestOpened"""
