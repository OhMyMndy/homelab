...
class TestRepository11(unittest.TestCase):
    """Repository11 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Repository11:
        """Test Repository11
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Repository11`
        """
        model = Repository11()
        if include_optional:
            return Repository11(
