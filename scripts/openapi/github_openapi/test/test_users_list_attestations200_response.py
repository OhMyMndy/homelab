...
class TestUsersListAttestations200Response(unittest.TestCase):
    """UsersListAttestations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersListAttestations200Response:
        """Test UsersListAttestations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersListAttestations200Response`
        """
        model = UsersListAttestations200Response()
        if include_optional:
            return UsersListAttestations200Response(
                attestations = [
                    github_openapi.models.users_list_attestations_200_response_attestations_inner.users_list_attestations_200_response_attestations_inner(
    ...
    def testUsersListAttestations200Response(self):
        """Test UsersListAttestations200Response"""
