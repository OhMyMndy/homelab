...
class TestAssignedIssueEvent(unittest.TestCase):
    """AssignedIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignedIssueEvent:
        """Test AssignedIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignedIssueEvent`
        """
        model = AssignedIssueEvent()
        if include_optional:
            return AssignedIssueEvent(
                id = 56,
                node_id = '',
                url = '',
    ...
    def testAssignedIssueEvent(self):
        """Test AssignedIssueEvent"""
