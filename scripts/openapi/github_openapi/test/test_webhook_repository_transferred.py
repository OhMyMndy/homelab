...
class TestWebhookRepositoryTransferred(unittest.TestCase):
    """WebhookRepositoryTransferred unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookRepositoryTransferred:
        """Test WebhookRepositoryTransferred
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookRepositoryTransferred`
        """
        model = WebhookRepositoryTransferred()
        if include_optional:
            return WebhookRepositoryTransferred(
                action = 'transferred',
                changes = github_openapi.models.webhook_repository_transferred_changes.webhook_repository_transferred_changes(
                    owner = github_openapi.models.webhook_repository_transferred_changes_owner.webhook_repository_transferred_changes_owner(
                        from = github_openapi.models.webhook_repository_transferred_changes_owner_from.webhook_repository_transferred_changes_owner_from(
                            organization = github_openapi.models.organization.Organization(
                                avatar_url = '', 
                                description = '', 
                                events_url = '', 
                                hooks_url = '', 
    ...
    def testWebhookRepositoryTransferred(self):
        """Test WebhookRepositoryTransferred"""
