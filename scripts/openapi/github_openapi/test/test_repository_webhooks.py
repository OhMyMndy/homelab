...
class TestRepositoryWebhooks(unittest.TestCase):
    """RepositoryWebhooks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepositoryWebhooks:
        """Test RepositoryWebhooks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepositoryWebhooks`
        """
        model = RepositoryWebhooks()
        if include_optional:
    ...
    def testRepositoryWebhooks(self):
        """Test RepositoryWebhooks"""
