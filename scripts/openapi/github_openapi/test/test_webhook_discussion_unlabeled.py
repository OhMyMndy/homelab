...
class TestWebhookDiscussionUnlabeled(unittest.TestCase):
    """WebhookDiscussionUnlabeled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDiscussionUnlabeled:
        """Test WebhookDiscussionUnlabeled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDiscussionUnlabeled`
        """
        model = WebhookDiscussionUnlabeled()
        if include_optional:
    ...
    def testWebhookDiscussionUnlabeled(self):
        """Test WebhookDiscussionUnlabeled"""
