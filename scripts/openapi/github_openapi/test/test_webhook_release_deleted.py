...
class TestWebhookReleaseDeleted(unittest.TestCase):
    """WebhookReleaseDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookReleaseDeleted:
        """Test WebhookReleaseDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookReleaseDeleted`
        """
        model = WebhookReleaseDeleted()
        if include_optional:
            return WebhookReleaseDeleted(
                action = 'deleted',
    ...
    def testWebhookReleaseDeleted(self):
        """Test WebhookReleaseDeleted"""
