...
class TestWebhookSponsorshipPendingTierChange(unittest.TestCase):
    """WebhookSponsorshipPendingTierChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSponsorshipPendingTierChange:
        """Test WebhookSponsorshipPendingTierChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSponsorshipPendingTierChange`
        """
        model = WebhookSponsorshipPendingTierChange()
        if include_optional:
            return WebhookSponsorshipPendingTierChange(
                action = 'pending_tier_change',
                changes = github_openapi.models.webhooks_changes_8.webhooks_changes_8(
                ...
                sender = github_openapi.models.simple_user.Simple User(
                    ...
                    starred_at = '"2020-07-09T00:17:55Z"', 
                    user_view_type = 'public', ),
                sponsorship = github_openapi.models.webhooks_sponsorship.webhooks_sponsorship(
                    created_at = '', 
    ...
    def testWebhookSponsorshipPendingTierChange(self):
        """Test WebhookSponsorshipPendingTierChange"""
