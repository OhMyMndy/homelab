...
class TestWebhookCustomPropertyDeleted(unittest.TestCase):
    """WebhookCustomPropertyDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookCustomPropertyDeleted:
        """Test WebhookCustomPropertyDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookCustomPropertyDeleted`
        """
        model = WebhookCustomPropertyDeleted()
        if include_optional:
            return WebhookCustomPropertyDeleted(
                action = 'deleted',
                definition = github_openapi.models.webhook_custom_property_deleted_definition.webhook_custom_property_deleted_definition(
                    property_name = '', ),
    ...
    def testWebhookCustomPropertyDeleted(self):
        """Test WebhookCustomPropertyDeleted"""
