...
class TestUnlabeledIssueEvent(unittest.TestCase):
    """UnlabeledIssueEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnlabeledIssueEvent:
        """Test UnlabeledIssueEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnlabeledIssueEvent`
        """
        model = UnlabeledIssueEvent()
        if include_optional:
    ...
    def testUnlabeledIssueEvent(self):
        """Test UnlabeledIssueEvent"""
