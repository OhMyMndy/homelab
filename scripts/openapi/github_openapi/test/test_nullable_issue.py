...
class TestNullableIssue(unittest.TestCase):
    """NullableIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NullableIssue:
        """Test NullableIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NullableIssue`
        """
        model = NullableIssue()
        if include_optional:
            return NullableIssue(
                ...
                draft = True,
                closed_by = github_openapi.models.simple_user.Simple User(
                    name = '', 
                    email = '', 
                    login = 'octocat', 
                    id = 1, 
