...
class TestCombinedStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CombinedStatus:
        """Test CombinedStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CombinedStatus`
        """
        model = CombinedStatus()
        if include_optional:
            return CombinedStatus(
                commit_url = '',
                repository = gitea_openapi.models.repository.Repository(
                ...
                state = '',
                statuses = [
                    gitea_openapi.models.commit_status.CommitStatus(
                        context = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
