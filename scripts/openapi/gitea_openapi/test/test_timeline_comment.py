        ...
        if include_optional:
            return TimelineComment(
                assignee = gitea_openapi.models.user.User(
                    ...
                    visibility = '', 
                    website = '', ),
                assignee_team = gitea_openapi.models.team.Team(
                ...
                dependent_issue = gitea_openapi.models.issue.Issue(
                    assets = [
                ...
                id = 56,
                issue_url = '',
                label = gitea_openapi.models.label.Label(
                    color = '00aabb', 
                    description = '', 
                    exclusive = False, 
                    id = 56, 
                ...
                new_ref = '',
                new_title = '',
                old_milestone = gitea_openapi.models.milestone.Milestone(
                    closed_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    closed_issues = 56, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
                ...
                pull_request_url = '',
                ref_action = '',
                ref_comment = gitea_openapi.models.comment.Comment(
                    assets = [
                        gitea_openapi.models.attachment.Attachment(
                            browser_download_url = '', 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    user = gitea_openapi.models.user.User(
                        ...
                        website = '', ), ),
                ref_commit_sha = '',
                ref_issue = gitea_openapi.models.issue.Issue(
                    assets = [
                        gitea_openapi.models.attachment.Attachment(
                            browser_download_url = '', 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                resolve_doer = gitea_openapi.models.user.User(
                    active = True, 
                    avatar_url = '', 
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
                    ...
                    website = '', ),
                review_id = 56,
                tracked_time = gitea_openapi.models.tracked_time.TrackedTime(
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    id = 56, 
                    issue = gitea_openapi.models.issue.Issue(
                        assets = [
                            gitea_openapi.models.attachment.Attachment(
                                browser_download_url = '', 
                                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
