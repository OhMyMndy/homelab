...
class TestPullReviewComment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PullReviewComment:
        """Test PullReviewComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullReviewComment`
        """
        ...
        if include_optional:
            return PullReviewComment(
                ...
                pull_request_url = '',
                resolver = gitea_openapi.models.user.User(
                    active = True, 
                    avatar_url = '', 
