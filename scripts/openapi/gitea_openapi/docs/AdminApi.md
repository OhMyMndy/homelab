...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_openapi.AdminApi(api_client)
    username = 'username_example' # str | username of user
    body = gitea_openapi.UserBadgeOption() # UserBadgeOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    key = gitea_openapi.CreateKeyOption() # CreateKeyOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repository = gitea_openapi.CreateRepoOption() # CreateRepoOption | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.AdminApi(api_client)
    body = gitea_openapi.CreateUserOption() # CreateUserOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.EditUserOption() # EditUserOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.RenameUserOption() # RenameUserOption | 
