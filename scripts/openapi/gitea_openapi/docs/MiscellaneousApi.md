...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_openapi.MiscellaneousApi(api_client)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.MiscellaneousApi(api_client)
    body = gitea_openapi.MarkdownOption() # MarkdownOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.MiscellaneousApi(api_client)
    body = gitea_openapi.MarkupOption() # MarkupOption |  (optional)
