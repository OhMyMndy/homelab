...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_openapi.RepositoryApi(api_client)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.RepositoryApi(api_client)
    body = gitea_openapi.CreateRepoOption() # CreateRepoOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.CreateForkOption() # CreateForkOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.CreateVariableOption() # CreateVariableOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.GenerateRepoOption() # GenerateRepoOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.AddCollaboratorOption() # AddCollaboratorOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreatePushMirrorOption() # CreatePushMirrorOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.UpdateFileOptions() # UpdateFileOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.ChangeFilesOptions() # ChangeFilesOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateBranchRepoOption() # CreateBranchRepoOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateBranchProtectionOption() # CreateBranchProtectionOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.CreateFileOptions() # CreateFileOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateHookOption() # CreateHookOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateKeyOption() # CreateKeyOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreatePullRequestOption() # CreatePullRequestOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.CreatePullReviewOptions() # CreatePullReviewOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the pull request
    body = gitea_openapi.PullReviewRequestOptions() # PullReviewRequestOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateReleaseOption() # CreateReleaseOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    sha = 'sha_example' # str | sha of the commit
    body = gitea_openapi.CreateStatusOption() # CreateStatusOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateTagOption() # CreateTagOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.CreateWikiPageOptions() # CreateWikiPageOptions |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.DeleteFileOptions() # DeleteFileOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    index = 56 # int | index of the pull request
    id = 56 # int | id of the review
    body = gitea_openapi.DismissPullReviewOptions() # DismissPullReviewOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.EditRepoOption() # EditRepoOption | Properties of a repo that you can edit (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    name = 'name_example' # str | name of protected branch
    body = gitea_openapi.EditBranchProtectionOption() # EditBranchProtectionOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 'id_example' # str | id of the hook to get
    body = gitea_openapi.EditGitHookOption() # EditGitHookOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.EditHookOption() # EditHookOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.EditPullRequestOption() # EditPullRequestOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.EditReleaseOption() # EditReleaseOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    var_not = 'var_not_example' # str | commits that match the given specifier will not be listed. (optional)
 ...
 **var_not** | **str**| commits that match the given specifier will not be listed. | [optional] 
...
> List[Activity] repo_list_activity_feeds(owner, repo, var_date=var_date, page=page, limit=limit)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the pull request to merge
    body = gitea_openapi.MergePullRequestOption() # MergePullRequestOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.RepositoryApi(api_client)
    body = gitea_openapi.MigrateRepoOptions() # MigrateRepoOptions |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    priority_owner_id = 56 # int | repo owner to prioritize in the results (optional)
    team_id = 56 # int | search only for repos that belong to the given team id (optional)
    starred_by = 56 # int | search only for repos that the user with the given id has starred (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    index = 56 # int | index of the pull request
    id = 56 # int | id of the review
    body = gitea_openapi.SubmitPullReviewOptions() # SubmitPullReviewOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo to transfer
    repo = 'repo_example' # str | name of the repo to transfer
    body = gitea_openapi.TransferRepoOption() # TransferRepoOption | Transfer Options
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.UpdateRepoAvatarOption() # UpdateRepoAvatarOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_openapi.RepoTopicOptions() # RepoTopicOptions |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repository
    secretname = 'secretname_example' # str | name of the secret
    body = gitea_openapi.CreateOrUpdateSecretOption() # CreateOrUpdateSecretOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repository
    variablename = 'variablename_example' # str | name of the variable
    body = gitea_openapi.UpdateVariableOption() # UpdateVariableOption |  (optional)
