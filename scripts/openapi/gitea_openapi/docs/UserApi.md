...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.CreateRepoOption() # CreateRepoOption |  (optional)

    try:
        # Create a repository
        api_response = api_instance.create_current_user_repo_0(body=body)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.UserSettingsOptions() # UserSettingsOptions |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.CreateEmailOption() # CreateEmailOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.CreateHookOption() # CreateHookOption | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.CreateOAuth2ApplicationOptions() # CreateOAuth2ApplicationOptions | 
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    body = gitea_openapi.CreateAccessTokenOption() # CreateAccessTokenOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    form = gitea_openapi.CreateGPGKeyOption() # CreateGPGKeyOption |  (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.DeleteEmailOption() # DeleteEmailOption |  (optional)
...
> List[Activity] user_list_activity_feeds(username, only_performed_by=only_performed_by, var_date=var_date, page=page, limit=limit)
...
# **user_search**
> UserSearch200Response user_search(q=q, uid=uid, page=page, limit=limit)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    ...
    uid = 56 # int | ID of the user to search for (optional)
    page = 56 # int | page number of results to return (1-based) (optional)
    limit = 56 # int | page size of results (optional)
...
with gitea_openapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_openapi.UserApi(api_client)
    body = gitea_openapi.UpdateUserAvatarOption() # UpdateUserAvatarOption |  (optional)
