...
class FileResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commit", "content", "verification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commit": FileCommitResponse.from_dict(obj["commit"]) if obj.get("commit") is not None else None,
            "content": ContentsResponse.from_dict(obj["content"]) if obj.get("content") is not None else None,
