...
class UpdateVariableOption(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="New name for the variable. If the field is empty, the variable name won't be updated.")
    value: StrictStr = Field(description="Value of the variable to update")
