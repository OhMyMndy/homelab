...
class Repository(BaseModel):
    ...
    """ # noqa: E501
    allow_fast_forward_only_merge: Optional[StrictBool] = None
    ...
    projects_mode: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["allow_fast_forward_only_merge", "allow_merge_commits", "allow_rebase", "allow_rebase_explicit", "allow_rebase_update", "allow_squash_merge", "archived", "archived_at", "avatar_url", "clone_url", "created_at", "default_allow_maintainer_edit", "default_branch", "default_delete_branch_after_merge", "default_merge_style", "description", "empty", "external_tracker", "external_wiki", "fork", "forks_count", "full_name", "has_actions", "has_issues", "has_packages", "has_projects", "has_pull_requests", "has_releases", "has_wiki", "html_url", "id", "ignore_whitespace_conflicts", "internal", "internal_tracker", "language", "languages_url", "link", "mirror", "mirror_interval", "mirror_updated", "name", "object_format_name", "open_issues_count", "open_pr_counter", "original_url", "owner", "parent", "permissions", "private", "projects_mode", "release_counter", "repo_transfer", "size", "ssh_url", "stars_count", "template", "updated_at", "url", "watchers_count", "website"]
