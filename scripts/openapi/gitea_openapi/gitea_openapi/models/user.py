...
class User(BaseModel):
    ...
    source_id: Optional[StrictInt] = Field(default=None, description="The ID of the user's Authentication Source")
    ...
    __properties: ClassVar[List[str]] = ["active", "avatar_url", "created", "description", "email", "followers_count", "following_count", "full_name", "id", "is_admin", "language", "last_login", "location", "login", "login_name", "prohibit_login", "restricted", "source_id", "starred_repos_count", "visibility", "website"]
