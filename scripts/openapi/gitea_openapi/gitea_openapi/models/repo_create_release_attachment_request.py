...
class RepoCreateReleaseAttachmentRequest(BaseModel):
    """
    RepoCreateReleaseAttachmentRequest
    """ # noqa: E501
    attachment: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = Field(default=None, description="attachment to upload")
