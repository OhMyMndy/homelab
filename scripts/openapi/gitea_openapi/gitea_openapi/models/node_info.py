...
class NodeInfo(BaseModel):
    ...
    open_registrations: Optional[StrictBool] = Field(default=None, alias="openRegistrations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "openRegistrations": obj.get("openRegistrations"),
            "protocols": obj.get("protocols"),
            "services": NodeInfoServices.from_dict(obj["services"]) if obj.get("services") is not None else None,
            "software": NodeInfoSoftware.from_dict(obj["software"]) if obj.get("software") is not None else None,
            "usage": NodeInfoUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
