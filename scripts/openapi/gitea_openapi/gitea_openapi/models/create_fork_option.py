...
class CreateForkOption(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="name of the forked repository")
    organization: Optional[StrictStr] = Field(default=None, description="organization name, if forking into an organization")
