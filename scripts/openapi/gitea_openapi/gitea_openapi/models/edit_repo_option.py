...
class EditRepoOption(BaseModel):
    ...
    """ # noqa: E501
    allow_fast_forward_only_merge: Optional[StrictBool] = Field(default=None, description="either `true` to allow fast-forward-only merging pull requests, or `false` to prevent fast-forward-only merging.")
    ...
    default_merge_style: Optional[StrictStr] = Field(default=None, description="set to a merge style to be used by this repository: \"merge\", \"rebase\", \"rebase-merge\", \"squash\", or \"fast-forward-only\".")
    ...
    projects_mode: Optional[StrictStr] = Field(default=None, description="`repo` to only allow repo-level projects, `owner` to only allow owner projects, `all` to allow both.")
    ...
    __properties: ClassVar[List[str]] = ["allow_fast_forward_only_merge", "allow_manual_merge", "allow_merge_commits", "allow_rebase", "allow_rebase_explicit", "allow_rebase_update", "allow_squash_merge", "archived", "autodetect_manual_merge", "default_allow_maintainer_edit", "default_branch", "default_delete_branch_after_merge", "default_merge_style", "description", "enable_prune", "external_tracker", "external_wiki", "has_actions", "has_issues", "has_packages", "has_projects", "has_pull_requests", "has_releases", "has_wiki", "ignore_whitespace_conflicts", "internal_tracker", "mirror_interval", "name", "private", "projects_mode", "template", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allow_fast_forward_only_merge": obj.get("allow_fast_forward_only_merge"),
            ...
            "projects_mode": obj.get("projects_mode"),
