...
class ActivitypubApi:
    ...
    def activitypub_person(
        ...
        _param = self._activitypub_person_serialize(
            user_id=user_id,
    ...
    def _activitypub_person_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/activitypub/user-id/{user-id}',
    ...
    def activitypub_person_inbox(
        ...
        _param = self._activitypub_person_inbox_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _activitypub_person_inbox_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/activitypub/user-id/{user-id}/inbox',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
