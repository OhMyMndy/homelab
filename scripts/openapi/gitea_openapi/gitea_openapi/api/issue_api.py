...
class IssueApi:
    ...
    def issue_create_issue_attachment(
        ...
        repo: Annotated[StrictStr, Field(description="name of the repo")],
        index: Annotated[StrictInt, Field(description="index of the issue")],
        attachment: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="attachment to upload")],
    ...
    def issue_list_issues(
        ...
        created_by: Annotated[Optional[StrictStr], Field(description="Only show items which were created by the given user")] = None,
